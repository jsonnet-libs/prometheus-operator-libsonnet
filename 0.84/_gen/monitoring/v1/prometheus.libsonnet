{
  ...
  spec: {
    ...
    otlp: {
      ...
      '#withPromoteResourceAttributes':: d.fn(help='"List of OpenTelemetry Attributes that should be promoted to metric labels, defaults to none."', args=[d.arg(name='promoteResourceAttributes', type=d.T.array)]),
