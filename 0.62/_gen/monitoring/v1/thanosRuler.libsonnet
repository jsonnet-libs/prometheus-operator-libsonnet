  ...
  spec: {
    ...
    storage: {
      ...
      volumeClaimTemplate: {
        ...
        status: {
          '#conditions':: d.obj(help="\"conditions is the current Condition of persistent volume claim. If underlying persistent volume is being resized then the Condition will be set to 'ResizeStarted'.\""),
          conditions: {
            '#withLastProbeTime':: d.fn(help='"lastProbeTime is the time we probed the condition."', args=[d.arg(name='lastProbeTime', type=d.T.string)]),
            withLastProbeTime(lastProbeTime): { lastProbeTime: lastProbeTime },
            '#withLastTransitionTime':: d.fn(help='"lastTransitionTime is the time the condition transitioned from one status to another."', args=[d.arg(name='lastTransitionTime', type=d.T.string)]),
            ...
            '#withReason':: d.fn(help="\"reason is a unique, this should be a short, machine understandable string that gives the reason for condition's last transition. If it reports \\\"ResizeStarted\\\" that means the underlying persistent volume is being resized.\"", args=[d.arg(name='reason', type=d.T.string)]),
