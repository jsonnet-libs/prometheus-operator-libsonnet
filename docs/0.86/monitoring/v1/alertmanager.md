---
permalink: /0.86/monitoring/v1/alertmanager/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.alertmanagerConfiguration`](#obj-specalertmanagerconfiguration)
    ...
    * [`obj spec.alertmanagerConfiguration.global`](#obj-specalertmanagerconfigurationglobal)
      ...
      * [`obj spec.alertmanagerConfiguration.global.httpConfig`](#obj-specalertmanagerconfigurationglobalhttpconfig)
        * [`fn withEnableHttp2(enableHttp2)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithenablehttp2)
        * [`fn withFollowRedirects(followRedirects)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithfollowredirects)
        * [`fn withNoProxy(noProxy)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithnoproxy)
        * [`fn withProxyConnectHeader(proxyConnectHeader)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithproxyconnectheader)
        * [`fn withProxyConnectHeaderMixin(proxyConnectHeader)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithproxyconnectheadermixin)
        * [`fn withProxyFromEnvironment(proxyFromEnvironment)`](#fn-specalertmanagerconfigurationglobalhttpconfigwithproxyfromenvironment)
        ...
        * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2)
          ...
          * [`fn withNoProxy(noProxy)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2withnoproxy)
          * [`fn withProxyConnectHeader(proxyConnectHeader)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2withproxyconnectheader)
          * [`fn withProxyConnectHeaderMixin(proxyConnectHeader)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2withproxyconnectheadermixin)
          * [`fn withProxyFromEnvironment(proxyFromEnvironment)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2withproxyfromenvironment)
          * [`fn withProxyUrl(proxyUrl)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2withproxyurl)
          ...
          * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfig)
            * [`fn withInsecureSkipVerify(insecureSkipVerify)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigwithinsecureskipverify)
            * [`fn withMaxVersion(maxVersion)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigwithmaxversion)
            * [`fn withMinVersion(minVersion)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigwithminversion)
            * [`fn withServerName(serverName)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigwithservername)
            * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigca)
              * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.configMap`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcaconfigmap)
                ...
                * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcaconfigmapwithname)
                * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcaconfigmapwithoptional)
              * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.secret`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcasecret)
                ...
                * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcasecretwithname)
                * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcasecretwithoptional)
            * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcert)
              * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.configMap`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertconfigmap)
                * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertconfigmapwithkey)
                * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertconfigmapwithname)
                * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertconfigmapwithoptional)
              * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.secret`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertsecret)
                * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertsecretwithkey)
                * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertsecretwithname)
                * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigcertsecretwithoptional)
            * [`obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.keySecret`](#obj-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigkeysecret)
              * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigkeysecretwithkey)
              * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalhttpconfigoauth2tlsconfigkeysecretwithname)
        ...
        * [`obj spec.alertmanagerConfiguration.global.httpConfig.tlsConfig`](#obj-specalertmanagerconfigurationglobalhttpconfigtlsconfig)
          ...
          * [`fn withMaxVersion(maxVersion)`](#fn-specalertmanagerconfigurationglobalhttpconfigtlsconfigwithmaxversion)
          * [`fn withMinVersion(minVersion)`](#fn-specalertmanagerconfigurationglobalhttpconfigtlsconfigwithminversion)
      ...
      * [`obj spec.alertmanagerConfiguration.global.jira`](#obj-specalertmanagerconfigurationglobaljira)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobaljirawithapiurl)
      ...
      * [`obj spec.alertmanagerConfiguration.global.rocketChat`](#obj-specalertmanagerconfigurationglobalrocketchat)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobalrocketchatwithapiurl)
        * [`obj spec.alertmanagerConfiguration.global.rocketChat.token`](#obj-specalertmanagerconfigurationglobalrocketchattoken)
          * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalrocketchattokenwithkey)
          * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalrocketchattokenwithname)
          * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalrocketchattokenwithoptional)
        * [`obj spec.alertmanagerConfiguration.global.rocketChat.tokenID`](#obj-specalertmanagerconfigurationglobalrocketchattokenid)
          * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalrocketchattokenidwithkey)
          * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalrocketchattokenidwithname)
          * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalrocketchattokenidwithoptional)
      ...
      * [`obj spec.alertmanagerConfiguration.global.smtp`](#obj-specalertmanagerconfigurationglobalsmtp)
        ...
        * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig`](#obj-specalertmanagerconfigurationglobalsmtptlsconfig)
          * [`fn withInsecureSkipVerify(insecureSkipVerify)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigwithinsecureskipverify)
          * [`fn withMaxVersion(maxVersion)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigwithmaxversion)
          * [`fn withMinVersion(minVersion)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigwithminversion)
          * [`fn withServerName(serverName)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigwithservername)
          * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigca)
            * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.configMap`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigcaconfigmap)
              * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcaconfigmapwithkey)
              * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcaconfigmapwithname)
              * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcaconfigmapwithoptional)
            * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.secret`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigcasecret)
              * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcasecretwithkey)
              * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcasecretwithname)
              * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcasecretwithoptional)
          * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigcert)
            * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.configMap`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigcertconfigmap)
              * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertconfigmapwithkey)
              * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertconfigmapwithname)
              * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertconfigmapwithoptional)
            * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.secret`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigcertsecret)
              * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertsecretwithkey)
              * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertsecretwithname)
              * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigcertsecretwithoptional)
          * [`obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.keySecret`](#obj-specalertmanagerconfigurationglobalsmtptlsconfigkeysecret)
            * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigkeysecretwithkey)
            * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigkeysecretwithname)
            * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalsmtptlsconfigkeysecretwithoptional)
      * [`obj spec.alertmanagerConfiguration.global.telegram`](#obj-specalertmanagerconfigurationglobaltelegram)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobaltelegramwithapiurl)
      * [`obj spec.alertmanagerConfiguration.global.victorops`](#obj-specalertmanagerconfigurationglobalvictorops)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobalvictoropswithapiurl)
        * [`obj spec.alertmanagerConfiguration.global.victorops.apiKey`](#obj-specalertmanagerconfigurationglobalvictoropsapikey)
          * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalvictoropsapikeywithkey)
          * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalvictoropsapikeywithname)
          * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalvictoropsapikeywithoptional)
      * [`obj spec.alertmanagerConfiguration.global.webex`](#obj-specalertmanagerconfigurationglobalwebex)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobalwebexwithapiurl)
      * [`obj spec.alertmanagerConfiguration.global.wechat`](#obj-specalertmanagerconfigurationglobalwechat)
        * [`fn withApiCorpID(apiCorpID)`](#fn-specalertmanagerconfigurationglobalwechatwithapicorpid)
        * [`fn withApiURL(apiURL)`](#fn-specalertmanagerconfigurationglobalwechatwithapiurl)
        * [`obj spec.alertmanagerConfiguration.global.wechat.apiSecret`](#obj-specalertmanagerconfigurationglobalwechatapisecret)
          * [`fn withKey(key)`](#fn-specalertmanagerconfigurationglobalwechatapisecretwithkey)
          * [`fn withName(name)`](#fn-specalertmanagerconfigurationglobalwechatapisecretwithname)
          * [`fn withOptional(optional)`](#fn-specalertmanagerconfigurationglobalwechatapisecretwithoptional)
  ...
  * [`obj spec.clusterTLS`](#obj-specclustertls)
    * [`obj spec.clusterTLS.client`](#obj-specclustertlsclient)
      * [`fn withInsecureSkipVerify(insecureSkipVerify)`](#fn-specclustertlsclientwithinsecureskipverify)
      * [`fn withMaxVersion(maxVersion)`](#fn-specclustertlsclientwithmaxversion)
      * [`fn withMinVersion(minVersion)`](#fn-specclustertlsclientwithminversion)
      * [`fn withServerName(serverName)`](#fn-specclustertlsclientwithservername)
      * [`obj spec.clusterTLS.client.ca`](#obj-specclustertlsclientca)
        * [`obj spec.clusterTLS.client.ca.configMap`](#obj-specclustertlsclientcaconfigmap)
          * [`fn withKey(key)`](#fn-specclustertlsclientcaconfigmapwithkey)
          * [`fn withName(name)`](#fn-specclustertlsclientcaconfigmapwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsclientcaconfigmapwithoptional)
        * [`obj spec.clusterTLS.client.ca.secret`](#obj-specclustertlsclientcasecret)
          * [`fn withKey(key)`](#fn-specclustertlsclientcasecretwithkey)
          * [`fn withName(name)`](#fn-specclustertlsclientcasecretwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsclientcasecretwithoptional)
      * [`obj spec.clusterTLS.client.cert`](#obj-specclustertlsclientcert)
        * [`obj spec.clusterTLS.client.cert.configMap`](#obj-specclustertlsclientcertconfigmap)
          * [`fn withKey(key)`](#fn-specclustertlsclientcertconfigmapwithkey)
          * [`fn withName(name)`](#fn-specclustertlsclientcertconfigmapwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsclientcertconfigmapwithoptional)
        * [`obj spec.clusterTLS.client.cert.secret`](#obj-specclustertlsclientcertsecret)
          * [`fn withKey(key)`](#fn-specclustertlsclientcertsecretwithkey)
          * [`fn withName(name)`](#fn-specclustertlsclientcertsecretwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsclientcertsecretwithoptional)
      * [`obj spec.clusterTLS.client.keySecret`](#obj-specclustertlsclientkeysecret)
        * [`fn withKey(key)`](#fn-specclustertlsclientkeysecretwithkey)
        * [`fn withName(name)`](#fn-specclustertlsclientkeysecretwithname)
        * [`fn withOptional(optional)`](#fn-specclustertlsclientkeysecretwithoptional)
    * [`obj spec.clusterTLS.server`](#obj-specclustertlsserver)
      * [`fn withCertFile(certFile)`](#fn-specclustertlsserverwithcertfile)
      * [`fn withCipherSuites(cipherSuites)`](#fn-specclustertlsserverwithciphersuites)
      * [`fn withCipherSuitesMixin(cipherSuites)`](#fn-specclustertlsserverwithciphersuitesmixin)
      * [`fn withClientAuthType(clientAuthType)`](#fn-specclustertlsserverwithclientauthtype)
      * [`fn withClientCAFile(clientCAFile)`](#fn-specclustertlsserverwithclientcafile)
      * [`fn withCurvePreferences(curvePreferences)`](#fn-specclustertlsserverwithcurvepreferences)
      * [`fn withCurvePreferencesMixin(curvePreferences)`](#fn-specclustertlsserverwithcurvepreferencesmixin)
      * [`fn withKeyFile(keyFile)`](#fn-specclustertlsserverwithkeyfile)
      * [`fn withMaxVersion(maxVersion)`](#fn-specclustertlsserverwithmaxversion)
      * [`fn withMinVersion(minVersion)`](#fn-specclustertlsserverwithminversion)
      * [`fn withPreferServerCipherSuites(preferServerCipherSuites)`](#fn-specclustertlsserverwithpreferserverciphersuites)
      * [`obj spec.clusterTLS.server.cert`](#obj-specclustertlsservercert)
        * [`obj spec.clusterTLS.server.cert.configMap`](#obj-specclustertlsservercertconfigmap)
          * [`fn withKey(key)`](#fn-specclustertlsservercertconfigmapwithkey)
          * [`fn withName(name)`](#fn-specclustertlsservercertconfigmapwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsservercertconfigmapwithoptional)
        * [`obj spec.clusterTLS.server.cert.secret`](#obj-specclustertlsservercertsecret)
          * [`fn withKey(key)`](#fn-specclustertlsservercertsecretwithkey)
          * [`fn withName(name)`](#fn-specclustertlsservercertsecretwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsservercertsecretwithoptional)
      * [`obj spec.clusterTLS.server.client_ca`](#obj-specclustertlsserverclient_ca)
        * [`obj spec.clusterTLS.server.client_ca.configMap`](#obj-specclustertlsserverclient_caconfigmap)
          * [`fn withKey(key)`](#fn-specclustertlsserverclient_caconfigmapwithkey)
          * [`fn withName(name)`](#fn-specclustertlsserverclient_caconfigmapwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsserverclient_caconfigmapwithoptional)
        * [`obj spec.clusterTLS.server.client_ca.secret`](#obj-specclustertlsserverclient_casecret)
          * [`fn withKey(key)`](#fn-specclustertlsserverclient_casecretwithkey)
          * [`fn withName(name)`](#fn-specclustertlsserverclient_casecretwithname)
          * [`fn withOptional(optional)`](#fn-specclustertlsserverclient_casecretwithoptional)
      * [`obj spec.clusterTLS.server.keySecret`](#obj-specclustertlsserverkeysecret)
        * [`fn withKey(key)`](#fn-specclustertlsserverkeysecretwithkey)
        * [`fn withName(name)`](#fn-specclustertlsserverkeysecretwithname)
        * [`fn withOptional(optional)`](#fn-specclustertlsserverkeysecretwithoptional)
  * [`obj spec.containers`](#obj-speccontainers)
    ...
    * [`fn withRestartPolicyRules(restartPolicyRules)`](#fn-speccontainerswithrestartpolicyrules)
    * [`fn withRestartPolicyRulesMixin(restartPolicyRules)`](#fn-speccontainerswithrestartpolicyrulesmixin)
    ...
    * [`obj spec.containers.env`](#obj-speccontainersenv)
      ...
      * [`obj spec.containers.env.valueFrom`](#obj-speccontainersenvvaluefrom)
        ...
        * [`obj spec.containers.env.valueFrom.fileKeyRef`](#obj-speccontainersenvvaluefromfilekeyref)
          * [`fn withKey(key)`](#fn-speccontainersenvvaluefromfilekeyrefwithkey)
          * [`fn withOptional(optional)`](#fn-speccontainersenvvaluefromfilekeyrefwithoptional)
          * [`fn withPath(path)`](#fn-speccontainersenvvaluefromfilekeyrefwithpath)
          * [`fn withVolumeName(volumeName)`](#fn-speccontainersenvvaluefromfilekeyrefwithvolumename)
    ...
    * [`obj spec.containers.lifecycle`](#obj-speccontainerslifecycle)
      * [`fn withStopSignal(stopSignal)`](#fn-speccontainerslifecyclewithstopsignal)
    ...
    * [`obj spec.containers.restartPolicyRules`](#obj-speccontainersrestartpolicyrules)
      * [`fn withAction(action)`](#fn-speccontainersrestartpolicyruleswithaction)
      * [`obj spec.containers.restartPolicyRules.exitCodes`](#obj-speccontainersrestartpolicyrulesexitcodes)
        * [`fn withOperator(operator)`](#fn-speccontainersrestartpolicyrulesexitcodeswithoperator)
        * [`fn withValues(values)`](#fn-speccontainersrestartpolicyrulesexitcodeswithvalues)
        * [`fn withValuesMixin(values)`](#fn-speccontainersrestartpolicyrulesexitcodeswithvaluesmixin)
  ...
  * [`obj spec.initContainers`](#obj-specinitcontainers)
    ...
    * [`fn withRestartPolicyRules(restartPolicyRules)`](#fn-specinitcontainerswithrestartpolicyrules)
    * [`fn withRestartPolicyRulesMixin(restartPolicyRules)`](#fn-specinitcontainerswithrestartpolicyrulesmixin)
    ...
    * [`obj spec.initContainers.env`](#obj-specinitcontainersenv)
      ...
      * [`obj spec.initContainers.env.valueFrom`](#obj-specinitcontainersenvvaluefrom)
        ...
        * [`obj spec.initContainers.env.valueFrom.fileKeyRef`](#obj-specinitcontainersenvvaluefromfilekeyref)
          * [`fn withKey(key)`](#fn-specinitcontainersenvvaluefromfilekeyrefwithkey)
          * [`fn withOptional(optional)`](#fn-specinitcontainersenvvaluefromfilekeyrefwithoptional)
          * [`fn withPath(path)`](#fn-specinitcontainersenvvaluefromfilekeyrefwithpath)
          * [`fn withVolumeName(volumeName)`](#fn-specinitcontainersenvvaluefromfilekeyrefwithvolumename)
    ...
    * [`obj spec.initContainers.restartPolicyRules`](#obj-specinitcontainersrestartpolicyrules)
      * [`fn withAction(action)`](#fn-specinitcontainersrestartpolicyruleswithaction)
      * [`obj spec.initContainers.restartPolicyRules.exitCodes`](#obj-specinitcontainersrestartpolicyrulesexitcodes)
        * [`fn withOperator(operator)`](#fn-specinitcontainersrestartpolicyrulesexitcodeswithoperator)
        * [`fn withValues(values)`](#fn-specinitcontainersrestartpolicyrulesexitcodeswithvalues)
        * [`fn withValuesMixin(values)`](#fn-specinitcontainersrestartpolicyrulesexitcodeswithvaluesmixin)
  ...
  * [`obj spec.limits`](#obj-speclimits)
    * [`fn withMaxPerSilenceBytes(maxPerSilenceBytes)`](#fn-speclimitswithmaxpersilencebytes)
    * [`fn withMaxSilences(maxSilences)`](#fn-speclimitswithmaxsilences)
  ...
  * [`obj spec.volumes`](#obj-specvolumes)
    ...
    * [`obj spec.volumes.projected`](#obj-specvolumesprojected)
      ...
      * [`obj spec.volumes.projected.sources`](#obj-specvolumesprojectedsources)
        ...
        * [`obj spec.volumes.projected.sources.podCertificate`](#obj-specvolumesprojectedsourcespodcertificate)
          * [`fn withCertificateChainPath(certificateChainPath)`](#fn-specvolumesprojectedsourcespodcertificatewithcertificatechainpath)
          * [`fn withCredentialBundlePath(credentialBundlePath)`](#fn-specvolumesprojectedsourcespodcertificatewithcredentialbundlepath)
          * [`fn withKeyPath(keyPath)`](#fn-specvolumesprojectedsourcespodcertificatewithkeypath)
          * [`fn withKeyType(keyType)`](#fn-specvolumesprojectedsourcespodcertificatewithkeytype)
          * [`fn withMaxExpirationSeconds(maxExpirationSeconds)`](#fn-specvolumesprojectedsourcespodcertificatewithmaxexpirationseconds)
          * [`fn withSignerName(signerName)`](#fn-specvolumesprojectedsourcespodcertificatewithsignername)
  ...
  * [`obj spec.web`](#obj-specweb)
    * [`fn withGetConcurrency(getConcurrency)`](#fn-specwebwithgetconcurrency)
    * [`fn withTimeout(timeout)`](#fn-specwebwithtimeout)
...
### fn spec.withClusterLabel

```ts
withClusterLabel(clusterLabel)
```
...
### fn spec.alertmanagerConfiguration.global.httpConfig.withEnableHttp2
...
### fn spec.alertmanagerConfiguration.global.httpConfig.withNoProxy
...
### fn spec.alertmanagerConfiguration.global.httpConfig.withProxyConnectHeader
...
### fn spec.alertmanagerConfiguration.global.httpConfig.withProxyConnectHeaderMixin
...
### fn spec.alertmanagerConfiguration.global.httpConfig.withProxyFromEnvironment
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.withNoProxy
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.withProxyConnectHeader
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.withProxyConnectHeaderMixin
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.withProxyFromEnvironment
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.withProxyUrl
...
## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig

"tlsConfig defines the TLS configuration to use when connecting to the OAuth2 server.\nIt requires Prometheus >= v2.43.0."

### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.withInsecureSkipVerify
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.withMaxVersion
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.withMinVersion
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.withServerName
...
## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca

"ca defines the Certificate authority used when verifying server certificates."

## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.configMap.withKey
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.configMap.withName
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.configMap.withOptional
...
## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.secret.withKey
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.secret.withName
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.ca.secret.withOptional
...
## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert

"cert defines the Client certificate to present when doing client-authentication."

## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.configMap.withKey
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.configMap.withName
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.configMap.withOptional
...
## obj spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.secret.withKey
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.secret.withName
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.cert.secret.withOptional
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.keySecret.withKey
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.keySecret.withName
...
### fn spec.alertmanagerConfiguration.global.httpConfig.oauth2.tlsConfig.keySecret.withOptional
...
### fn spec.alertmanagerConfiguration.global.httpConfig.tlsConfig.withMaxVersion
...
### fn spec.alertmanagerConfiguration.global.httpConfig.tlsConfig.withMinVersion
...
## obj spec.alertmanagerConfiguration.global.jira

"jira defines the default configuration for Jira."

### fn spec.alertmanagerConfiguration.global.jira.withApiURL
...
## obj spec.alertmanagerConfiguration.global.rocketChat

"rocketChat defines the default configuration for Rocket Chat."

### fn spec.alertmanagerConfiguration.global.rocketChat.withApiURL
...
## obj spec.alertmanagerConfiguration.global.rocketChat.token

"token defines the default Rocket Chat token.\n\nIt requires Alertmanager >= v0.28.0."

### fn spec.alertmanagerConfiguration.global.rocketChat.token.withKey
...
### fn spec.alertmanagerConfiguration.global.rocketChat.token.withName
...
### fn spec.alertmanagerConfiguration.global.rocketChat.token.withOptional
...
## obj spec.alertmanagerConfiguration.global.rocketChat.tokenID

"tokenID defines the default Rocket Chat Token ID.\n\nIt requires Alertmanager >= v0.28.0."

### fn spec.alertmanagerConfiguration.global.rocketChat.tokenID.withKey
...
### fn spec.alertmanagerConfiguration.global.rocketChat.tokenID.withName
...
### fn spec.alertmanagerConfiguration.global.rocketChat.tokenID.withOptional
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig

"tlsConfig defines the default TLS configuration for SMTP receivers"

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.withInsecureSkipVerify
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.withMaxVersion
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.withMinVersion
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.withServerName
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca

"ca defines the Certificate authority used when verifying server certificates."

## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.configMap.withKey
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.configMap.withName
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.configMap.withOptional
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.secret.withKey
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.secret.withName
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.ca.secret.withOptional
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert

"cert defines the Client certificate to present when doing client-authentication."

## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.configMap.withKey
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.configMap.withName
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.configMap.withOptional
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.secret.withKey
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.secret.withName
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.cert.secret.withOptional
...
## obj spec.alertmanagerConfiguration.global.smtp.tlsConfig.keySecret

"keySecret defines the Secret containing the client key file for the targets."

### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.keySecret.withKey
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.keySecret.withName
...
### fn spec.alertmanagerConfiguration.global.smtp.tlsConfig.keySecret.withOptional
...
## obj spec.alertmanagerConfiguration.global.telegram

"telegram defines the default Telegram config"

### fn spec.alertmanagerConfiguration.global.telegram.withApiURL
...
## obj spec.alertmanagerConfiguration.global.victorops

"victorops defines the default configuration for VictorOps."

### fn spec.alertmanagerConfiguration.global.victorops.withApiURL
...
## obj spec.alertmanagerConfiguration.global.victorops.apiKey

"apiKey defines the default VictorOps API Key."

### fn spec.alertmanagerConfiguration.global.victorops.apiKey.withKey
...
### fn spec.alertmanagerConfiguration.global.victorops.apiKey.withName
...
### fn spec.alertmanagerConfiguration.global.victorops.apiKey.withOptional
...
## obj spec.alertmanagerConfiguration.global.webex

"webex defines the default configuration for Jira."

### fn spec.alertmanagerConfiguration.global.webex.withApiURL
...
## obj spec.alertmanagerConfiguration.global.wechat

"wechat defines the default WeChat Config"

### fn spec.alertmanagerConfiguration.global.wechat.withApiCorpID

```ts
withApiCorpID(apiCorpID)
```

"apiCorpID defines the default WeChat API Corporate ID."

### fn spec.alertmanagerConfiguration.global.wechat.withApiURL
...
## obj spec.alertmanagerConfiguration.global.wechat.apiSecret

"apiSecret defines the default WeChat API Secret."

### fn spec.alertmanagerConfiguration.global.wechat.apiSecret.withKey
...
### fn spec.alertmanagerConfiguration.global.wechat.apiSecret.withName
...
### fn spec.alertmanagerConfiguration.global.wechat.apiSecret.withOptional
...
## obj spec.clusterTLS.client

"client defines the client-side configuration for mutual TLS."

### fn spec.clusterTLS.client.withInsecureSkipVerify
...
### fn spec.clusterTLS.client.withMaxVersion
...
### fn spec.clusterTLS.client.withMinVersion
...
### fn spec.clusterTLS.client.withServerName
...
## obj spec.clusterTLS.client.ca

"ca defines the Certificate authority used when verifying server certificates."

## obj spec.clusterTLS.client.ca.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.clusterTLS.client.ca.configMap.withKey
...
### fn spec.clusterTLS.client.ca.configMap.withName
...
### fn spec.clusterTLS.client.ca.configMap.withOptional
...
## obj spec.clusterTLS.client.ca.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.clusterTLS.client.ca.secret.withKey
...
### fn spec.clusterTLS.client.ca.secret.withName
...
### fn spec.clusterTLS.client.ca.secret.withOptional
...
## obj spec.clusterTLS.client.cert

"cert defines the Client certificate to present when doing client-authentication."

## obj spec.clusterTLS.client.cert.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.clusterTLS.client.cert.configMap.withKey
...
### fn spec.clusterTLS.client.cert.configMap.withName
...
### fn spec.clusterTLS.client.cert.configMap.withOptional
...
## obj spec.clusterTLS.client.cert.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.clusterTLS.client.cert.secret.withKey
...
### fn spec.clusterTLS.client.cert.secret.withName
...
### fn spec.clusterTLS.client.cert.secret.withOptional
...
## obj spec.clusterTLS.client.keySecret

"keySecret defines the Secret containing the client key file for the targets."

### fn spec.clusterTLS.client.keySecret.withKey
...
### fn spec.clusterTLS.client.keySecret.withName
...
### fn spec.clusterTLS.client.keySecret.withOptional
...
## obj spec.clusterTLS.server

"server defines the server-side configuration for mutual TLS."

### fn spec.clusterTLS.server.withCertFile
...
### fn spec.clusterTLS.server.withCipherSuites
...
### fn spec.clusterTLS.server.withCipherSuitesMixin
...
### fn spec.clusterTLS.server.withClientAuthType
...
### fn spec.clusterTLS.server.withClientCAFile
...
### fn spec.clusterTLS.server.withCurvePreferences
...
### fn spec.clusterTLS.server.withCurvePreferencesMixin
...
### fn spec.clusterTLS.server.withKeyFile
...
### fn spec.clusterTLS.server.withMaxVersion
...
### fn spec.clusterTLS.server.withMinVersion
...
### fn spec.clusterTLS.server.withPreferServerCipherSuites
...
## obj spec.clusterTLS.server.cert
...
## obj spec.clusterTLS.server.cert.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.clusterTLS.server.cert.configMap.withKey
...
### fn spec.clusterTLS.server.cert.configMap.withName
...
### fn spec.clusterTLS.server.cert.configMap.withOptional
...
## obj spec.clusterTLS.server.cert.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.clusterTLS.server.cert.secret.withKey
...
### fn spec.clusterTLS.server.cert.secret.withName
...
### fn spec.clusterTLS.server.cert.secret.withOptional
...
## obj spec.clusterTLS.server.client_ca

"client_ca defines the Secret or ConfigMap containing the CA certificate for client certificate\nauthentication to the server.\n\nIt is mutually exclusive with `clientCAFile`."

## obj spec.clusterTLS.server.client_ca.configMap

"configMap defines the ConfigMap containing data to use for the targets."

### fn spec.clusterTLS.server.client_ca.configMap.withKey
...
### fn spec.clusterTLS.server.client_ca.configMap.withName
...
### fn spec.clusterTLS.server.client_ca.configMap.withOptional
...
## obj spec.clusterTLS.server.client_ca.secret

"secret defines the Secret containing data to use for the targets."

### fn spec.clusterTLS.server.client_ca.secret.withKey
...
### fn spec.clusterTLS.server.client_ca.secret.withName
...
### fn spec.clusterTLS.server.client_ca.secret.withOptional
...
## obj spec.clusterTLS.server.keySecret
...
### fn spec.clusterTLS.server.keySecret.withKey
...
### fn spec.clusterTLS.server.keySecret.withName
...
### fn spec.clusterTLS.server.keySecret.withOptional
...
### fn spec.containers.withRestartPolicyRules
...
### fn spec.containers.withRestartPolicyRulesMixin
...
## obj spec.containers.env.valueFrom.fileKeyRef

"FileKeyRef selects a key of the env file.\nRequires the EnvFiles feature gate to be enabled."

### fn spec.containers.env.valueFrom.fileKeyRef.withKey
...
### fn spec.containers.env.valueFrom.fileKeyRef.withOptional
...
### fn spec.containers.env.valueFrom.fileKeyRef.withPath
...
### fn spec.containers.env.valueFrom.fileKeyRef.withVolumeName
...
### fn spec.containers.lifecycle.withStopSignal
...
## obj spec.containers.restartPolicyRules

"Represents a list of rules to be checked to determine if the\ncontainer should be restarted on exit. The rules are evaluated in\norder. Once a rule matches a container exit condition, the remaining\nrules are ignored. If no rule matches the container exit condition,\nthe Container-level restart policy determines the whether the container\nis restarted or not. Constraints on the rules:\n- At most 20 rules are allowed.\n- Rules can have the same action.\n- Identical rules are not forbidden in validations.\nWhen rules are specified, container MUST set RestartPolicy explicitly\neven it if matches the Pod's RestartPolicy."

### fn spec.containers.restartPolicyRules.withAction
...
## obj spec.containers.restartPolicyRules.exitCodes

"Represents the exit codes to check on container exits."

### fn spec.containers.restartPolicyRules.exitCodes.withOperator
...
### fn spec.containers.restartPolicyRules.exitCodes.withValues
...
### fn spec.containers.restartPolicyRules.exitCodes.withValuesMixin
...
### fn spec.initContainers.withRestartPolicyRules
...
### fn spec.initContainers.withRestartPolicyRulesMixin
...
## obj spec.initContainers.env.valueFrom.fileKeyRef

"FileKeyRef selects a key of the env file.\nRequires the EnvFiles feature gate to be enabled."

### fn spec.initContainers.env.valueFrom.fileKeyRef.withKey
...
### fn spec.initContainers.env.valueFrom.fileKeyRef.withOptional
...
### fn spec.initContainers.env.valueFrom.fileKeyRef.withPath
...
### fn spec.initContainers.env.valueFrom.fileKeyRef.withVolumeName
...
## obj spec.initContainers.restartPolicyRules

"Represents a list of rules to be checked to determine if the\ncontainer should be restarted on exit. The rules are evaluated in\norder. Once a rule matches a container exit condition, the remaining\nrules are ignored. If no rule matches the container exit condition,\nthe Container-level restart policy determines the whether the container\nis restarted or not. Constraints on the rules:\n- At most 20 rules are allowed.\n- Rules can have the same action.\n- Identical rules are not forbidden in validations.\nWhen rules are specified, container MUST set RestartPolicy explicitly\neven it if matches the Pod's RestartPolicy."

### fn spec.initContainers.restartPolicyRules.withAction
...
## obj spec.initContainers.restartPolicyRules.exitCodes

"Represents the exit codes to check on container exits."

### fn spec.initContainers.restartPolicyRules.exitCodes.withOperator
...
### fn spec.initContainers.restartPolicyRules.exitCodes.withValues
...
### fn spec.initContainers.restartPolicyRules.exitCodes.withValuesMixin
...
### fn spec.limits.withMaxPerSilenceBytes

```ts
withMaxPerSilenceBytes(maxPerSilenceBytes)
```
...
### fn spec.limits.withMaxSilences

```ts
withMaxSilences(maxSilences)
```
...
## obj spec.volumes.projected.sources.podCertificate
...
### fn spec.volumes.projected.sources.podCertificate.withCertificateChainPath
...
### fn spec.volumes.projected.sources.podCertificate.withCredentialBundlePath
...
### fn spec.volumes.projected.sources.podCertificate.withKeyPath
...
### fn spec.volumes.projected.sources.podCertificate.withKeyType
...
### fn spec.volumes.projected.sources.podCertificate.withMaxExpirationSeconds
...
### fn spec.volumes.projected.sources.podCertificate.withSignerName
