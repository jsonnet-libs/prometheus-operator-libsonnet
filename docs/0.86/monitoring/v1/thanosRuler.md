---
permalink: /0.86/monitoring/v1/thanosRuler/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withResendDelay(resendDelay)`](#fn-specwithresenddelay)
  * [`fn withRetention(retention)`](#fn-specwithretention)
  * [`fn withRoutePrefix(routePrefix)`](#fn-specwithrouteprefix)
  * [`fn withRuleConcurrentEval(ruleConcurrentEval)`](#fn-specwithruleconcurrenteval)
  * [`fn withRuleGracePeriod(ruleGracePeriod)`](#fn-specwithrulegraceperiod)
  * [`fn withRuleOutageTolerance(ruleOutageTolerance)`](#fn-specwithruleoutagetolerance)
...
### fn spec.withRuleConcurrentEval

```ts
withRuleConcurrentEval(ruleConcurrentEval)
```

"ruleConcurrentEval defines how many rules can be evaluated concurrently.\nIt requires Thanos >= v0.37.0."

### fn spec.withRuleGracePeriod

```ts
withRuleGracePeriod(ruleGracePeriod)
```
...
### fn spec.withRuleOutageTolerance

```ts
withRuleOutageTolerance(ruleOutageTolerance)
```
...
### fn spec.grpcServerTlsConfig.withMaxVersion
...
### fn spec.grpcServerTlsConfig.withMinVersion
