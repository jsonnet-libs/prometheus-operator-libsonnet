---
permalink: /0.85/monitoring/v1/probe/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.params`](#obj-specparams)
    * [`fn withName(name)`](#fn-specparamswithname)
    * [`fn withValues(values)`](#fn-specparamswithvalues)
    * [`fn withValuesMixin(values)`](#fn-specparamswithvaluesmixin)
  * [`obj spec.prober`](#obj-specprober)
    * [`fn withNoProxy(noProxy)`](#fn-specproberwithnoproxy)
    * [`fn withPath(path)`](#fn-specproberwithpath)
    * [`fn withProxyConnectHeader(proxyConnectHeader)`](#fn-specproberwithproxyconnectheader)
    * [`fn withProxyConnectHeaderMixin(proxyConnectHeader)`](#fn-specproberwithproxyconnectheadermixin)
    * [`fn withProxyFromEnvironment(proxyFromEnvironment)`](#fn-specproberwithproxyfromenvironment)
...
### fn spec.params.withValuesMixin
...
### fn spec.prober.withProxyConnectHeader
...
### fn spec.prober.withProxyConnectHeaderMixin
...
### fn spec.prober.withProxyFromEnvironment
