{
  ...
  spec: {
    ...
    '#alertmanagersConfig':: d.obj(help='"Define configuration for connecting to alertmanager.  Only available with thanos v0.10.0\\nand higher.  Maps to the `alertmanagers.config` arg."'),
    alertmanagersConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#objectStorageConfig':: d.obj(help='"ObjectStorageConfig configures object storage in Thanos.\\nAlternative to ObjectStorageConfigFile, and lower order priority."'),
    objectStorageConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#ruleSelector':: d.obj(help='"A label selector to select which PrometheusRules to mount for alerting and\\nrecording."'),
    ruleSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#withAlertDropLabels':: d.fn(help='"AlertDropLabels configure the label names which should be dropped in ThanosRuler alerts.\\nThe replica label `thanos_ruler_replica` will always be dropped in alerts."', args=[d.arg(name='alertDropLabels', type=d.T.array)]),
    ...
    '#withAlertRelabelConfigFile':: d.fn(help='"AlertRelabelConfigFile specifies the path of the alert relabeling configuration file.\\nWhen used alongside with AlertRelabelConfigs, alertRelabelConfigFile takes precedence."', args=[d.arg(name='alertRelabelConfigFile', type=d.T.string)]),
    withAlertRelabelConfigFile(alertRelabelConfigFile): { spec+: { alertRelabelConfigFile: alertRelabelConfigFile } },
    '#withAlertmanagersUrl':: d.fn(help='"Define URLs to send alerts to Alertmanager.  For Thanos v0.10.0 and higher,\\nAlertManagersConfig should be used instead.  Note: this field will be ignored\\nif AlertManagersConfig is specified.\\nMaps to the `alertmanagers.url` arg."', args=[d.arg(name='alertmanagersUrl', type=d.T.array)]),
    ...
    '#withLabels':: d.fn(help="\"Labels configure the external label pairs to ThanosRuler. A default replica label\\n`thanos_ruler_replica` will be always added  as a label with the value of the pod's name and it will be dropped in the alerts.\"", args=[d.arg(name='labels', type=d.T.object)]),
    withLabels(labels): { spec+: { labels: labels } },
    '#withLabelsMixin':: d.fn(help="\"Labels configure the external label pairs to ThanosRuler. A default replica label\\n`thanos_ruler_replica` will be always added  as a label with the value of the pod's name and it will be dropped in the alerts.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='labels', type=d.T.object)]),
    ...
    '#withObjectStorageConfigFile':: d.fn(help='"ObjectStorageConfigFile specifies the path of the object storage configuration file.\\nWhen used alongside with ObjectStorageConfig, ObjectStorageConfigFile takes precedence."', args=[d.arg(name='objectStorageConfigFile', type=d.T.string)]),
    ...
    '#withQueryEndpoints':: d.fn(help='"QueryEndpoints defines Thanos querier endpoints from which to query metrics.\\nMaps to the --query flag of thanos ruler."', args=[d.arg(name='queryEndpoints', type=d.T.array)]),
