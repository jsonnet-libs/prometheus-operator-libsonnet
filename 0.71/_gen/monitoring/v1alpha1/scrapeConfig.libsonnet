{
  ...
  spec: {
    ...
    dnsSDConfigs: {
      ...
      withRefreshInterval(refreshInterval): { refreshInterval: refreshInterval },
      '#withType':: d.fn(help='"The type of DNS query to perform. One of SRV, A, AAAA or MX. If not set, Prometheus uses its default value."', args=[d.arg(name='type', type=d.T.string)]),
