{
  ...
  spec: {
    ...
    alertmanagerConfiguration: {
      ...
      global: {
        ...
        smtp: {
          ...
          '#withRequireTLS':: d.fn(help='"The default SMTP TLS requirement. Note that Go does not support unencrypted connections to remote SMTP endpoints."', args=[d.arg(name='requireTLS', type=d.T.boolean)]),
    ...
    web: {
      ...
      '#withGetConcurrency':: d.fn(help="\"Maximum number of GET requests processed concurrently. This corresponds to the Alertmanager's `--web.get-concurrency` flag.\"", args=[d.arg(name='getConcurrency', type=d.T.integer)]),
      withGetConcurrency(getConcurrency): { spec+: { web+: { getConcurrency: getConcurrency } } },
      '#withTimeout':: d.fn(help="\"Timeout for HTTP requests. This corresponds to the Alertmanager's `--web.timeout` flag.\"", args=[d.arg(name='timeout', type=d.T.integer)]),
    ...
    '#withAutomountServiceAccountToken':: d.fn(help='"AutomountServiceAccountToken indicates whether a service account token should be automatically mounted in the pod. If the service account has `automountServiceAccountToken: true`, set the field to `false` to opt out of automounting API credentials."', args=[d.arg(name='automountServiceAccountToken', type=d.T.boolean)]),
    ...
    '#withClusterLabel':: d.fn(help='"Defines the identifier that uniquely identifies the Alertmanager cluster. You should only set it when the Alertmanager cluster includes Alertmanager instances which are external to this Alertmanager resource. In practice, the addresses of the external instances are provided via the `.spec.additionalPeers` field."', args=[d.arg(name='clusterLabel', type=d.T.string)]),
