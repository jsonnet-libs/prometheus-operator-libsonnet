{
  ...
  spec: {
    ...
    '#probeNamespaceSelector':: d.obj(help='"*Experimental* Namespaces to match for Probe discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only."'),
    ...
    '#probeSelector':: d.obj(help="\"*Experimental* Probes to be selected for target discovery. An empty label selector matches all objects. A null label selector matches no objects. \\n If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is *deprecated* and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead.\""),
    probeSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#scrapeClasses':: d.obj(help='"EXPERIMENTAL List of scrape classes to expose to monitors and other scrape configs. This is experimental feature and might change in the future."'),
    scrapeClasses: {
    ...
    '#scrapeConfigNamespaceSelector':: d.obj(help='"Namespaces to match for ScrapeConfig discovery. An empty label selector matches all namespaces. A null label selector matches the current current namespace only."'),
    ...
    '#scrapeConfigSelector':: d.obj(help="\"*Experimental* ScrapeConfigs to be selected for target discovery. An empty label selector matches all objects. A null label selector matches no objects. \\n If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is *deprecated* and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead.\""),
    ...
    '#tracingConfig':: d.obj(help='"EXPERIMENTAL: TracingConfig configures tracing in Prometheus. This is an experimental feature, it may change in any upcoming release in a breaking way."'),
    tracingConfig: {
    ...
    '#withScrapeClasses':: d.fn(help='"EXPERIMENTAL List of scrape classes to expose to monitors and other scrape configs. This is experimental feature and might change in the future."', args=[d.arg(name='scrapeClasses', type=d.T.array)]),
    withScrapeClasses(scrapeClasses): { spec+: { scrapeClasses: if std.isArray(v=scrapeClasses) then scrapeClasses else [scrapeClasses] } },
    '#withScrapeClassesMixin':: d.fn(help='"EXPERIMENTAL List of scrape classes to expose to monitors and other scrape configs. This is experimental feature and might change in the future."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scrapeClasses', type=d.T.array)]),
