{
  ...
  spec: {
    ...
    '#alertmanagerConfigMatcherStrategy':: d.obj(help='"The AlertmanagerConfigMatcherStrategy defines how AlertmanagerConfig objects match the alerts.\\nIn the future more options may be added."'),
    alertmanagerConfigMatcherStrategy: {
      '#withType':: d.fn(help='"If set to `OnNamespace`, the operator injects a label matcher matching the namespace of the AlertmanagerConfig object for all its routes and inhibition rules.\\n`None` will not add any additional matchers other than the ones specified in the AlertmanagerConfig.\\nDefault is `OnNamespace`."', args=[d.arg(name='type', type=d.T.string)]),
