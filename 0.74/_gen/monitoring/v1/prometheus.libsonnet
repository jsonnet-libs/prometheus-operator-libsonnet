{
  ...
  spec: {
    ...
    '#tsdb':: d.obj(help='"Defines the runtime reloadable configuration of the timeseries database\\n(TSDB)."'),
    tsdb: {
    ...
    '#withBodySizeLimit':: d.fn(help='"BodySizeLimit defines per-scrape on response body size.\\nOnly valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='bodySizeLimit', type=d.T.string)]),
    ...
    '#withOverrideHonorLabels':: d.fn(help='"When true, Prometheus resolves label conflicts by renaming the labels in\\nthe scraped data to \\"exported_<label value>\\" for all targets created\\nfrom service and pod monitors.\\nOtherwise the HonorLabels field of the service or pod monitor applies."', args=[d.arg(name='overrideHonorLabels', type=d.T.boolean)]),
