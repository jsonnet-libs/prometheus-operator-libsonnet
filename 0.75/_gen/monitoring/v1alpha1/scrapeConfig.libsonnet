{
  ...
  spec: {
    ...
    dockerSwarmSDConfigs: {
      ...
      filters: {
        '#withName':: d.fn(help='"Name is the key of the field to check against."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValues':: d.fn(help='"Values is the value or set of values to check for a match."', args=[d.arg(name='values', type=d.T.array)]),
        withValues(values): { values: if std.isArray(v=values) then values else [values] },
        '#withValuesMixin':: d.fn(help='"Values is the value or set of values to check for a match."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
        withValuesMixin(values): { values+: if std.isArray(v=values) then values else [values] },
      },
