{
  ...
  spec: {
    ...
    additionalArgs: {
      ...
      '#withValue':: d.fn(help='"value defines the argument value, e.g. 30s. Can be empty for name-only arguments (e.g. --storage.tsdb.no-lockfile)"', args=[d.arg(name='value', type=d.T.string)]),
    ...
    '#affinity':: d.obj(help="\"affinity defines the Pods' affinity scheduling rules if specified.\""),
    affinity: {
    ...
    '#alerting':: d.obj(help='"alerting defines the settings related to Alertmanager."'),
    alerting: {
      '#alertmanagers':: d.obj(help='"alertmanagers endpoints where Prometheus should send alerts to."'),
      alertmanagers: {
        '#alertRelabelings':: d.obj(help='"alertRelabelings defines the relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."'),
        alertRelabelings: {
        ...
        '#relabelings':: d.obj(help='"relabelings defines the relabel configuration applied to the discovered Alertmanagers."'),
        relabelings: {
          '#withAction':: d.fn(help='"action to perform based on the regex matching.\\n\\n`Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0.\\n`DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.\\n\\nDefault: \\"Replace\\', args=[d.arg(name='action', type=d.T.string)]),
          withAction(action): { action: action },
          '#withModulus':: d.fn(help='"modulus to take of the hash of the source label values.\\n\\nOnly applicable when the action is `HashMod`."', args=[d.arg(name='modulus', type=d.T.integer)]),
        ...
        '#tlsConfig':: d.obj(help='"tlsConfig to use for Alertmanager."'),
        tlsConfig: {
          ...
          '#withCaFile':: d.fn(help='"caFile defines the path to the CA cert in the Prometheus container to use for the targets."', args=[d.arg(name='caFile', type=d.T.string)]),
          withCaFile(caFile): { tlsConfig+: { caFile: caFile } },
          '#withCertFile':: d.fn(help='"certFile defines the path to the client cert file in the Prometheus container for the targets."', args=[d.arg(name='certFile', type=d.T.string)]),
          ...
          '#withKeyFile':: d.fn(help='"keyFile defines the path to the client key file in the Prometheus container for the targets."', args=[d.arg(name='keyFile', type=d.T.string)]),
        ...
        '#withAlertRelabelings':: d.fn(help='"alertRelabelings defines the relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."', args=[d.arg(name='alertRelabelings', type=d.T.array)]),
        withAlertRelabelings(alertRelabelings): { alertRelabelings: if std.isArray(v=alertRelabelings) then alertRelabelings else [alertRelabelings] },
        '#withAlertRelabelingsMixin':: d.fn(help='"alertRelabelings defines the relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alertRelabelings', type=d.T.array)]),
        withAlertRelabelingsMixin(alertRelabelings): { alertRelabelings+: if std.isArray(v=alertRelabelings) then alertRelabelings else [alertRelabelings] },
        '#withApiVersion':: d.fn(help='"apiVersion defines the version of the Alertmanager API that Prometheus uses to send alerts.\\nIt can be \\"V1\\" or \\"V2\\".\\nThe field has no effect for Prometheus >= v3.0.0 because only the v2 API is supported."', args=[d.arg(name='apiVersion', type=d.T.string)]),
        withApiVersion(apiVersion): { apiVersion: apiVersion },
        '#withBearerTokenFile':: d.fn(help='"bearerTokenFile defines the file to read bearer token for Alertmanager.\\n\\nCannot be set at the same time as `basicAuth`, `authorization`, or `sigv4`.\\n\\nDeprecated: this will be removed in a future release. Prefer using `authorization`."', args=[d.arg(name='bearerTokenFile', type=d.T.string)]),
        ...
        '#withName':: d.fn(help='"name of the Endpoints object in the namespace."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withNamespace':: d.fn(help='"namespace of the Endpoints object.\\n\\nIf not set, the object will be discovered in the namespace of the\\nPrometheus object."', args=[d.arg(name='namespace', type=d.T.string)]),
        ...
        '#withPathPrefix':: d.fn(help='"pathPrefix defines the prefix for the HTTP path alerts are pushed to."', args=[d.arg(name='pathPrefix', type=d.T.string)]),
        withPathPrefix(pathPrefix): { pathPrefix: pathPrefix },
        '#withPort':: d.fn(help='"port on which the Alertmanager API is exposed."', args=[d.arg(name='port', type=d.T.any)]),
        ...
        '#withRelabelings':: d.fn(help='"relabelings defines the relabel configuration applied to the discovered Alertmanagers."', args=[d.arg(name='relabelings', type=d.T.array)]),
        withRelabelings(relabelings): { relabelings: if std.isArray(v=relabelings) then relabelings else [relabelings] },
        '#withRelabelingsMixin':: d.fn(help='"relabelings defines the relabel configuration applied to the discovered Alertmanagers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='relabelings', type=d.T.array)]),
        ...
        '#withTimeout':: d.fn(help='"timeout defines a per-target Alertmanager timeout when pushing alerts."', args=[d.arg(name='timeout', type=d.T.string)]),
        withTimeout(timeout): { timeout: timeout },
      },
      '#withAlertmanagers':: d.fn(help='"alertmanagers endpoints where Prometheus should send alerts to."', args=[d.arg(name='alertmanagers', type=d.T.array)]),
    ...
    apiserverConfig: {
      ...
      authorization: {
        ...
        '#withCredentialsFile':: d.fn(help='"credentialsFile defines the file to read a secret from, mutually exclusive with `credentials`."', args=[d.arg(name='credentialsFile', type=d.T.string)]),
      ...
      '#tlsConfig':: d.obj(help='"tlsConfig to use for the API server."'),
      tlsConfig: {
        '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
      ...
      '#withBearerToken':: d.fn(help="\"bearerToken is deprecated: this will be removed in a future release.\\n *Warning: this field shouldn't be used because the token value appears\\nin clear-text. Prefer using `authorization`.*\"", args=[d.arg(name='bearerToken', type=d.T.string)]),
      withBearerToken(bearerToken): { spec+: { apiserverConfig+: { bearerToken: bearerToken } } },
      '#withBearerTokenFile':: d.fn(help='"bearerTokenFile defines the file to read bearer token for accessing apiserver.\\n\\nCannot be set at the same time as `basicAuth`, `authorization`, or `bearerToken`.\\n\\nDeprecated: this will be removed in a future release. Prefer using `authorization`."', args=[d.arg(name='bearerTokenFile', type=d.T.string)]),
      withBearerTokenFile(bearerTokenFile): { spec+: { apiserverConfig+: { bearerTokenFile: bearerTokenFile } } },
      '#withHost':: d.fn(help='"host defines the Kubernetes API address consisting of a hostname or IP address followed\\nby an optional port number."', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { spec+: { apiserverConfig+: { host: host } } },
      '#withNoProxy':: d.fn(help='"noProxy defines a comma-separated string that can contain IPs, CIDR notation, domain names\\nthat should be excluded from proxying. IP and domain names can\\ncontain port numbers.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='noProxy', type=d.T.string)]),
      withNoProxy(noProxy): { spec+: { apiserverConfig+: { noProxy: noProxy } } },
      '#withProxyConnectHeader':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      withProxyConnectHeader(proxyConnectHeader): { spec+: { apiserverConfig+: { proxyConnectHeader: proxyConnectHeader } } },
      '#withProxyConnectHeaderMixin':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      withProxyConnectHeaderMixin(proxyConnectHeader): { spec+: { apiserverConfig+: { proxyConnectHeader+: proxyConnectHeader } } },
      '#withProxyFromEnvironment':: d.fn(help='"proxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyFromEnvironment', type=d.T.boolean)]),
      withProxyFromEnvironment(proxyFromEnvironment): { spec+: { apiserverConfig+: { proxyFromEnvironment: proxyFromEnvironment } } },
      '#withProxyUrl':: d.fn(help='"proxyUrl defines the HTTP proxy server to use."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
      withProxyUrl(proxyUrl): { spec+: { apiserverConfig+: { proxyUrl: proxyUrl } } },
    },
    '#arbitraryFSAccessThroughSMs':: d.obj(help="\"arbitraryFSAccessThroughSMs when true, ServiceMonitor, PodMonitor and Probe object are forbidden to\\nreference arbitrary files on the file system of the 'prometheus'\\ncontainer.\\nWhen a ServiceMonitor's endpoint specifies a `bearerTokenFile` value\\n(e.g.  '/var/run/secrets/kubernetes.io/serviceaccount/token'), a\\nmalicious target can get access to the Prometheus service account's\\ntoken in the Prometheus' scrape request. Setting\\n`spec.arbitraryFSAccessThroughSM` to 'true' would prevent the attack.\\nUsers should instead provide the credentials using the\\n`spec.bearerTokenSecret` field.\""),
    arbitraryFSAccessThroughSMs: {
      '#withDeny':: d.fn(help='"deny prevents service monitors from accessing arbitrary files on the file system.\\nWhen true, service monitors cannot use file-based configurations like BearerTokenFile\\nthat could potentially access sensitive files. When false (default), such access is allowed.\\nSetting this to true enhances security by preventing potential credential theft attacks."', args=[d.arg(name='deny', type=d.T.boolean)]),
    ...
    '#dnsConfig':: d.obj(help='"dnsConfig defines the DNS configuration for the pods."'),
    dnsConfig: {
      '#options':: d.obj(help='"options defines the list of DNS resolver options.\\nThis will be merged with the base options generated from DNSPolicy.\\nResolution options given in Options\\nwill override those that appear in the base DNSPolicy."'),
      options: {
        '#withName':: d.fn(help='"name is required and must be unique."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"value is optional."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#withNameservers':: d.fn(help='"nameservers defines the list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy."', args=[d.arg(name='nameservers', type=d.T.array)]),
      withNameservers(nameservers): { spec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } },
      '#withNameserversMixin':: d.fn(help='"nameservers defines the list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nameservers', type=d.T.array)]),
    ...
    '#exemplars':: d.obj(help='"exemplars related settings that are runtime reloadable.\\nIt requires to enable the `exemplar-storage` feature flag to be effective."'),
    exemplars: {
      '#withMaxSize':: d.fn(help='"maxSize defines the maximum number of exemplars stored in memory for all series.\\n\\nexemplar-storage itself must be enabled using the `spec.enableFeature`\\noption for exemplars to be scraped in the first place.\\n\\nIf not set, Prometheus uses its default value. A value of zero or less\\nthan zero disables the storage."', args=[d.arg(name='maxSize', type=d.T.integer)]),
      withMaxSize(maxSize): { spec+: { exemplars+: { maxSize: maxSize } } },
    },
    '#hostAliases':: d.obj(help="\"hostAliases defines the optional list of hosts and IPs that will be injected into the Pod's\\nhosts file if specified.\""),
    hostAliases: {
      '#withHostnames':: d.fn(help='"hostnames defines hostnames for the above IP address."', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnames(hostnames): { hostnames: if std.isArray(v=hostnames) then hostnames else [hostnames] },
      '#withHostnamesMixin':: d.fn(help='"hostnames defines hostnames for the above IP address."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostnames', type=d.T.array)]),
      withHostnamesMixin(hostnames): { hostnames+: if std.isArray(v=hostnames) then hostnames else [hostnames] },
      '#withIp':: d.fn(help='"ip defines the IP address of the host file entry."', args=[d.arg(name='ip', type=d.T.string)]),
      withIp(ip): { ip: ip },
    },
    '#imagePullSecrets':: d.obj(help='"imagePullSecrets defines an optional list of references to Secrets in the same namespace\\nto use for pulling images from registries.\\nSee http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"'),
    imagePullSecrets: {
      '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    ...
    '#otlp':: d.obj(help='"otlp defines the settings related to the OTLP receiver feature.\\nIt requires Prometheus >= v2.55.0."'),
    otlp: {
      '#withConvertHistogramsToNHCB':: d.fn(help='"convertHistogramsToNHCB defines optional translation of OTLP explicit bucket histograms into native histograms with custom buckets.\\nIt requires Prometheus >= v3.4.0."', args=[d.arg(name='convertHistogramsToNHCB', type=d.T.boolean)]),
      withConvertHistogramsToNHCB(convertHistogramsToNHCB): { spec+: { otlp+: { convertHistogramsToNHCB: convertHistogramsToNHCB } } },
      '#withIgnoreResourceAttributes':: d.fn(help='"ignoreResourceAttributes defines the list of OpenTelemetry resource attributes to ignore when `promoteAllResourceAttributes` is true.\\n\\nIt requires `promoteAllResourceAttributes` to be true.\\nIt requires Prometheus >= v3.5.0."', args=[d.arg(name='ignoreResourceAttributes', type=d.T.array)]),
      withIgnoreResourceAttributes(ignoreResourceAttributes): { spec+: { otlp+: { ignoreResourceAttributes: if std.isArray(v=ignoreResourceAttributes) then ignoreResourceAttributes else [ignoreResourceAttributes] } } },
      '#withIgnoreResourceAttributesMixin':: d.fn(help='"ignoreResourceAttributes defines the list of OpenTelemetry resource attributes to ignore when `promoteAllResourceAttributes` is true.\\n\\nIt requires `promoteAllResourceAttributes` to be true.\\nIt requires Prometheus >= v3.5.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ignoreResourceAttributes', type=d.T.array)]),
      withIgnoreResourceAttributesMixin(ignoreResourceAttributes): { spec+: { otlp+: { ignoreResourceAttributes+: if std.isArray(v=ignoreResourceAttributes) then ignoreResourceAttributes else [ignoreResourceAttributes] } } },
      '#withKeepIdentifyingResourceAttributes':: d.fn(help='"keepIdentifyingResourceAttributes enables adding `service.name`, `service.namespace` and `service.instance.id`\\nresource attributes to the `target_info` metric, on top of converting them into the `instance` and `job` labels.\\n\\nIt requires Prometheus >= v3.1.0."', args=[d.arg(name='keepIdentifyingResourceAttributes', type=d.T.boolean)]),
      withKeepIdentifyingResourceAttributes(keepIdentifyingResourceAttributes): { spec+: { otlp+: { keepIdentifyingResourceAttributes: keepIdentifyingResourceAttributes } } },
      '#withPromoteAllResourceAttributes':: d.fn(help='"promoteAllResourceAttributes promotes all resource attributes to metric labels except the ones defined in `ignoreResourceAttributes`.\\n\\nCannot be true when `promoteResourceAttributes` is defined.\\nIt requires Prometheus >= v3.5.0."', args=[d.arg(name='promoteAllResourceAttributes', type=d.T.boolean)]),
      withPromoteAllResourceAttributes(promoteAllResourceAttributes): { spec+: { otlp+: { promoteAllResourceAttributes: promoteAllResourceAttributes } } },
      '#withPromoteResourceAttributes':: d.fn(help='"promoteResourceAttributes defines the list of OpenTelemetry Attributes that should be promoted to metric labels, defaults to none.\\nCannot be defined when `promoteAllResourceAttributes` is true."', args=[d.arg(name='promoteResourceAttributes', type=d.T.array)]),
      withPromoteResourceAttributes(promoteResourceAttributes): { spec+: { otlp+: { promoteResourceAttributes: if std.isArray(v=promoteResourceAttributes) then promoteResourceAttributes else [promoteResourceAttributes] } } },
      '#withPromoteResourceAttributesMixin':: d.fn(help='"promoteResourceAttributes defines the list of OpenTelemetry Attributes that should be promoted to metric labels, defaults to none.\\nCannot be defined when `promoteAllResourceAttributes` is true."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='promoteResourceAttributes', type=d.T.array)]),
      withPromoteResourceAttributesMixin(promoteResourceAttributes): { spec+: { otlp+: { promoteResourceAttributes+: if std.isArray(v=promoteResourceAttributes) then promoteResourceAttributes else [promoteResourceAttributes] } } },
      '#withPromoteScopeMetadata':: d.fn(help='"promoteScopeMetadata controls whether to promote OpenTelemetry scope metadata (i.e. name, version, schema URL, and attributes) to metric labels.\\nAs per the OpenTelemetry specification, the aforementioned scope metadata should be identifying, i.e. made into metric labels.\\nIt requires Prometheus >= v3.6.0."', args=[d.arg(name='promoteScopeMetadata', type=d.T.boolean)]),
      withPromoteScopeMetadata(promoteScopeMetadata): { spec+: { otlp+: { promoteScopeMetadata: promoteScopeMetadata } } },
      '#withTranslationStrategy':: d.fn(help='"translationStrategy defines how the OTLP receiver endpoint translates the incoming metrics.\\n\\nIt requires Prometheus >= v3.0.0."', args=[d.arg(name='translationStrategy', type=d.T.string)]),
      withTranslationStrategy(translationStrategy): { spec+: { otlp+: { translationStrategy: translationStrategy } } },
    },
    '#persistentVolumeClaimRetentionPolicy':: d.obj(help='"persistentVolumeClaimRetentionPolicy defines the field controls if and how PVCs are deleted during the lifecycle of a StatefulSet.\\nThe default behavior is all PVCs are retained.\\nThis is an alpha field from kubernetes 1.23 until 1.26 and a beta field from 1.26.\\nIt requires enabling the StatefulSetAutoDeletePVC feature gate."'),
    ...
    '#probeNamespaceSelector':: d.obj(help='"probeNamespaceSelector defines the namespaces to match for Probe discovery. An empty label\\nselector matches all namespaces. A null label selector matches the\\ncurrent namespace only."'),
    ...
    '#probeSelector':: d.obj(help="\"probeSelector defines the probes to be selected for target discovery. An empty label selector\\nmatches all objects. A null label selector matches no objects.\\n\\nIf `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector`\\nand `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged.\\nThe Prometheus operator will ensure that the Prometheus configuration's\\nSecret exists, but it is the responsibility of the user to provide the raw\\ngzipped Prometheus configuration under the `prometheus.yaml.gz` key.\\nThis behavior is *deprecated* and will be removed in the next major version\\nof the custom resource definition. It is recommended to use\\n`spec.additionalScrapeConfigs` instead.\""),
    probeSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#prometheusRulesExcludedFromEnforce':: d.obj(help="\"prometheusRulesExcludedFromEnforce defines the list of PrometheusRule objects to which the namespace label\\nenforcement doesn't apply.\\nThis is only relevant when `spec.enforcedNamespaceLabel` is set to true.\\nDeprecated: use `spec.excludedFromEnforcement` instead.\""),
    prometheusRulesExcludedFromEnforce: {
      '#withRuleName':: d.fn(help='"ruleName defines the name of the excluded PrometheusRule object."', args=[d.arg(name='ruleName', type=d.T.string)]),
      withRuleName(ruleName): { ruleName: ruleName },
      '#withRuleNamespace':: d.fn(help='"ruleNamespace defines the namespace of the excluded PrometheusRule object."', args=[d.arg(name='ruleNamespace', type=d.T.string)]),
      withRuleNamespace(ruleNamespace): { ruleNamespace: ruleNamespace },
    },
    '#query':: d.obj(help='"query defines the configuration of the Prometheus query service."'),
    query: {
      '#withLookbackDelta':: d.fn(help='"lookbackDelta defines the delta difference allowed for retrieving metrics during expression evaluations."', args=[d.arg(name='lookbackDelta', type=d.T.string)]),
      withLookbackDelta(lookbackDelta): { spec+: { query+: { lookbackDelta: lookbackDelta } } },
      '#withMaxConcurrency':: d.fn(help='"maxConcurrency defines the number of concurrent queries that can be run at once."', args=[d.arg(name='maxConcurrency', type=d.T.integer)]),
      withMaxConcurrency(maxConcurrency): { spec+: { query+: { maxConcurrency: maxConcurrency } } },
      '#withMaxSamples':: d.fn(help='"maxSamples defines the maximum number of samples a single query can load into memory. Note that\\nqueries will fail if they would load more samples than this into memory,\\nso this also limits the number of samples a query can return."', args=[d.arg(name='maxSamples', type=d.T.integer)]),
      withMaxSamples(maxSamples): { spec+: { query+: { maxSamples: maxSamples } } },
      '#withTimeout':: d.fn(help='"timeout defines the maximum time a query may take before being aborted."', args=[d.arg(name='timeout', type=d.T.string)]),
      withTimeout(timeout): { spec+: { query+: { timeout: timeout } } },
    },
    '#remoteRead':: d.obj(help='"remoteRead defines the list of remote read configurations."'),
    remoteRead: {
      ...
      '#tlsConfig':: d.obj(help='"tlsConfig to use for the URL."'),
      tlsConfig: {
        '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
      ...
      '#withBearerTokenFile':: d.fn(help='"bearerTokenFile defines the file from which to read the bearer token for the URL.\\n\\nDeprecated: this will be removed in a future release. Prefer using `authorization`."', args=[d.arg(name='bearerTokenFile', type=d.T.string)]),
      withBearerTokenFile(bearerTokenFile): { bearerTokenFile: bearerTokenFile },
      '#withFilterExternalLabels':: d.fn(help='"filterExternalLabels defines whether to use the external labels as selectors for the remote read endpoint.\\n\\nIt requires Prometheus >= v2.34.0."', args=[d.arg(name='filterExternalLabels', type=d.T.boolean)]),
      ...
      '#withHeaders':: d.fn(help="\"headers defines the custom HTTP headers to be sent along with each remote read request.\\nBe aware that headers that are set by Prometheus itself can't be overwritten.\\nOnly valid in Prometheus versions 2.26.0 and newer.\"", args=[d.arg(name='headers', type=d.T.object)]),
      withHeaders(headers): { headers: headers },
      '#withHeadersMixin':: d.fn(help="\"headers defines the custom HTTP headers to be sent along with each remote read request.\\nBe aware that headers that are set by Prometheus itself can't be overwritten.\\nOnly valid in Prometheus versions 2.26.0 and newer.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='headers', type=d.T.object)]),
      withHeadersMixin(headers): { headers+: headers },
      '#withName':: d.fn(help='"name of the remote read queue, it must be unique if specified. The\\nname is used in metrics and logging in order to differentiate read\\nconfigurations.\\n\\nIt requires Prometheus >= v2.15.0."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withNoProxy':: d.fn(help='"noProxy defines a comma-separated string that can contain IPs, CIDR notation, domain names\\nthat should be excluded from proxying. IP and domain names can\\ncontain port numbers.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='noProxy', type=d.T.string)]),
      withNoProxy(noProxy): { noProxy: noProxy },
      '#withProxyConnectHeader':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      ...
      '#withProxyUrl':: d.fn(help='"proxyUrl defines the HTTP proxy server to use."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
      withProxyUrl(proxyUrl): { proxyUrl: proxyUrl },
      '#withReadRecent':: d.fn(help='"readRecent defines whether reads should be made for queries for time ranges that\\nthe local storage should have complete data for."', args=[d.arg(name='readRecent', type=d.T.boolean)]),
      withReadRecent(readRecent): { readRecent: readRecent },
      '#withRemoteTimeout':: d.fn(help='"remoteTimeout defines the timeout for requests to the remote read endpoint."', args=[d.arg(name='remoteTimeout', type=d.T.string)]),
      withRemoteTimeout(remoteTimeout): { remoteTimeout: remoteTimeout },
      '#withRequiredMatchers':: d.fn(help='"requiredMatchers defines an optional list of equality matchers which have to be present\\nin a selector to query the remote read endpoint."', args=[d.arg(name='requiredMatchers', type=d.T.object)]),
      withRequiredMatchers(requiredMatchers): { requiredMatchers: requiredMatchers },
      '#withRequiredMatchersMixin':: d.fn(help='"requiredMatchers defines an optional list of equality matchers which have to be present\\nin a selector to query the remote read endpoint."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredMatchers', type=d.T.object)]),
      withRequiredMatchersMixin(requiredMatchers): { requiredMatchers+: requiredMatchers },
      '#withUrl':: d.fn(help='"url defines the URL of the endpoint to query from."', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { url: url },
    },
    '#remoteWrite':: d.obj(help='"remoteWrite defines the list of remote write configurations."'),
    remoteWrite: {
      ...
      azureAd: {
        ...
        managedIdentity: {
          '#withClientId':: d.fn(help='"clientId defines defines the Azure User-assigned Managed identity."', args=[d.arg(name='clientId', type=d.T.string)]),
        ...
        oauth: {
          ...
          '#withClientId':: d.fn(help='"clientId defines the clientId of the Azure Active Directory application that is being used to authenticate."', args=[d.arg(name='clientId', type=d.T.string)]),
        ...
        sdk: {
          '#withTenantId':: d.fn(help='"tenantId defines the tenant ID of the azure active directory application that is being used to authenticate."', args=[d.arg(name='tenantId', type=d.T.string)]),
          withTenantId(tenantId): { azureAd+: { sdk+: { tenantId: tenantId } } },
        },
        '#withCloud':: d.fn(help="\"cloud defines the Azure Cloud. Options are 'AzurePublic', 'AzureChina', or 'AzureGovernment'.\"", args=[d.arg(name='cloud', type=d.T.string)]),
      ...
      '#metadataConfig':: d.obj(help='"metadataConfig defines how to send a series metadata to the remote storage."'),
      metadataConfig: {
        '#withMaxSamplesPerSend':: d.fn(help='"maxSamplesPerSend defines the maximum number of metadata samples per send.\\n\\nIt requires Prometheus >= v2.29.0."', args=[d.arg(name='maxSamplesPerSend', type=d.T.integer)]),
        withMaxSamplesPerSend(maxSamplesPerSend): { metadataConfig+: { maxSamplesPerSend: maxSamplesPerSend } },
        '#withSend':: d.fn(help='"send defines whether metric metadata is sent to the remote storage or not."', args=[d.arg(name='send', type=d.T.boolean)]),
        withSend(send): { metadataConfig+: { send: send } },
        '#withSendInterval':: d.fn(help='"sendInterval defines how frequently metric metadata is sent to the remote storage."', args=[d.arg(name='sendInterval', type=d.T.string)]),
      ...
      queueConfig: {
        '#withBatchSendDeadline':: d.fn(help='"batchSendDeadline defines the maximum time a sample will wait in buffer."', args=[d.arg(name='batchSendDeadline', type=d.T.string)]),
        withBatchSendDeadline(batchSendDeadline): { queueConfig+: { batchSendDeadline: batchSendDeadline } },
        '#withCapacity':: d.fn(help='"capacity defines the number of samples to buffer per shard before we start\\ndropping them."', args=[d.arg(name='capacity', type=d.T.integer)]),
        withCapacity(capacity): { queueConfig+: { capacity: capacity } },
        '#withMaxBackoff':: d.fn(help='"maxBackoff defines the maximum retry delay."', args=[d.arg(name='maxBackoff', type=d.T.string)]),
        withMaxBackoff(maxBackoff): { queueConfig+: { maxBackoff: maxBackoff } },
        '#withMaxRetries':: d.fn(help='"maxRetries defines the maximum number of times to retry a batch on recoverable errors."', args=[d.arg(name='maxRetries', type=d.T.integer)]),
        withMaxRetries(maxRetries): { queueConfig+: { maxRetries: maxRetries } },
        '#withMaxSamplesPerSend':: d.fn(help='"maxSamplesPerSend defines the maximum number of samples per send."', args=[d.arg(name='maxSamplesPerSend', type=d.T.integer)]),
        withMaxSamplesPerSend(maxSamplesPerSend): { queueConfig+: { maxSamplesPerSend: maxSamplesPerSend } },
        '#withMaxShards':: d.fn(help='"maxShards defines the maximum number of shards, i.e. amount of concurrency."', args=[d.arg(name='maxShards', type=d.T.integer)]),
        withMaxShards(maxShards): { queueConfig+: { maxShards: maxShards } },
        '#withMinBackoff':: d.fn(help='"minBackoff defines the initial retry delay. Gets doubled for every retry."', args=[d.arg(name='minBackoff', type=d.T.string)]),
        withMinBackoff(minBackoff): { queueConfig+: { minBackoff: minBackoff } },
        '#withMinShards':: d.fn(help='"minShards defines the minimum number of shards, i.e. amount of concurrency."', args=[d.arg(name='minShards', type=d.T.integer)]),
        withMinShards(minShards): { queueConfig+: { minShards: minShards } },
        '#withRetryOnRateLimit':: d.fn(help='"retryOnRateLimit defines the retry upon receiving a 429 status code from the remote-write storage.\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."', args=[d.arg(name='retryOnRateLimit', type=d.T.boolean)]),
        withRetryOnRateLimit(retryOnRateLimit): { queueConfig+: { retryOnRateLimit: retryOnRateLimit } },
        '#withSampleAgeLimit':: d.fn(help='"sampleAgeLimit drops samples older than the limit.\\nIt requires Prometheus >= v2.50.0 or Thanos >= v0.32.0."', args=[d.arg(name='sampleAgeLimit', type=d.T.string)]),
        withSampleAgeLimit(sampleAgeLimit): { queueConfig+: { sampleAgeLimit: sampleAgeLimit } },
      },
      '#sigv4':: d.obj(help="\"sigv4 defines the AWS's Signature Verification 4 for the URL.\\n\\nIt requires Prometheus \u003e= v2.26.0 or Thanos \u003e= v0.24.0.\\n\\nCannot be set at the same time as `authorization`, `basicAuth`, `oauth2`, or `azureAd`.\""),
      sigv4: {
        '#accessKey':: d.obj(help='"accessKey defines the AWS API key. If not specified, the environment variable\\n`AWS_ACCESS_KEY_ID` is used."'),
        accessKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withBearerToken':: d.fn(help="\"bearerToken is deprecated: this will be removed in a future release.\\n*Warning: this field shouldn't be used because the token value appears\\nin clear-text. Prefer using `authorization`.*\"", args=[d.arg(name='bearerToken', type=d.T.string)]),
      withBearerToken(bearerToken): { bearerToken: bearerToken },
      '#withBearerTokenFile':: d.fn(help='"bearerTokenFile defines the file from which to read bearer token for the URL.\\n\\nDeprecated: this will be removed in a future release. Prefer using `authorization`."', args=[d.arg(name='bearerTokenFile', type=d.T.string)]),
      withBearerTokenFile(bearerTokenFile): { bearerTokenFile: bearerTokenFile },
      '#withEnableHTTP2':: d.fn(help='"enableHTTP2 defines whether to enable HTTP2."', args=[d.arg(name='enableHTTP2', type=d.T.boolean)]),
      withEnableHTTP2(enableHTTP2): { enableHTTP2: enableHTTP2 },
      '#withFollowRedirects':: d.fn(help='"followRedirects defines whether HTTP requests follow HTTP 3xx redirects.\\n\\nIt requires Prometheus >= v2.26.0 or Thanos >= v0.24.0."', args=[d.arg(name='followRedirects', type=d.T.boolean)]),
      withFollowRedirects(followRedirects): { followRedirects: followRedirects },
      '#withHeaders':: d.fn(help="\"headers defines the custom HTTP headers to be sent along with each remote write request.\\nBe aware that headers that are set by Prometheus itself can't be overwritten.\\n\\nIt requires Prometheus \u003e= v2.25.0 or Thanos \u003e= v0.24.0.\"", args=[d.arg(name='headers', type=d.T.object)]),
      withHeaders(headers): { headers: headers },
      '#withHeadersMixin':: d.fn(help="\"headers defines the custom HTTP headers to be sent along with each remote write request.\\nBe aware that headers that are set by Prometheus itself can't be overwritten.\\n\\nIt requires Prometheus \u003e= v2.25.0 or Thanos \u003e= v0.24.0.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='headers', type=d.T.object)]),
      withHeadersMixin(headers): { headers+: headers },
      '#withMessageVersion':: d.fn(help="\"messageVersion defines the Remote Write message's version to use when writing to the endpoint.\\n\\n`Version1.0` corresponds to the `prometheus.WriteRequest` protobuf message introduced in Remote Write 1.0.\\n`Version2.0` corresponds to the `io.prometheus.write.v2.Request` protobuf message introduced in Remote Write 2.0.\\n\\nWhen `Version2.0` is selected, Prometheus will automatically be\\nconfigured to append the metadata of scraped metrics to the WAL.\\n\\nBefore setting this field, consult with your remote storage provider\\nwhat message version it supports.\\n\\nIt requires Prometheus \u003e= v2.54.0 or Thanos \u003e= v0.37.0.\"", args=[d.arg(name='messageVersion', type=d.T.string)]),
      withMessageVersion(messageVersion): { messageVersion: messageVersion },
      '#withName':: d.fn(help='"name of the remote write queue, it must be unique if specified. The\\nname is used in metrics and logging in order to differentiate queues.\\n\\nIt requires Prometheus >= v2.15.0 or Thanos >= 0.24.0."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withNoProxy':: d.fn(help='"noProxy defines a comma-separated string that can contain IPs, CIDR notation, domain names\\nthat should be excluded from proxying. IP and domain names can\\ncontain port numbers.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='noProxy', type=d.T.string)]),
      withNoProxy(noProxy): { noProxy: noProxy },
      '#withProxyConnectHeader':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      ...
      '#withProxyUrl':: d.fn(help='"proxyUrl defines the HTTP proxy server to use."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
      withProxyUrl(proxyUrl): { proxyUrl: proxyUrl },
      '#withRemoteTimeout':: d.fn(help='"remoteTimeout defines the timeout for requests to the remote write endpoint."', args=[d.arg(name='remoteTimeout', type=d.T.string)]),
      withRemoteTimeout(remoteTimeout): { remoteTimeout: remoteTimeout },
      '#withRoundRobinDNS':: d.fn(help='"roundRobinDNS controls the DNS resolution behavior for remote-write connections.\\nWhen enabled:\\n  - The remote-write mechanism will resolve the hostname via DNS.\\n  - It will randomly select one of the resolved IP addresses and connect to it.\\n\\nWhen disabled (default behavior):\\n  - The Go standard library will handle hostname resolution.\\n  - It will attempt connections to each resolved IP address sequentially.\\n\\nNote: The connection timeout applies to the entire resolution and connection process.\\n\\n\\tIf disabled, the timeout is distributed across all connection attempts.\\n\\nIt requires Prometheus >= v3.1.0 or Thanos >= v0.38.0."', args=[d.arg(name='roundRobinDNS', type=d.T.boolean)]),
      withRoundRobinDNS(roundRobinDNS): { roundRobinDNS: roundRobinDNS },
      '#withSendExemplars':: d.fn(help='"sendExemplars enables sending of exemplars over remote write. Note that\\nexemplar-storage itself must be enabled using the `spec.enableFeatures`\\noption for exemplars to be scraped in the first place.\\n\\nIt requires Prometheus >= v2.27.0 or Thanos >= v0.24.0."', args=[d.arg(name='sendExemplars', type=d.T.boolean)]),
      withSendExemplars(sendExemplars): { sendExemplars: sendExemplars },
      '#withSendNativeHistograms':: d.fn(help='"sendNativeHistograms enables sending of native histograms, also known as sparse histograms\\nover remote write.\\n\\nIt requires Prometheus >= v2.40.0 or Thanos >= v0.30.0."', args=[d.arg(name='sendNativeHistograms', type=d.T.boolean)]),
      withSendNativeHistograms(sendNativeHistograms): { sendNativeHistograms: sendNativeHistograms },
      '#withUrl':: d.fn(help='"url defines the URL of the endpoint to send samples to."', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { url: url },
      '#withWriteRelabelConfigs':: d.fn(help='"writeRelabelConfigs defines the list of remote write relabel configurations."', args=[d.arg(name='writeRelabelConfigs', type=d.T.array)]),
      ...
      '#withWriteRelabelConfigsMixin':: d.fn(help='"writeRelabelConfigs defines the list of remote write relabel configurations."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='writeRelabelConfigs', type=d.T.array)]),
      ...
      '#writeRelabelConfigs':: d.obj(help='"writeRelabelConfigs defines the list of remote write relabel configurations."'),
      writeRelabelConfigs: {
        '#withAction':: d.fn(help='"action to perform based on the regex matching.\\n\\n`Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0.\\n`DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.\\n\\nDefault: \\"Replace\\', args=[d.arg(name='action', type=d.T.string)]),
        withAction(action): { action: action },
        '#withModulus':: d.fn(help='"modulus to take of the hash of the source label values.\\n\\nOnly applicable when the action is `HashMod`."', args=[d.arg(name='modulus', type=d.T.integer)]),
    ...
    '#resources':: d.obj(help="\"resources defines the resources requests and limits of the 'prometheus' container.\""),
    resources: {
      '#claims':: d.obj(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."'),
      claims: {
        '#withName':: d.fn(help='"Name must match the name of one entry in pod.spec.resourceClaims of\\nthe Pod where this field is used. It makes that resource available\\ninside a container."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#ruleNamespaceSelector':: d.obj(help='"ruleNamespaceSelector defines the namespaces to match for PrometheusRule discovery. An empty label selector\\nmatches all namespaces. A null label selector matches the current\\nnamespace only."'),
    ...
    '#ruleSelector':: d.obj(help='"ruleSelector defines the prometheusRule objects to be selected for rule evaluation. An empty\\nlabel selector matches all objects. A null label selector matches no\\nobjects."'),
    ruleSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#rules':: d.obj(help="\"rules defines the configuration of the Prometheus rules' engine.\""),
    rules: {
      '#alert':: d.obj(help="\"alert defines the parameters of the Prometheus rules' engine.\\n\\nAny update to these parameters trigger a restart of the pods.\""),
      alert: {
        '#withForGracePeriod':: d.fn(help="\"forGracePeriod defines the minimum duration between alert and restored 'for' state.\\n\\nThis is maintained only for alerts with a configured 'for' time greater\\nthan the grace period.\"", args=[d.arg(name='forGracePeriod', type=d.T.string)]),
        withForGracePeriod(forGracePeriod): { spec+: { rules+: { alert+: { forGracePeriod: forGracePeriod } } } },
        '#withForOutageTolerance':: d.fn(help="\"forOutageTolerance defines the max time to tolerate prometheus outage for restoring 'for' state of\\nalert.\"", args=[d.arg(name='forOutageTolerance', type=d.T.string)]),
        withForOutageTolerance(forOutageTolerance): { spec+: { rules+: { alert+: { forOutageTolerance: forOutageTolerance } } } },
        '#withResendDelay':: d.fn(help='"resendDelay defines the minimum amount of time to wait before resending an alert to\\nAlertmanager."', args=[d.arg(name='resendDelay', type=d.T.string)]),
        withResendDelay(resendDelay): { spec+: { rules+: { alert+: { resendDelay: resendDelay } } } },
      },
    },
    '#runtime':: d.obj(help='"runtime defines the values for the Prometheus process behavior"'),
    runtime: {
      '#withGoGC':: d.fn(help='"goGC defines the Go garbage collection target percentage. Lowering this number may increase the CPU usage.\\nSee: https://tip.golang.org/doc/gc-guide#GOGC"', args=[d.arg(name='goGC', type=d.T.integer)]),
      withGoGC(goGC): { spec+: { runtime+: { goGC: goGC } } },
    },
    '#scrapeClasses':: d.obj(help='"scrapeClasses defines the list of scrape classes to expose to scraping objects such as\\nPodMonitors, ServiceMonitors, Probes and ScrapeConfigs.\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."'),
    scrapeClasses: {
      '#attachMetadata':: d.obj(help='"attachMetadata defines additional metadata to the discovered targets.\\nWhen the scrape object defines its own configuration, it takes\\nprecedence over the scrape class configuration."'),
      attachMetadata: {
        '#withNode':: d.fn(help='"node when set to true, Prometheus attaches node metadata to the discovered\\ntargets.\\n\\nThe Prometheus service account must have the `list` and `watch`\\npermissions on the `Nodes` objects."', args=[d.arg(name='node', type=d.T.boolean)]),
        withNode(node): { attachMetadata+: { node: node } },
      },
      '#authorization':: d.obj(help="\"authorization section for the ScrapeClass.\\nIt will only apply if the scrape resource doesn't specify any Authorization.\""),
      authorization: {
        '#credentials':: d.obj(help='"credentials defines a key of a Secret in the namespace that contains the credentials for authentication."'),
        credentials: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      withFallbackScrapeProtocol(fallbackScrapeProtocol): { fallbackScrapeProtocol: fallbackScrapeProtocol },
      '#withMetricRelabelings':: d.fn(help="\"metricRelabelings defines the relabeling rules to apply to all samples before ingestion.\\n\\nThe Operator adds the scrape class metric relabelings defined here.\\nThen the Operator adds the target-specific metric relabelings defined in ServiceMonitors, PodMonitors, Probes and ScrapeConfigs.\\nThen the Operator adds namespace enforcement relabeling rule, specified in '.spec.enforcedNamespaceLabel'.\\n\\nMore info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#metric_relabel_configs\"", args=[d.arg(name='metricRelabelings', type=d.T.array)]),
      ...
      '#withMetricRelabelingsMixin':: d.fn(help="\"metricRelabelings defines the relabeling rules to apply to all samples before ingestion.\\n\\nThe Operator adds the scrape class metric relabelings defined here.\\nThen the Operator adds the target-specific metric relabelings defined in ServiceMonitors, PodMonitors, Probes and ScrapeConfigs.\\nThen the Operator adds namespace enforcement relabeling rule, specified in '.spec.enforcedNamespaceLabel'.\\n\\nMore info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#metric_relabel_configs\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='metricRelabelings', type=d.T.array)]),
      ...
      withName(name): { name: name },
      '#withRelabelings':: d.fn(help='"relabelings defines the relabeling rules to apply to all scrape targets.\\n\\nThe Operator automatically adds relabelings for a few standard Kubernetes fields\\nlike `__meta_kubernetes_namespace` and `__meta_kubernetes_service_name`.\\nThen the Operator adds the scrape class relabelings defined here.\\nThen the Operator adds the target-specific relabelings defined in the scrape object.\\n\\nMore info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config"', args=[d.arg(name='relabelings', type=d.T.array)]),
      withRelabelings(relabelings): { relabelings: if std.isArray(v=relabelings) then relabelings else [relabelings] },
      '#withRelabelingsMixin':: d.fn(help='"relabelings defines the relabeling rules to apply to all scrape targets.\\n\\nThe Operator automatically adds relabelings for a few standard Kubernetes fields\\nlike `__meta_kubernetes_namespace` and `__meta_kubernetes_service_name`.\\nThen the Operator adds the scrape class relabelings defined here.\\nThen the Operator adds the target-specific relabelings defined in the scrape object.\\n\\nMore info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='relabelings', type=d.T.array)]),
      withRelabelingsMixin(relabelings): { relabelings+: if std.isArray(v=relabelings) then relabelings else [relabelings] },
    },
    '#scrapeConfigNamespaceSelector':: d.obj(help='"scrapeConfigNamespaceSelector defines the namespaces to match for ScrapeConfig discovery. An empty label selector\\nmatches all namespaces. A null label selector matches the current\\nnamespace only.\\n\\nNote that the ScrapeConfig custom resource definition is currently at Alpha level."'),
    ...
    '#scrapeConfigSelector':: d.obj(help="\"scrapeConfigSelector defines the scrapeConfigs to be selected for target discovery. An empty label\\nselector matches all objects. A null label selector matches no objects.\\n\\nIf `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector`\\nand `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged.\\nThe Prometheus operator will ensure that the Prometheus configuration's\\nSecret exists, but it is the responsibility of the user to provide the raw\\ngzipped Prometheus configuration under the `prometheus.yaml.gz` key.\\nThis behavior is *deprecated* and will be removed in the next major version\\nof the custom resource definition. It is recommended to use\\n`spec.additionalScrapeConfigs` instead.\\n\\nNote that the ScrapeConfig custom resource definition is currently at Alpha level.\""),
    ...
    securityContext: {
      ...
      withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { securityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } },
      ...
      withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { securityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } },
    ...
    '#serviceMonitorNamespaceSelector':: d.obj(help='"serviceMonitorNamespaceSelector defines the namespaces to match for ServicedMonitors discovery. An empty label selector\\nmatches all namespaces. A null label selector (default value) matches the current\\nnamespace only."'),
    ...
    '#serviceMonitorSelector':: d.obj(help="\"serviceMonitorSelector defines the serviceMonitors to be selected for target discovery. An empty label\\nselector matches all objects. A null label selector matches no objects.\\n\\nIf `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector`\\nand `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged.\\nThe Prometheus operator will ensure that the Prometheus configuration's\\nSecret exists, but it is the responsibility of the user to provide the raw\\ngzipped Prometheus configuration under the `prometheus.yaml.gz` key.\\nThis behavior is *deprecated* and will be removed in the next major version\\nof the custom resource definition. It is recommended to use\\n`spec.additionalScrapeConfigs` instead.\""),
    ...
    '#shardRetentionPolicy':: d.obj(help="\"shardRetentionPolicy defines the retention policy for the Prometheus shards.\\n(Alpha) Using this field requires the 'PrometheusShardRetentionPolicy' feature gate to be enabled.\\n\\nThe final goals for this feature can be seen at https://github.com/prometheus-operator/prometheus-operator/blob/main/Documentation/proposals/202310-shard-autoscaling.md#graceful-scale-down-of-prometheus-servers,\\nhowever, the feature is not yet fully implemented in this PR. The limitation being:\\n* Retention duration is not settable, for now, shards are retained forever.\""),
    shardRetentionPolicy: {
      '#retain':: d.obj(help='"retain defines the config for retention when the retention policy is set to `Retain`.\\nThis field is ineffective as of now."'),
      retain: {
        '#withRetentionPeriod':: d.fn(help='"retentionPeriod defines the retentionPeriod for shard retention policy."', args=[d.arg(name='retentionPeriod', type=d.T.string)]),
        withRetentionPeriod(retentionPeriod): { spec+: { shardRetentionPolicy+: { retain+: { retentionPeriod: retentionPeriod } } } },
      },
      '#withWhenScaled':: d.fn(help='"whenScaled defines the retention policy when the Prometheus shards are scaled down.\\n* `Delete`, the operator will delete the pods from the scaled-down shard(s).\\n* `Retain`, the operator will keep the pods from the scaled-down shard(s), so the data can still be queried.\\n\\nIf not defined, the operator assumes the `Delete` value."', args=[d.arg(name='whenScaled', type=d.T.string)]),
      withWhenScaled(whenScaled): { spec+: { shardRetentionPolicy+: { whenScaled: whenScaled } } },
    },
    '#storage':: d.obj(help='"storage defines the storage used by Prometheus."'),
    storage: {
      '#emptyDir':: d.obj(help='"emptyDir to be used by the StatefulSet.\\nIf specified, it takes precedence over `ephemeral` and `volumeClaimTemplate`.\\nMore info: https://kubernetes.io/docs/concepts/storage/volumes/#emptydir"'),
      emptyDir: {
      ...
      '#ephemeral':: d.obj(help='"ephemeral to be used by the StatefulSet.\\nThis is a beta field in k8s 1.21 and GA in 1.15.\\nFor lower versions, starting with k8s 1.19, it requires enabling the GenericEphemeralVolume feature gate.\\nMore info: https://kubernetes.io/docs/concepts/storage/ephemeral-volumes/#generic-ephemeral-volumes"'),
      ephemeral: {
      ...
      '#volumeClaimTemplate':: d.obj(help='"volumeClaimTemplate defines the PVC spec to be used by the Prometheus StatefulSets.\\nThe easiest way to use a volume that cannot be automatically provisioned\\nis to use a label selector alongside manually created PersistentVolumes."'),
      volumeClaimTemplate: {
        '#metadata':: d.obj(help='"metadata defines EmbeddedMetadata contains metadata relevant to an EmbeddedResource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"annotations defines an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/"', args=[d.arg(name='annotations', type=d.T.object)]),
        ...
        '#spec':: d.obj(help='"spec defines the specification of the  characteristics of a volume requested by a pod author.\\nMore info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims"'),
        spec: {
          '#dataSource':: d.obj(help='"dataSource field can be used to specify either:\\n* An existing VolumeSnapshot object (snapshot.storage.k8s.io/VolumeSnapshot)\\n* An existing PVC (PersistentVolumeClaim)\\nIf the provisioner or an external controller can support the specified data source,\\nit will create a new volume based on the contents of the specified data source.\\nWhen the AnyVolumeDataSource feature gate is enabled, dataSource contents will be copied to dataSourceRef,\\nand dataSourceRef contents will be copied to dataSource when dataSourceRef.namespace is not specified.\\nIf the namespace is specified, then dataSourceRef will not be copied to dataSource."'),
          dataSource: {
            '#withApiGroup':: d.fn(help='"APIGroup is the group for the resource being referenced.\\nIf APIGroup is not specified, the specified Kind must be in the core API group.\\nFor any other third-party types, APIGroup is required."', args=[d.arg(name='apiGroup', type=d.T.string)]),
      ...
      '#withDisableMountSubPath':: d.fn(help='"disableMountSubPath deprecated: subPath usage will be removed in a future release."', args=[d.arg(name='disableMountSubPath', type=d.T.boolean)]),
      withDisableMountSubPath(disableMountSubPath): { spec+: { storage+: { disableMountSubPath: disableMountSubPath } } },
    },
    '#thanos':: d.obj(help='"thanos defines the configuration of the optional Thanos sidecar."'),
    thanos: {
      '#additionalArgs':: d.obj(help='"additionalArgs allows setting additional arguments for the Thanos container.\\nThe arguments are passed as-is to the Thanos container which may cause issues\\nif they are invalid or not supported the given Thanos version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument, the reconciliation will\\nfail and an error will be logged."'),
      additionalArgs: {
        '#withName':: d.fn(help='"name of the argument, e.g. \\"scrape.discovery-reload-interval\\"."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"value defines the argument value, e.g. 30s. Can be empty for name-only arguments (e.g. --storage.tsdb.no-lockfile)"', args=[d.arg(name='value', type=d.T.string)]),
      ...
      '#grpcServerTlsConfig':: d.obj(help='"grpcServerTlsConfig defines the TLS parameters for the gRPC server providing the StoreAPI.\\n\\nNote: Currently only the `caFile`, `certFile`, and `keyFile` fields are supported."'),
      grpcServerTlsConfig: {
        '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
        ...
        '#withMaxVersion':: d.fn(help='"maxVersion defines the maximum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0."', args=[d.arg(name='maxVersion', type=d.T.string)]),
        withMaxVersion(maxVersion): { spec+: { thanos+: { grpcServerTlsConfig+: { maxVersion: maxVersion } } } },
        '#withMinVersion':: d.fn(help='"minVersion defines the minimum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.35.0 or Thanos >= v0.28.0."', args=[d.arg(name='minVersion', type=d.T.string)]),
        withMinVersion(minVersion): { spec+: { thanos+: { grpcServerTlsConfig+: { minVersion: minVersion } } } },
        '#withServerName':: d.fn(help='"serverName is used to verify the hostname for the targets."', args=[d.arg(name='serverName', type=d.T.string)]),
        withServerName(serverName): { spec+: { thanos+: { grpcServerTlsConfig+: { serverName: serverName } } } },
      },
      '#objectStorageConfig':: d.obj(help="\"objectStorageConfig defines the Thanos sidecar's configuration to upload TSDB blocks to object storage.\\n\\nMore info: https://thanos.io/tip/thanos/storage.md/\\n\\nobjectStorageConfigFile takes precedence over this field.\""),
      objectStorageConfig: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#resources':: d.obj(help='"resources defines the resources requests and limits of the Thanos sidecar."'),
      resources: {
        '#claims':: d.obj(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."'),
        claims: {
          '#withName':: d.fn(help='"Name must match the name of one entry in pod.spec.resourceClaims of\\nthe Pod where this field is used. It makes that resource available\\ninside a container."', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
        withClaims(claims): { spec+: { thanos+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
        withClaimsMixin(claims): { spec+: { thanos+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } },
        '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed.\\nMore info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
      ...
      '#tracingConfig':: d.obj(help='"tracingConfig defines the tracing configuration for the Thanos sidecar.\\n\\n`tracingConfigFile` takes precedence over this field.\\n\\nMore info: https://thanos.io/tip/thanos/tracing.md/\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."'),
      tracingConfig: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#volumeMounts':: d.obj(help="\"volumeMounts allows configuration of additional VolumeMounts for Thanos.\\nVolumeMounts specified will be appended to other VolumeMounts in the\\n'thanos-sidecar' container.\""),
      volumeMounts: {
        '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must\\nnot contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
        withMountPath(mountPath): { mountPath: mountPath },
        '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host\\nto container and the other way around.\\nWhen not set, MountPropagationNone is used.\\nThis field is beta in 1.10.\\nWhen RecursiveReadOnly is set to IfPossible or to Enabled, MountPropagation must be None or unspecified\\n(which defaults to None)."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
      ...
      '#withAdditionalArgs':: d.fn(help='"additionalArgs allows setting additional arguments for the Thanos container.\\nThe arguments are passed as-is to the Thanos container which may cause issues\\nif they are invalid or not supported the given Thanos version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument, the reconciliation will\\nfail and an error will be logged."', args=[d.arg(name='additionalArgs', type=d.T.array)]),
      ...
      '#withAdditionalArgsMixin':: d.fn(help='"additionalArgs allows setting additional arguments for the Thanos container.\\nThe arguments are passed as-is to the Thanos container which may cause issues\\nif they are invalid or not supported the given Thanos version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument, the reconciliation will\\nfail and an error will be logged."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalArgs', type=d.T.array)]),
      ...
      '#withBaseImage':: d.fn(help="\"baseImage is deprecated: use 'image' instead.\"", args=[d.arg(name='baseImage', type=d.T.string)]),
      withBaseImage(baseImage): { spec+: { thanos+: { baseImage: baseImage } } },
      '#withBlockSize':: d.fn(help='"blockSize controls the size of TSDB blocks produced by Prometheus.\\nThe default value is 2h to match the upstream Prometheus defaults.\\n\\nWARNING: Changing the block duration can impact the performance and\\nefficiency of the entire Prometheus/Thanos stack due to how it interacts\\nwith memory and Thanos compactors. It is recommended to keep this value\\nset to a multiple of 120 times your longest scrape or rule interval. For\\nexample, 30s * 120 = 1h."', args=[d.arg(name='blockSize', type=d.T.string)]),
      withBlockSize(blockSize): { spec+: { thanos+: { blockSize: blockSize } } },
      '#withGetConfigInterval':: d.fn(help='"getConfigInterval defines how often to retrieve the Prometheus configuration."', args=[d.arg(name='getConfigInterval', type=d.T.string)]),
      withGetConfigInterval(getConfigInterval): { spec+: { thanos+: { getConfigInterval: getConfigInterval } } },
      '#withGetConfigTimeout':: d.fn(help='"getConfigTimeout defines the maximum time to wait when retrieving the Prometheus configuration."', args=[d.arg(name='getConfigTimeout', type=d.T.string)]),
      withGetConfigTimeout(getConfigTimeout): { spec+: { thanos+: { getConfigTimeout: getConfigTimeout } } },
      '#withGrpcListenLocal':: d.fn(help="\"grpcListenLocal defines when true, the Thanos sidecar listens on the loopback interface instead\\nof the Pod IP's address for the gRPC endpoints.\\n\\nIt has no effect if `listenLocal` is true.\"", args=[d.arg(name='grpcListenLocal', type=d.T.boolean)]),
      withGrpcListenLocal(grpcListenLocal): { spec+: { thanos+: { grpcListenLocal: grpcListenLocal } } },
      '#withHttpListenLocal':: d.fn(help="\"httpListenLocal when true, the Thanos sidecar listens on the loopback interface instead\\nof the Pod IP's address for the HTTP endpoints.\\n\\nIt has no effect if `listenLocal` is true.\"", args=[d.arg(name='httpListenLocal', type=d.T.boolean)]),
      withHttpListenLocal(httpListenLocal): { spec+: { thanos+: { httpListenLocal: httpListenLocal } } },
      '#withImage':: d.fn(help='"image defines the container image name for Thanos. If specified, it takes precedence over\\nthe `spec.thanos.baseImage`, `spec.thanos.tag` and `spec.thanos.sha`\\nfields.\\n\\nSpecifying `spec.thanos.version` is still necessary to ensure the\\nPrometheus Operator knows which version of Thanos is being configured.\\n\\nIf neither `spec.thanos.image` nor `spec.thanos.baseImage` are defined,\\nthe operator will use the latest upstream version of Thanos available at\\nthe time when the operator was released."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { thanos+: { image: image } } },
      '#withListenLocal':: d.fn(help='"listenLocal is deprecated: use `grpcListenLocal` and `httpListenLocal` instead."', args=[d.arg(name='listenLocal', type=d.T.boolean)]),
      withListenLocal(listenLocal): { spec+: { thanos+: { listenLocal: listenLocal } } },
      '#withLogFormat':: d.fn(help='"logFormat for the Thanos sidecar."', args=[d.arg(name='logFormat', type=d.T.string)]),
      withLogFormat(logFormat): { spec+: { thanos+: { logFormat: logFormat } } },
      '#withLogLevel':: d.fn(help='"logLevel for the Thanos sidecar."', args=[d.arg(name='logLevel', type=d.T.string)]),
      withLogLevel(logLevel): { spec+: { thanos+: { logLevel: logLevel } } },
      '#withMinTime':: d.fn(help="\"minTime defines the start of time range limit served by the Thanos sidecar's StoreAPI.\\nThe field's value should be a constant time in RFC3339 format or a time\\nduration relative to current time, such as -1d or 2h45m. Valid duration\\nunits are ms, s, m, h, d, w, y.\"", args=[d.arg(name='minTime', type=d.T.string)]),
      withMinTime(minTime): { spec+: { thanos+: { minTime: minTime } } },
      '#withObjectStorageConfigFile':: d.fn(help="\"objectStorageConfigFile defines the Thanos sidecar's configuration file to upload TSDB blocks to object storage.\\n\\nMore info: https://thanos.io/tip/thanos/storage.md/\\n\\nThis field takes precedence over objectStorageConfig.\"", args=[d.arg(name='objectStorageConfigFile', type=d.T.string)]),
      withObjectStorageConfigFile(objectStorageConfigFile): { spec+: { thanos+: { objectStorageConfigFile: objectStorageConfigFile } } },
      '#withReadyTimeout':: d.fn(help='"readyTimeout defines the maximum time that the Thanos sidecar will wait for\\nPrometheus to start."', args=[d.arg(name='readyTimeout', type=d.T.string)]),
      withReadyTimeout(readyTimeout): { spec+: { thanos+: { readyTimeout: readyTimeout } } },
      '#withSha':: d.fn(help="\"sha is deprecated: use 'image' instead.  The image digest can be specified as part of the image name.\"", args=[d.arg(name='sha', type=d.T.string)]),
      withSha(sha): { spec+: { thanos+: { sha: sha } } },
      '#withTag':: d.fn(help="\"tag is deprecated: use 'image' instead. The image's tag can be specified as as part of the image name.\"", args=[d.arg(name='tag', type=d.T.string)]),
      withTag(tag): { spec+: { thanos+: { tag: tag } } },
      '#withTracingConfigFile':: d.fn(help='"tracingConfigFile defines the tracing configuration file for the Thanos sidecar.\\n\\nThis field takes precedence over `tracingConfig`.\\n\\nMore info: https://thanos.io/tip/thanos/tracing.md/\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."', args=[d.arg(name='tracingConfigFile', type=d.T.string)]),
      withTracingConfigFile(tracingConfigFile): { spec+: { thanos+: { tracingConfigFile: tracingConfigFile } } },
      '#withVersion':: d.fn(help='"version of Thanos being deployed. The operator uses this information\\nto generate the Prometheus StatefulSet + configuration files.\\n\\nIf not specified, the operator assumes the latest upstream release of\\nThanos available at the time when the version of the operator was\\nreleased."', args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { spec+: { thanos+: { version: version } } },
      '#withVolumeMounts':: d.fn(help="\"volumeMounts allows configuration of additional VolumeMounts for Thanos.\\nVolumeMounts specified will be appended to other VolumeMounts in the\\n'thanos-sidecar' container.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { spec+: { thanos+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help="\"volumeMounts allows configuration of additional VolumeMounts for Thanos.\\nVolumeMounts specified will be appended to other VolumeMounts in the\\n'thanos-sidecar' container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
    ...
    '#tolerations':: d.obj(help="\"tolerations defines the Pods' tolerations if specified.\""),
    tolerations: {
    ...
    '#topologySpreadConstraints':: d.obj(help="\"topologySpreadConstraints defines the pod's topology spread constraints if specified.\""),
    topologySpreadConstraints: {
      ...
      '#withAdditionalLabelSelectors':: d.fn(help='"additionalLabelSelectors Defines what Prometheus Operator managed labels should be added to labelSelector on the topologySpreadConstraint."', args=[d.arg(name='additionalLabelSelectors', type=d.T.string)]),
    ...
    '#tracingConfig':: d.obj(help='"tracingConfig defines tracing in Prometheus.\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."'),
    tracingConfig: {
      '#tlsConfig':: d.obj(help='"tlsConfig to use when sending traces."'),
      tlsConfig: {
        '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
      ...
      '#withClientType':: d.fn(help='"clientType defines the client used to export the traces. Supported values are `http` or `grpc`."', args=[d.arg(name='clientType', type=d.T.string)]),
      ...
      '#withHeaders':: d.fn(help='"headers defines the key-value pairs to be used as headers associated with gRPC or HTTP requests."', args=[d.arg(name='headers', type=d.T.object)]),
      withHeaders(headers): { spec+: { tracingConfig+: { headers: headers } } },
      '#withHeadersMixin':: d.fn(help='"headers defines the key-value pairs to be used as headers associated with gRPC or HTTP requests."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.object)]),
      withHeadersMixin(headers): { spec+: { tracingConfig+: { headers+: headers } } },
      '#withInsecure':: d.fn(help='"insecure if disabled, the client will use a secure connection."', args=[d.arg(name='insecure', type=d.T.boolean)]),
      withInsecure(insecure): { spec+: { tracingConfig+: { insecure: insecure } } },
      '#withSamplingFraction':: d.fn(help='"samplingFraction defines the probability a given trace will be sampled. Must be a float from 0 through 1."', args=[d.arg(name='samplingFraction', type=d.T.any)]),
      withSamplingFraction(samplingFraction): { spec+: { tracingConfig+: { samplingFraction: samplingFraction } } },
      '#withTimeout':: d.fn(help='"timeout defines the maximum time the exporter will wait for each batch export."', args=[d.arg(name='timeout', type=d.T.string)]),
      withTimeout(timeout): { spec+: { tracingConfig+: { timeout: timeout } } },
    },
    '#tsdb':: d.obj(help='"tsdb defines the runtime reloadable configuration of the timeseries database(TSDB).\\nIt requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0."'),
    tsdb: {
      '#withOutOfOrderTimeWindow':: d.fn(help='"outOfOrderTimeWindow defines how old an out-of-order/out-of-bounds sample can be with\\nrespect to the TSDB max time.\\n\\nAn out-of-order/out-of-bounds sample is ingested into the TSDB as long as\\nthe timestamp of the sample is >= (TSDB.MaxTime - outOfOrderTimeWindow).\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way.\\n\\nIt requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0."', args=[d.arg(name='outOfOrderTimeWindow', type=d.T.string)]),
    ...
    '#web':: d.obj(help='"web defines the configuration of the Prometheus web server."'),
    web: {
      '#httpConfig':: d.obj(help='"httpConfig defines HTTP parameters for web server."'),
      httpConfig: {
        '#headers':: d.obj(help='"headers defines a list of headers that can be added to HTTP responses."'),
        headers: {
          '#withContentSecurityPolicy':: d.fn(help='"contentSecurityPolicy defines the Content-Security-Policy header to HTTP responses.\\nUnset if blank."', args=[d.arg(name='contentSecurityPolicy', type=d.T.string)]),
          withContentSecurityPolicy(contentSecurityPolicy): { spec+: { web+: { httpConfig+: { headers+: { contentSecurityPolicy: contentSecurityPolicy } } } } },
          '#withStrictTransportSecurity':: d.fn(help='"strictTransportSecurity defines the Strict-Transport-Security header to HTTP responses.\\nUnset if blank.\\nPlease make sure that you use this with care as this header might force\\nbrowsers to load Prometheus and the other applications hosted on the same\\ndomain and subdomains over HTTPS.\\nhttps://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Strict-Transport-Security"', args=[d.arg(name='strictTransportSecurity', type=d.T.string)]),
      ...
      tlsConfig: {
        ...
        '#client_ca':: d.obj(help='"client_ca defines the Secret or ConfigMap containing the CA certificate for client certificate\\nauthentication to the server.\\n\\nIt is mutually exclusive with `clientCAFile`."'),
        client_ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#keySecret':: d.obj(help='"keySecret defines the secret containing the TLS private key for the web server.\\n\\nEither `cert` or `certFile` must be defined.\\n\\nIt is mutually exclusive with `keyFile`."'),
        keySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withCertFile':: d.fn(help='"certFile defines the path to the TLS certificate file in the container for the web server.\\n\\nEither `keySecret` or `keyFile` must be defined.\\n\\nIt is mutually exclusive with `cert`."', args=[d.arg(name='certFile', type=d.T.string)]),
        withCertFile(certFile): { spec+: { web+: { tlsConfig+: { certFile: certFile } } } },
        '#withCipherSuites':: d.fn(help='"cipherSuites defines the list of supported cipher suites for TLS versions up to TLS 1.2.\\n\\nIf not defined, the Go default cipher suites are used.\\nAvailable cipher suites are documented in the Go documentation:\\nhttps://golang.org/pkg/crypto/tls/#pkg-constants"', args=[d.arg(name='cipherSuites', type=d.T.array)]),
        ...
        '#withCipherSuitesMixin':: d.fn(help='"cipherSuites defines the list of supported cipher suites for TLS versions up to TLS 1.2.\\n\\nIf not defined, the Go default cipher suites are used.\\nAvailable cipher suites are documented in the Go documentation:\\nhttps://golang.org/pkg/crypto/tls/#pkg-constants"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='cipherSuites', type=d.T.array)]),
        ...
        '#withClientAuthType':: d.fn(help='"clientAuthType defines the server policy for client TLS authentication.\\n\\nFor more detail on clientAuth options:\\nhttps://golang.org/pkg/crypto/tls/#ClientAuthType"', args=[d.arg(name='clientAuthType', type=d.T.string)]),
        withClientAuthType(clientAuthType): { spec+: { web+: { tlsConfig+: { clientAuthType: clientAuthType } } } },
        '#withClientCAFile':: d.fn(help='"clientCAFile defines the path to the CA certificate file for client certificate authentication to\\nthe server.\\n\\nIt is mutually exclusive with `client_ca`."', args=[d.arg(name='clientCAFile', type=d.T.string)]),
        withClientCAFile(clientCAFile): { spec+: { web+: { tlsConfig+: { clientCAFile: clientCAFile } } } },
        '#withCurvePreferences':: d.fn(help='"curvePreferences defines elliptic curves that will be used in an ECDHE handshake, in preference\\norder.\\n\\nAvailable curves are documented in the Go documentation:\\nhttps://golang.org/pkg/crypto/tls/#CurveID"', args=[d.arg(name='curvePreferences', type=d.T.array)]),
        ...
        '#withCurvePreferencesMixin':: d.fn(help='"curvePreferences defines elliptic curves that will be used in an ECDHE handshake, in preference\\norder.\\n\\nAvailable curves are documented in the Go documentation:\\nhttps://golang.org/pkg/crypto/tls/#CurveID"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='curvePreferences', type=d.T.array)]),
        ...
        '#withKeyFile':: d.fn(help='"keyFile defines the path to the TLS private key file in the container for the web server.\\n\\nIf defined, either `cert` or `certFile` must be defined.\\n\\nIt is mutually exclusive with `keySecret`."', args=[d.arg(name='keyFile', type=d.T.string)]),
        withKeyFile(keyFile): { spec+: { web+: { tlsConfig+: { keyFile: keyFile } } } },
        '#withMaxVersion':: d.fn(help='"maxVersion defines the Maximum TLS version that is acceptable."', args=[d.arg(name='maxVersion', type=d.T.string)]),
        withMaxVersion(maxVersion): { spec+: { web+: { tlsConfig+: { maxVersion: maxVersion } } } },
        '#withMinVersion':: d.fn(help='"minVersion defines the minimum TLS version that is acceptable."', args=[d.arg(name='minVersion', type=d.T.string)]),
        withMinVersion(minVersion): { spec+: { web+: { tlsConfig+: { minVersion: minVersion } } } },
        '#withPreferServerCipherSuites':: d.fn(help="\"preferServerCipherSuites defines whether the server selects the client's most preferred cipher\\nsuite, or the server's most preferred cipher suite.\\n\\nIf true then the server's preference, as expressed in\\nthe order of elements in cipherSuites, is used.\"", args=[d.arg(name='preferServerCipherSuites', type=d.T.boolean)]),
      ...
      '#withMaxConnections':: d.fn(help="\"maxConnections defines the maximum number of simultaneous connections\\nA zero value means that Prometheus doesn't accept any incoming connection.\"", args=[d.arg(name='maxConnections', type=d.T.integer)]),
      withMaxConnections(maxConnections): { spec+: { web+: { maxConnections: maxConnections } } },
      '#withPageTitle':: d.fn(help='"pageTitle defines the prometheus web page title."', args=[d.arg(name='pageTitle', type=d.T.string)]),
    ...
    '#withAllowOverlappingBlocks':: d.fn(help='"allowOverlappingBlocks enables vertical compaction and vertical query\\nmerge in Prometheus.\\n\\nDeprecated: this flag has no effect for Prometheus >= 2.39.0 where overlapping blocks are enabled by default."', args=[d.arg(name='allowOverlappingBlocks', type=d.T.boolean)]),
    withAllowOverlappingBlocks(allowOverlappingBlocks): { spec+: { allowOverlappingBlocks: allowOverlappingBlocks } },
    '#withAutomountServiceAccountToken':: d.fn(help="\"automountServiceAccountToken defines whether a service account token should be automatically mounted in the pod.\\nIf the field isn't set, the operator mounts the service account token by default.\\n\\n**Warning:** be aware that by default, Prometheus requires the service account token for Kubernetes service discovery.\\nIt is possible to use strategic merge patch to project the service account token into the 'prometheus' container.\"", args=[d.arg(name='automountServiceAccountToken', type=d.T.boolean)]),
    ...
    '#withBaseImage':: d.fn(help="\"baseImage is deprecated: use 'spec.image' instead.\"", args=[d.arg(name='baseImage', type=d.T.string)]),
    ...
    '#withConvertClassicHistogramsToNHCB':: d.fn(help='"convertClassicHistogramsToNHCB defines whether to convert all scraped classic histograms into a native\\nhistogram with custom buckets.\\n\\nIt requires Prometheus >= v3.4.0."', args=[d.arg(name='convertClassicHistogramsToNHCB', type=d.T.boolean)]),
    ...
    '#withDisableCompaction':: d.fn(help='"disableCompaction when true, the Prometheus compaction is disabled.\\nWhen `spec.thanos.objectStorageConfig` or `spec.objectStorageConfigFile` are defined, the operator automatically\\ndisables block compaction to avoid race conditions during block uploads (as the Thanos documentation recommends)."', args=[d.arg(name='disableCompaction', type=d.T.boolean)]),
    withDisableCompaction(disableCompaction): { spec+: { disableCompaction: disableCompaction } },
    '#withDnsPolicy':: d.fn(help='"dnsPolicy defines the DNS policy for the pods."', args=[d.arg(name='dnsPolicy', type=d.T.string)]),
    withDnsPolicy(dnsPolicy): { spec+: { dnsPolicy: dnsPolicy } },
    '#withEnableAdminAPI':: d.fn(help='"enableAdminAPI defines access to the Prometheus web admin API.\\n\\nWARNING: Enabling the admin APIs enables mutating endpoints, to delete data,\\nshutdown Prometheus, and more. Enabling this should be done with care and the\\nuser is advised to add additional authentication authorization via a proxy to\\nensure only clients authorized to perform these actions can do so.\\n\\nFor more information:\\nhttps://prometheus.io/docs/prometheus/latest/querying/api/#tsdb-admin-apis"', args=[d.arg(name='enableAdminAPI', type=d.T.boolean)]),
    withEnableAdminAPI(enableAdminAPI): { spec+: { enableAdminAPI: enableAdminAPI } },
    '#withEnableFeatures':: d.fn(help='"enableFeatures enables access to Prometheus feature flags. By default, no features are enabled.\\n\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nFor more information see https://prometheus.io/docs/prometheus/latest/feature_flags/"', args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withEnableFeaturesMixin':: d.fn(help='"enableFeatures enables access to Prometheus feature flags. By default, no features are enabled.\\n\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nFor more information see https://prometheus.io/docs/prometheus/latest/feature_flags/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withExcludedFromEnforcementMixin':: d.fn(help='"excludedFromEnforcement defines the list of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objects\\nto be excluded from enforcing a namespace label of origin.\\n\\nIt is only applicable if `spec.enforcedNamespaceLabel` set to true."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='excludedFromEnforcement', type=d.T.array)]),
    ...
    '#withImagePullSecretsMixin':: d.fn(help='"imagePullSecrets defines an optional list of references to Secrets in the same namespace\\nto use for pulling images from registries.\\nSee http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
    ...
    '#withListenLocal':: d.fn(help="\"listenLocal when true, the Prometheus server listens on the loopback address\\ninstead of the Pod IP's address.\"", args=[d.arg(name='listenLocal', type=d.T.boolean)]),
    withListenLocal(listenLocal): { spec+: { listenLocal: listenLocal } },
    '#withLogFormat':: d.fn(help='"logFormat for Log level for Prometheus and the config-reloader sidecar."', args=[d.arg(name='logFormat', type=d.T.string)]),
    withLogFormat(logFormat): { spec+: { logFormat: logFormat } },
    '#withLogLevel':: d.fn(help='"logLevel for Prometheus and the config-reloader sidecar."', args=[d.arg(name='logLevel', type=d.T.string)]),
    withLogLevel(logLevel): { spec+: { logLevel: logLevel } },
    '#withMaximumStartupDurationSeconds':: d.fn(help="\"maximumStartupDurationSeconds defines the maximum time that the `prometheus` container's startup probe will wait before being considered failed. The startup probe will return success after the WAL replay is complete.\\nIf set, the value should be greater than 60 (seconds). Otherwise it will be equal to 900 seconds (15 minutes).\"", args=[d.arg(name='maximumStartupDurationSeconds', type=d.T.integer)]),
    ...
    '#withPrometheusExternalLabelName':: d.fn(help='"prometheusExternalLabelName defines the name of Prometheus external label used to denote the Prometheus instance\\nname. The external label will _not_ be added when the field is set to\\nthe empty string (`\\"\\"`).\\n\\nDefault: \\"prometheus\\', args=[d.arg(name='prometheusExternalLabelName', type=d.T.string)]),
    withPrometheusExternalLabelName(prometheusExternalLabelName): { spec+: { prometheusExternalLabelName: prometheusExternalLabelName } },
    '#withPrometheusRulesExcludedFromEnforce':: d.fn(help="\"prometheusRulesExcludedFromEnforce defines the list of PrometheusRule objects to which the namespace label\\nenforcement doesn't apply.\\nThis is only relevant when `spec.enforcedNamespaceLabel` is set to true.\\nDeprecated: use `spec.excludedFromEnforcement` instead.\"", args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withPrometheusRulesExcludedFromEnforceMixin':: d.fn(help="\"prometheusRulesExcludedFromEnforce defines the list of PrometheusRule objects to which the namespace label\\nenforcement doesn't apply.\\nThis is only relevant when `spec.enforcedNamespaceLabel` is set to true.\\nDeprecated: use `spec.excludedFromEnforcement` instead.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withQueryLogFile':: d.fn(help="\"queryLogFile specifies where the file to which PromQL queries are logged.\\n\\nIf the filename has an empty path, e.g. 'query.log', The Prometheus Pods\\nwill mount the file into an emptyDir volume at `/var/log/prometheus`.\\nIf a full path is provided, e.g. '/var/log/prometheus/query.log', you\\nmust mount a volume in the specified directory and it must be writable.\\nThis is because the prometheus container runs with a read-only root\\nfilesystem for security reasons.\\nAlternatively, the location can be set to a standard I/O stream, e.g.\\n`/dev/stdout`, to log query information to the default Prometheus log\\nstream.\"", args=[d.arg(name='queryLogFile', type=d.T.string)]),
    withQueryLogFile(queryLogFile): { spec+: { queryLogFile: queryLogFile } },
    '#withReloadStrategy':: d.fn(help='"reloadStrategy defines the strategy used to reload the Prometheus configuration.\\nIf not specified, the configuration is reloaded using the /-/reload HTTP endpoint."', args=[d.arg(name='reloadStrategy', type=d.T.string)]),
    withReloadStrategy(reloadStrategy): { spec+: { reloadStrategy: reloadStrategy } },
    '#withRemoteRead':: d.fn(help='"remoteRead defines the list of remote read configurations."', args=[d.arg(name='remoteRead', type=d.T.array)]),
    withRemoteRead(remoteRead): { spec+: { remoteRead: if std.isArray(v=remoteRead) then remoteRead else [remoteRead] } },
    '#withRemoteReadMixin':: d.fn(help='"remoteRead defines the list of remote read configurations."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='remoteRead', type=d.T.array)]),
    withRemoteReadMixin(remoteRead): { spec+: { remoteRead+: if std.isArray(v=remoteRead) then remoteRead else [remoteRead] } },
    '#withRemoteWrite':: d.fn(help='"remoteWrite defines the list of remote write configurations."', args=[d.arg(name='remoteWrite', type=d.T.array)]),
    withRemoteWrite(remoteWrite): { spec+: { remoteWrite: if std.isArray(v=remoteWrite) then remoteWrite else [remoteWrite] } },
    '#withRemoteWriteMixin':: d.fn(help='"remoteWrite defines the list of remote write configurations."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='remoteWrite', type=d.T.array)]),
    withRemoteWriteMixin(remoteWrite): { spec+: { remoteWrite+: if std.isArray(v=remoteWrite) then remoteWrite else [remoteWrite] } },
    '#withRemoteWriteReceiverMessageVersions':: d.fn(help='"remoteWriteReceiverMessageVersions list of the protobuf message versions to accept when receiving the\\nremote writes.\\n\\nIt requires Prometheus >= v2.54.0."', args=[d.arg(name='remoteWriteReceiverMessageVersions', type=d.T.array)]),
    withRemoteWriteReceiverMessageVersions(remoteWriteReceiverMessageVersions): { spec+: { remoteWriteReceiverMessageVersions: if std.isArray(v=remoteWriteReceiverMessageVersions) then remoteWriteReceiverMessageVersions else [remoteWriteReceiverMessageVersions] } },
    '#withRemoteWriteReceiverMessageVersionsMixin':: d.fn(help='"remoteWriteReceiverMessageVersions list of the protobuf message versions to accept when receiving the\\nremote writes.\\n\\nIt requires Prometheus >= v2.54.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='remoteWriteReceiverMessageVersions', type=d.T.array)]),
    withRemoteWriteReceiverMessageVersionsMixin(remoteWriteReceiverMessageVersions): { spec+: { remoteWriteReceiverMessageVersions+: if std.isArray(v=remoteWriteReceiverMessageVersions) then remoteWriteReceiverMessageVersions else [remoteWriteReceiverMessageVersions] } },
    '#withReplicaExternalLabelName':: d.fn(help='"replicaExternalLabelName defines the name of Prometheus external label used to denote the replica name.\\nThe external label will _not_ be added when the field is set to the\\nempty string (`\\"\\"`).\\n\\nDefault: \\"prometheus_replica\\', args=[d.arg(name='replicaExternalLabelName', type=d.T.string)]),
    withReplicaExternalLabelName(replicaExternalLabelName): { spec+: { replicaExternalLabelName: replicaExternalLabelName } },
    '#withReplicas':: d.fn(help='"replicas defines the number of replicas of each shard to deploy for a Prometheus deployment.\\n`spec.replicas` multiplied by `spec.shards` is the total number of Pods\\ncreated.\\n\\nDefault: 1"', args=[d.arg(name='replicas', type=d.T.integer)]),
    withReplicas(replicas): { spec+: { replicas: replicas } },
    '#withRetention':: d.fn(help='"retention defines how long to retain the Prometheus data.\\n\\nDefault: \\"24h\\" if `spec.retention` and `spec.retentionSize` are empty."', args=[d.arg(name='retention', type=d.T.string)]),
    withRetention(retention): { spec+: { retention: retention } },
    '#withRetentionSize':: d.fn(help='"retentionSize defines the maximum number of bytes used by the Prometheus data."', args=[d.arg(name='retentionSize', type=d.T.string)]),
    withRetentionSize(retentionSize): { spec+: { retentionSize: retentionSize } },
    '#withRoutePrefix':: d.fn(help='"routePrefix defines the route prefix Prometheus registers HTTP handlers for.\\n\\nThis is useful when using `spec.externalURL`, and a proxy is rewriting\\nHTTP routes of a request, and the actual ExternalURL is still true, but\\nthe server serves requests under a different route prefix. For example\\nfor use with `kubectl proxy`."', args=[d.arg(name='routePrefix', type=d.T.string)]),
    withRoutePrefix(routePrefix): { spec+: { routePrefix: routePrefix } },
    '#withRuleQueryOffset':: d.fn(help='"ruleQueryOffset defines the offset the rule evaluation timestamp of this particular group by the specified duration into the past.\\nIt requires Prometheus >= v2.53.0."', args=[d.arg(name='ruleQueryOffset', type=d.T.string)]),
    withRuleQueryOffset(ruleQueryOffset): { spec+: { ruleQueryOffset: ruleQueryOffset } },
    ...
    '#withTerminationGracePeriodSeconds':: d.fn(help='"terminationGracePeriodSeconds defines the optional duration in seconds the pod needs to terminate gracefully.\\nValue must be non-negative integer. The value zero indicates stop immediately via\\nthe kill signal (no opportunity to shut down) which may lead to data corruption.\\n\\nDefaults to 600 seconds."', args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
    ...
    '#withTolerations':: d.fn(help="\"tolerations defines the Pods' tolerations if specified.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerations(tolerations): { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTolerationsMixin':: d.fn(help="\"tolerations defines the Pods' tolerations if specified.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerationsMixin(tolerations): { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTopologySpreadConstraints':: d.fn(help="\"topologySpreadConstraints defines the pod's topology spread constraints if specified.\"", args=[d.arg(name='topologySpreadConstraints', type=d.T.array)]),
    ...
    '#withTopologySpreadConstraintsMixin':: d.fn(help="\"topologySpreadConstraints defines the pod's topology spread constraints if specified.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='topologySpreadConstraints', type=d.T.array)]),
    ...
    '#withWalCompression':: d.fn(help='"walCompression defines the compression of the write-ahead log (WAL) using Snappy.\\n\\nWAL compression is enabled by default for Prometheus >= 2.20.0\\n\\nRequires Prometheus v2.11.0 and above."', args=[d.arg(name='walCompression', type=d.T.boolean)]),
