{
  ...
  '#new':: d.fn(help='new returns an instance of ThanosRuler', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'monitoring.coreos.com/v1',
    kind: 'ThanosRuler',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"spec defines the specification of the desired behavior of the ThanosRuler cluster. More info:\\nhttps://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    '#additionalArgs':: d.obj(help='"additionalArgs defines how to add additional arguments for the ThanosRuler container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nThanosRuler container which may cause issues if they are invalid or not supported\\nby the given ThanosRuler version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument the reconciliation will\\nfail and an error will be logged."'),
    additionalArgs: {
    ...
    '#affinity':: d.obj(help="\"affinity defines when specified, the pod's scheduling constraints.\""),
    affinity: {
    ...
    alertRelabelConfigs: {
      ...
      withName(name): { spec+: { alertRelabelConfigs+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { alertRelabelConfigs+: { optional: optional } } },
    },
    '#alertmanagersConfig':: d.obj(help='"alertmanagersConfig defines the list of Alertmanager endpoints to send alerts to.\\n\\nThe configuration format is defined at https://thanos.io/tip/components/rule.md/#alertmanager.\\n\\nIt requires Thanos >= v0.10.0.\\n\\nThe operator performs no validation of the configuration.\\n\\nThis field takes precedence over `alertmanagersUrl`."'),
    alertmanagersConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { alertmanagersConfig+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { alertmanagersConfig+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { alertmanagersConfig+: { optional: optional } } },
    },
    '#containers':: d.obj(help='"containers allows injecting additional containers or modifying operator generated\\ncontainers. This can be used to allow adding an authentication proxy to a ThanosRuler pod or\\nto change the behavior of an operator generated container. Containers described here modify\\nan operator generated container if they share the same name and modifications are done via a\\nstrategic merge patch. The current container names are: `thanos-ruler` and `config-reloader`.\\nOverriding containers is entirely outside the scope of what the maintainers will support and by doing\\nso, you accept that this behaviour may break at any time without notice."'),
    containers: {
    ...
    '#dnsConfig':: d.obj(help='"dnsConfig defines Defines the DNS configuration for the pods."'),
    dnsConfig: {
    ...
    '#excludedFromEnforcement':: d.obj(help='"excludedFromEnforcement defines the list of references to PrometheusRule objects\\nto be excluded from enforcing a namespace label of origin.\\nApplies only if enforcedNamespaceLabel set to true."'),
    ...
    '#grpcServerTlsConfig':: d.obj(help="\"grpcServerTlsConfig defines the gRPC server from which Thanos Querier reads\\nrecorded rule data.\\nNote: Currently only the CAFile, CertFile, and KeyFile fields are supported.\\nMaps to the '--grpc-server-tls-*' CLI args.\""),
    grpcServerTlsConfig: {
      ...
      ca: {
        ...
        configMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { grpcServerTlsConfig+: { ca+: { configMap+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { grpcServerTlsConfig+: { ca+: { configMap+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { grpcServerTlsConfig+: { ca+: { configMap+: { optional: optional } } } } },
        },
        '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
        secret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { grpcServerTlsConfig+: { ca+: { secret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { grpcServerTlsConfig+: { ca+: { secret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { grpcServerTlsConfig+: { ca+: { secret+: { optional: optional } } } } },
        },
      },
      ...
      cert: {
        ...
        configMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { grpcServerTlsConfig+: { cert+: { configMap+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { grpcServerTlsConfig+: { cert+: { configMap+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { grpcServerTlsConfig+: { cert+: { configMap+: { optional: optional } } } } },
        },
        '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
        secret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { grpcServerTlsConfig+: { cert+: { secret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { grpcServerTlsConfig+: { cert+: { secret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { grpcServerTlsConfig+: { cert+: { secret+: { optional: optional } } } } },
        },
      },
      '#keySecret':: d.obj(help='"keySecret defines the Secret containing the client key file for the targets."'),
      keySecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { grpcServerTlsConfig+: { keySecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { grpcServerTlsConfig+: { keySecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { grpcServerTlsConfig+: { keySecret+: { optional: optional } } } },
      },
      ...
      withCaFile(caFile): { spec+: { grpcServerTlsConfig+: { caFile: caFile } } },
      ...
      withCertFile(certFile): { spec+: { grpcServerTlsConfig+: { certFile: certFile } } },
      ...
      withInsecureSkipVerify(insecureSkipVerify): { spec+: { grpcServerTlsConfig+: { insecureSkipVerify: insecureSkipVerify } } },
      ...
      withKeyFile(keyFile): { spec+: { grpcServerTlsConfig+: { keyFile: keyFile } } },
      ...
      withMaxVersion(maxVersion): { spec+: { grpcServerTlsConfig+: { maxVersion: maxVersion } } },
      ...
      withMinVersion(minVersion): { spec+: { grpcServerTlsConfig+: { minVersion: minVersion } } },
      ...
      withServerName(serverName): { spec+: { grpcServerTlsConfig+: { serverName: serverName } } },
    },
    '#hostAliases':: d.obj(help="\"hostAliases defines pods' hostAliases configuration\""),
    hostAliases: {
    ...
    '#objectStorageConfig':: d.obj(help='"objectStorageConfig defines the configuration format is defined at https://thanos.io/tip/thanos/storage.md/#configuring-access-to-object-storage\\n\\nThe operator performs no validation of the configuration.\\n\\n`objectStorageConfigFile` takes precedence over this field."'),
    objectStorageConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { objectStorageConfig+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { objectStorageConfig+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { objectStorageConfig+: { optional: optional } } },
    },
    '#podMetadata':: d.obj(help='"podMetadata defines labels and annotations which are propagated to the ThanosRuler pods.\\n\\nThe following items are reserved and cannot be overridden:\\n* \\"app.kubernetes.io/name\\" label, set to \\"thanos-ruler\\".\\n* \\"app.kubernetes.io/managed-by\\" label, set to \\"prometheus-operator\\".\\n* \\"app.kubernetes.io/instance\\" label, set to the name of the ThanosRuler instance.\\n* \\"thanos-ruler\\" label, set to the name of the ThanosRuler instance.\\n* \\"kubectl.kubernetes.io/default-container\\" annotation, set to \\"thanos-ruler\\"."'),
    podMetadata: {
    ...
    '#prometheusRulesExcludedFromEnforce':: d.obj(help='"prometheusRulesExcludedFromEnforce defines a list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."'),
    ...
    '#queryConfig':: d.obj(help='"queryConfig defines the list of Thanos Query endpoints from which to query metrics.\\n\\nThe configuration format is defined at https://thanos.io/tip/components/rule.md/#query-api\\n\\nIt requires Thanos >= v0.11.0.\\n\\nThe operator performs no validation of the configuration.\\n\\nThis field takes precedence over `queryEndpoints`."'),
    queryConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { queryConfig+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { queryConfig+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { queryConfig+: { optional: optional } } },
    },
    ...
    '#resources':: d.obj(help='"resources defines the resource requirements for single Pods.\\nIf not provided, no requests/limits will be set"'),
    resources: {
      '#claims':: d.obj(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."'),
      claims: {
        '#withName':: d.fn(help='"Name must match the name of one entry in pod.spec.resourceClaims of\\nthe Pod where this field is used. It makes that resource available\\ninside a container."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#ruleNamespaceSelector':: d.obj(help='"ruleNamespaceSelector defines the namespaces to be selected for Rules discovery. If unspecified, only\\nthe same namespace as the ThanosRuler object is in is used."'),
    ...
    '#securityContext':: d.obj(help='"securityContext defines the pod-level security attributes and common container settings.\\nThis defaults to the default PodSecurityContext."'),
    securityContext: {
    ...
    '#storage':: d.obj(help='"storage defines the specification of how storage shall be used."'),
    storage: {
    ...
    '#tolerations':: d.obj(help="\"tolerations defines when specified, the pod's tolerations.\""),
    tolerations: {
    ...
    '#topologySpreadConstraints':: d.obj(help="\"topologySpreadConstraints defines the pod's topology spread constraints.\""),
    ...
    '#tracingConfig':: d.obj(help='"tracingConfig defines the tracing configuration.\\n\\nThe configuration format is defined at https://thanos.io/tip/thanos/tracing.md/#configuration\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way.\\n\\nThe operator performs no validation of the configuration.\\n\\n`tracingConfigFile` takes precedence over this field."'),
    tracingConfig: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { tracingConfig+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { tracingConfig+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { spec+: { tracingConfig+: { optional: optional } } },
    },
    '#volumeMounts':: d.obj(help='"volumeMounts defines how the configuration of additional VolumeMounts on the output StatefulSet definition.\\nVolumeMounts specified will be appended to other VolumeMounts in the ruler container,\\nthat are generated as a result of StorageSpec objects."'),
    volumeMounts: {
      '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must\\nnot contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
      withMountPath(mountPath): { mountPath: mountPath },
      '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host\\nto container and the other way around.\\nWhen not set, MountPropagationNone is used.\\nThis field is beta in 1.10.\\nWhen RecursiveReadOnly is set to IfPossible or to Enabled, MountPropagation must be None or unspecified\\n(which defaults to None)."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
    ...
    '#volumes':: d.obj(help='"volumes defines how configuration of additional volumes on the output StatefulSet definition. Volumes specified will\\nbe appended to other volumes that are generated as a result of StorageSpec objects."'),
    volumes: {
    ...
    '#web':: d.obj(help='"web defines the configuration of the ThanosRuler web server."'),
    web: {
    ...
    '#withAdditionalArgs':: d.fn(help='"additionalArgs defines how to add additional arguments for the ThanosRuler container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nThanosRuler container which may cause issues if they are invalid or not supported\\nby the given ThanosRuler version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument the reconciliation will\\nfail and an error will be logged."', args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withAdditionalArgsMixin':: d.fn(help='"additionalArgs defines how to add additional arguments for the ThanosRuler container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nThanosRuler container which may cause issues if they are invalid or not supported\\nby the given ThanosRuler version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument the reconciliation will\\nfail and an error will be logged."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withAlertDropLabels':: d.fn(help='"alertDropLabels defines the label names which should be dropped in Thanos Ruler\\nalerts.\\n\\nThe replica label `thanos_ruler_replica` will always be dropped from the alerts."', args=[d.arg(name='alertDropLabels', type=d.T.array)]),
    withAlertDropLabels(alertDropLabels): { spec+: { alertDropLabels: if std.isArray(v=alertDropLabels) then alertDropLabels else [alertDropLabels] } },
    '#withAlertDropLabelsMixin':: d.fn(help='"alertDropLabels defines the label names which should be dropped in Thanos Ruler\\nalerts.\\n\\nThe replica label `thanos_ruler_replica` will always be dropped from the alerts."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alertDropLabels', type=d.T.array)]),
    withAlertDropLabelsMixin(alertDropLabels): { spec+: { alertDropLabels+: if std.isArray(v=alertDropLabels) then alertDropLabels else [alertDropLabels] } },
    '#withAlertQueryUrl':: d.fn(help="\"alertQueryUrl defines how Thanos Ruler will set in the 'Source' field\\nof all alerts.\\nMaps to the '--alert.query-url' CLI arg.\"", args=[d.arg(name='alertQueryUrl', type=d.T.string)]),
    withAlertQueryUrl(alertQueryUrl): { spec+: { alertQueryUrl: alertQueryUrl } },
    '#withAlertRelabelConfigFile':: d.fn(help='"alertRelabelConfigFile defines the path to the alert relabeling configuration file.\\n\\nAlert relabel configuration must have the form as specified in the\\nofficial Prometheus documentation:\\nhttps://prometheus.io/docs/prometheus/latest/configuration/configuration/#alert_relabel_configs\\n\\nThe operator performs no validation of the configuration file.\\n\\nThis field takes precedence over `alertRelabelConfig`."', args=[d.arg(name='alertRelabelConfigFile', type=d.T.string)]),
    withAlertRelabelConfigFile(alertRelabelConfigFile): { spec+: { alertRelabelConfigFile: alertRelabelConfigFile } },
    '#withAlertmanagersUrl':: d.fn(help='"alertmanagersUrl defines the list of Alertmanager endpoints to send alerts to.\\n\\nFor Thanos >= v0.10.0, it is recommended to use `alertmanagersConfig` instead.\\n\\n`alertmanagersConfig` takes precedence over this field."', args=[d.arg(name='alertmanagersUrl', type=d.T.array)]),
    withAlertmanagersUrl(alertmanagersUrl): { spec+: { alertmanagersUrl: if std.isArray(v=alertmanagersUrl) then alertmanagersUrl else [alertmanagersUrl] } },
    '#withAlertmanagersUrlMixin':: d.fn(help='"alertmanagersUrl defines the list of Alertmanager endpoints to send alerts to.\\n\\nFor Thanos >= v0.10.0, it is recommended to use `alertmanagersConfig` instead.\\n\\n`alertmanagersConfig` takes precedence over this field."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alertmanagersUrl', type=d.T.array)]),
    withAlertmanagersUrlMixin(alertmanagersUrl): { spec+: { alertmanagersUrl+: if std.isArray(v=alertmanagersUrl) then alertmanagersUrl else [alertmanagersUrl] } },
    '#withContainers':: d.fn(help='"containers allows injecting additional containers or modifying operator generated\\ncontainers. This can be used to allow adding an authentication proxy to a ThanosRuler pod or\\nto change the behavior of an operator generated container. Containers described here modify\\nan operator generated container if they share the same name and modifications are done via a\\nstrategic merge patch. The current container names are: `thanos-ruler` and `config-reloader`.\\nOverriding containers is entirely outside the scope of what the maintainers will support and by doing\\nso, you accept that this behaviour may break at any time without notice."', args=[d.arg(name='containers', type=d.T.array)]),
    withContainers(containers): { spec+: { containers: if std.isArray(v=containers) then containers else [containers] } },
    '#withContainersMixin':: d.fn(help='"containers allows injecting additional containers or modifying operator generated\\ncontainers. This can be used to allow adding an authentication proxy to a ThanosRuler pod or\\nto change the behavior of an operator generated container. Containers described here modify\\nan operator generated container if they share the same name and modifications are done via a\\nstrategic merge patch. The current container names are: `thanos-ruler` and `config-reloader`.\\nOverriding containers is entirely outside the scope of what the maintainers will support and by doing\\nso, you accept that this behaviour may break at any time without notice."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='containers', type=d.T.array)]),
    ...
    '#withEnableFeatures':: d.fn(help='"enableFeatures defines how to setup Thanos Ruler feature flags. By default, no features are enabled.\\n\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nFor more information see https://thanos.io/tip/components/rule.md/\\n\\nIt requires Thanos >= 0.39.0."', args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withEnableFeaturesMixin':: d.fn(help='"enableFeatures defines how to setup Thanos Ruler feature flags. By default, no features are enabled.\\n\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nFor more information see https://thanos.io/tip/components/rule.md/\\n\\nIt requires Thanos >= 0.39.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withEvaluationInterval':: d.fn(help='"evaluationInterval defines the interval between consecutive evaluations."', args=[d.arg(name='evaluationInterval', type=d.T.string)]),
    withEvaluationInterval(evaluationInterval): { spec+: { evaluationInterval: evaluationInterval } },
    '#withExcludedFromEnforcement':: d.fn(help='"excludedFromEnforcement defines the list of references to PrometheusRule objects\\nto be excluded from enforcing a namespace label of origin.\\nApplies only if enforcedNamespaceLabel set to true."', args=[d.arg(name='excludedFromEnforcement', type=d.T.array)]),
    ...
    '#withExcludedFromEnforcementMixin':: d.fn(help='"excludedFromEnforcement defines the list of references to PrometheusRule objects\\nto be excluded from enforcing a namespace label of origin.\\nApplies only if enforcedNamespaceLabel set to true."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='excludedFromEnforcement', type=d.T.array)]),
    ...
    '#withExternalPrefix':: d.fn(help='"externalPrefix defines the Thanos Ruler instances will be available under. This is\\nnecessary to generate correct URLs. This is necessary if Thanos Ruler is not\\nserved from root of a DNS name."', args=[d.arg(name='externalPrefix', type=d.T.string)]),
    withExternalPrefix(externalPrefix): { spec+: { externalPrefix: externalPrefix } },
    '#withHostAliases':: d.fn(help="\"hostAliases defines pods' hostAliases configuration\"", args=[d.arg(name='hostAliases', type=d.T.array)]),
    withHostAliases(hostAliases): { spec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    '#withHostAliasesMixin':: d.fn(help="\"hostAliases defines pods' hostAliases configuration\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='hostAliases', type=d.T.array)]),
    ...
    '#withImage':: d.fn(help='"image defines Thanos container image URL."', args=[d.arg(name='image', type=d.T.string)]),
    withImage(image): { spec+: { image: image } },
    '#withImagePullPolicy':: d.fn(help="\"imagePullPolicy defines for the 'thanos', 'init-config-reloader' and 'config-reloader' containers.\\nSee https://kubernetes.io/docs/concepts/containers/images/#image-pull-policy for more details.\"", args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
    ...
    '#withLabels':: d.fn(help="\"labels defines the external label pairs of the ThanosRuler resource.\\n\\nA default replica label `thanos_ruler_replica` will be always added as a\\nlabel with the value of the pod's name.\"", args=[d.arg(name='labels', type=d.T.object)]),
    withLabels(labels): { spec+: { labels: labels } },
    '#withLabelsMixin':: d.fn(help="\"labels defines the external label pairs of the ThanosRuler resource.\\n\\nA default replica label `thanos_ruler_replica` will be always added as a\\nlabel with the value of the pod's name.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='labels', type=d.T.object)]),
    withLabelsMixin(labels): { spec+: { labels+: labels } },
    '#withListenLocal':: d.fn(help='"listenLocal defines the Thanos ruler listen on loopback, so that it\\ndoes not bind against the Pod IP."', args=[d.arg(name='listenLocal', type=d.T.boolean)]),
    withListenLocal(listenLocal): { spec+: { listenLocal: listenLocal } },
    '#withLogFormat':: d.fn(help='"logFormat for ThanosRuler to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    withLogFormat(logFormat): { spec+: { logFormat: logFormat } },
    '#withLogLevel':: d.fn(help='"logLevel for ThanosRuler to be configured with."', args=[d.arg(name='logLevel', type=d.T.string)]),
    ...
    '#withNodeSelector':: d.fn(help='"nodeSelector defines which Nodes the Pods are scheduled on."', args=[d.arg(name='nodeSelector', type=d.T.object)]),
    withNodeSelector(nodeSelector): { spec+: { nodeSelector: nodeSelector } },
    '#withNodeSelectorMixin':: d.fn(help='"nodeSelector defines which Nodes the Pods are scheduled on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelector', type=d.T.object)]),
    withNodeSelectorMixin(nodeSelector): { spec+: { nodeSelector+: nodeSelector } },
    '#withObjectStorageConfigFile':: d.fn(help='"objectStorageConfigFile defines the path of the object storage configuration file.\\n\\nThe configuration format is defined at https://thanos.io/tip/thanos/storage.md/#configuring-access-to-object-storage\\n\\nThe operator performs no validation of the configuration file.\\n\\nThis field takes precedence over `objectStorageConfig`."', args=[d.arg(name='objectStorageConfigFile', type=d.T.string)]),
    withObjectStorageConfigFile(objectStorageConfigFile): { spec+: { objectStorageConfigFile: objectStorageConfigFile } },
    '#withPaused':: d.fn(help='"paused defines when a ThanosRuler deployment is paused, no actions except for deletion\\nwill be performed on the underlying objects."', args=[d.arg(name='paused', type=d.T.boolean)]),
    withPaused(paused): { spec+: { paused: paused } },
    '#withPortName':: d.fn(help='"portName defines the port name used for the pods and governing service.\\nDefaults to `web`."', args=[d.arg(name='portName', type=d.T.string)]),
    withPortName(portName): { spec+: { portName: portName } },
    '#withPriorityClassName':: d.fn(help='"priorityClassName defines the priority class assigned to the Pods"', args=[d.arg(name='priorityClassName', type=d.T.string)]),
    withPriorityClassName(priorityClassName): { spec+: { priorityClassName: priorityClassName } },
    '#withPrometheusRulesExcludedFromEnforce':: d.fn(help='"prometheusRulesExcludedFromEnforce defines a list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."', args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withPrometheusRulesExcludedFromEnforceMixin':: d.fn(help='"prometheusRulesExcludedFromEnforce defines a list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withQueryEndpoints':: d.fn(help='"queryEndpoints defines the list of Thanos Query endpoints from which to query metrics.\\n\\nFor Thanos >= v0.11.0, it is recommended to use `queryConfig` instead.\\n\\n`queryConfig` takes precedence over this field."', args=[d.arg(name='queryEndpoints', type=d.T.array)]),
    withQueryEndpoints(queryEndpoints): { spec+: { queryEndpoints: if std.isArray(v=queryEndpoints) then queryEndpoints else [queryEndpoints] } },
    '#withQueryEndpointsMixin':: d.fn(help='"queryEndpoints defines the list of Thanos Query endpoints from which to query metrics.\\n\\nFor Thanos >= v0.11.0, it is recommended to use `queryConfig` instead.\\n\\n`queryConfig` takes precedence over this field."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='queryEndpoints', type=d.T.array)]),
    withQueryEndpointsMixin(queryEndpoints): { spec+: { queryEndpoints+: if std.isArray(v=queryEndpoints) then queryEndpoints else [queryEndpoints] } },
    '#withRemoteWrite':: d.fn(help="\"remoteWrite defines the list of remote write configurations.\\n\\nWhen the list isn't empty, the ruler is configured with stateless mode.\\n\\nIt requires Thanos \u003e= 0.24.0.\"", args=[d.arg(name='remoteWrite', type=d.T.array)]),
    ...
    '#withReplicas':: d.fn(help='"replicas defines the number of thanos ruler instances to deploy."', args=[d.arg(name='replicas', type=d.T.integer)]),
    withReplicas(replicas): { spec+: { replicas: replicas } },
    '#withResendDelay':: d.fn(help='"resendDelay defines the minimum amount of time to wait before resending an alert to Alertmanager."', args=[d.arg(name='resendDelay', type=d.T.string)]),
    withResendDelay(resendDelay): { spec+: { resendDelay: resendDelay } },
    '#withRetention':: d.fn(help="\"retention defines the time duration ThanosRuler shall retain data for. Default is '24h', and\\nmust match the regular expression `[0-9]+(ms|s|m|h|d|w|y)` (milliseconds\\nseconds minutes hours days weeks years).\\n\\nThe field has no effect when remote-write is configured since the Ruler\\noperates in stateless mode.\"", args=[d.arg(name='retention', type=d.T.string)]),
    withRetention(retention): { spec+: { retention: retention } },
    '#withRoutePrefix':: d.fn(help='"routePrefix defines the route prefix ThanosRuler registers HTTP handlers for. This allows thanos UI to be served on a sub-path."', args=[d.arg(name='routePrefix', type=d.T.string)]),
    withRoutePrefix(routePrefix): { spec+: { routePrefix: routePrefix } },
    '#withRuleConcurrentEval':: d.fn(help='"ruleConcurrentEval defines how many rules can be evaluated concurrently.\\nIt requires Thanos >= v0.37.0."', args=[d.arg(name='ruleConcurrentEval', type=d.T.integer)]),
    withRuleConcurrentEval(ruleConcurrentEval): { spec+: { ruleConcurrentEval: ruleConcurrentEval } },
    '#withRuleGracePeriod':: d.fn(help='"ruleGracePeriod defines the minimum duration between alert and restored \\"for\\" state.\\nThis is maintained only for alerts with configured \\"for\\" time greater than grace period.\\nIt requires Thanos >= v0.30.0."', args=[d.arg(name='ruleGracePeriod', type=d.T.string)]),
    withRuleGracePeriod(ruleGracePeriod): { spec+: { ruleGracePeriod: ruleGracePeriod } },
    '#withRuleOutageTolerance':: d.fn(help='"ruleOutageTolerance defines the max time to tolerate prometheus outage for restoring \\"for\\" state of alert.\\nIt requires Thanos >= v0.30.0."', args=[d.arg(name='ruleOutageTolerance', type=d.T.string)]),
    withRuleOutageTolerance(ruleOutageTolerance): { spec+: { ruleOutageTolerance: ruleOutageTolerance } },
    '#withRuleQueryOffset':: d.fn(help="\"ruleQueryOffset defines the default rule group's query offset duration to use.\\nIt requires Thanos \u003e= v0.38.0.\"", args=[d.arg(name='ruleQueryOffset', type=d.T.string)]),
    withRuleQueryOffset(ruleQueryOffset): { spec+: { ruleQueryOffset: ruleQueryOffset } },
    '#withServiceAccountName':: d.fn(help='"serviceAccountName defines the name of the ServiceAccount to use to run the\\nThanos Ruler Pods."', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
    ...
    '#withTolerations':: d.fn(help="\"tolerations defines when specified, the pod's tolerations.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerations(tolerations): { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTolerationsMixin':: d.fn(help="\"tolerations defines when specified, the pod's tolerations.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerationsMixin(tolerations): { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTopologySpreadConstraints':: d.fn(help="\"topologySpreadConstraints defines the pod's topology spread constraints.\"", args=[d.arg(name='topologySpreadConstraints', type=d.T.array)]),
    ...
    '#withTopologySpreadConstraintsMixin':: d.fn(help="\"topologySpreadConstraints defines the pod's topology spread constraints.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='topologySpreadConstraints', type=d.T.array)]),
    ...
    '#withTracingConfigFile':: d.fn(help='"tracingConfigFile defines the path of the tracing configuration file.\\n\\nThe configuration format is defined at https://thanos.io/tip/thanos/tracing.md/#configuration\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way.\\n\\nThe operator performs no validation of the configuration file.\\n\\nThis field takes precedence over `tracingConfig`."', args=[d.arg(name='tracingConfigFile', type=d.T.string)]),
    withTracingConfigFile(tracingConfigFile): { spec+: { tracingConfigFile: tracingConfigFile } },
    '#withVersion':: d.fn(help='"version of Thanos to be deployed."', args=[d.arg(name='version', type=d.T.string)]),
    withVersion(version): { spec+: { version: version } },
    '#withVolumeMounts':: d.fn(help='"volumeMounts defines how the configuration of additional VolumeMounts on the output StatefulSet definition.\\nVolumeMounts specified will be appended to other VolumeMounts in the ruler container,\\nthat are generated as a result of StorageSpec objects."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMounts(volumeMounts): { spec+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumeMountsMixin':: d.fn(help='"volumeMounts defines how the configuration of additional VolumeMounts on the output StatefulSet definition.\\nVolumeMounts specified will be appended to other VolumeMounts in the ruler container,\\nthat are generated as a result of StorageSpec objects."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMountsMixin(volumeMounts): { spec+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumes':: d.fn(help='"volumes defines how configuration of additional volumes on the output StatefulSet definition. Volumes specified will\\nbe appended to other volumes that are generated as a result of StorageSpec objects."', args=[d.arg(name='volumes', type=d.T.array)]),
    withVolumes(volumes): { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    '#withVolumesMixin':: d.fn(help='"volumes defines how configuration of additional volumes on the output StatefulSet definition. Volumes specified will\\nbe appended to other volumes that are generated as a result of StorageSpec objects."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
