{
  ...
  '#spec':: d.obj(help='"spec defines the specification of the desired behavior of the Alertmanager cluster. More info:\\nhttps://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    '#additionalArgs':: d.obj(help="\"additionalArgs allows setting additional arguments for the 'Alertmanager' container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nAlertmanager container which may cause issues if they are invalid or not supported\\nby the given Alertmanager version.\""),
    additionalArgs: {
    ...
    '#affinity':: d.obj(help="\"affinity defines the pod's scheduling constraints.\""),
    affinity: {
    ...
    alertmanagerConfigMatcherStrategy: {
      '#withType':: d.fn(help='"type defines the strategy used by\\nAlertmanagerConfig objects to match alerts in the routes and inhibition\\nrules.\\n\\nThe default value is `OnNamespace`."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { alertmanagerConfigMatcherStrategy+: { type: type } } },
    },
    '#alertmanagerConfigNamespaceSelector':: d.obj(help='"alertmanagerConfigNamespaceSelector defines the namespaces to be selected for AlertmanagerConfig discovery. If nil, only\\ncheck own namespace."'),
    ...
    '#alertmanagerConfigSelector':: d.obj(help='"alertmanagerConfigSelector defines the selector to be used for to merge and configure Alertmanager with."'),
    ...
    '#alertmanagerConfiguration':: d.obj(help='"alertmanagerConfiguration defines the configuration of Alertmanager.\\n\\nIf defined, it takes precedence over the `configSecret` field.\\n\\nThis is an *experimental feature*, it may change in any upcoming release\\nin a breaking way."'),
    alertmanagerConfiguration: {
      '#global':: d.obj(help='"global defines the global parameters of the Alertmanager configuration."'),
      global: {
        '#httpConfig':: d.obj(help='"httpConfig defines the default HTTP configuration."'),
        httpConfig: {
          '#authorization':: d.obj(help='"authorization configures the Authorization header credentials used by\\nthe client.\\n\\nCannot be set at the same time as `basicAuth`, `bearerTokenSecret` or `oauth2`."'),
          authorization: {
          ...
          '#basicAuth':: d.obj(help='"basicAuth defines the Basic Authentication credentials used by the\\nclient.\\n\\nCannot be set at the same time as `authorization`, `bearerTokenSecret` or `oauth2`."'),
          basicAuth: {
          ...
          '#tlsConfig':: d.obj(help='"tlsConfig defines the TLS configuration used by the client."'),
          tlsConfig: {
            '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
            ca: {
              '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
          ...
          withEnableHttp2(enableHttp2): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { enableHttp2: enableHttp2 } } } } },
          '#withFollowRedirects':: d.fn(help='"followRedirects defines whether the client should follow HTTP 3xx\\nredirects."', args=[d.arg(name='followRedirects', type=d.T.boolean)]),
          withFollowRedirects(followRedirects): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { followRedirects: followRedirects } } } } },
          '#withNoProxy':: d.fn(help='"noProxy defines a comma-separated string that can contain IPs, CIDR notation, domain names\\nthat should be excluded from proxying. IP and domain names can\\ncontain port numbers.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='noProxy', type=d.T.string)]),
          withNoProxy(noProxy): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { noProxy: noProxy } } } } },
          '#withProxyConnectHeader':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
          withProxyConnectHeader(proxyConnectHeader): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { proxyConnectHeader: proxyConnectHeader } } } } },
          '#withProxyConnectHeaderMixin':: d.fn(help='"proxyConnectHeader optionally specifies headers to send to\\nproxies during CONNECT requests.\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
          withProxyConnectHeaderMixin(proxyConnectHeader): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { proxyConnectHeader+: proxyConnectHeader } } } } },
          '#withProxyFromEnvironment':: d.fn(help='"proxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).\\n\\nIt requires Prometheus >= v2.43.0, Alertmanager >= v0.25.0 or Thanos >= v0.32.0."', args=[d.arg(name='proxyFromEnvironment', type=d.T.boolean)]),
          withProxyFromEnvironment(proxyFromEnvironment): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { proxyFromEnvironment: proxyFromEnvironment } } } } },
          '#withProxyUrl':: d.fn(help='"proxyUrl defines the HTTP proxy server to use."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
          withProxyUrl(proxyUrl): { spec+: { alertmanagerConfiguration+: { global+: { httpConfig+: { proxyUrl: proxyUrl } } } } },
        },
        '#jira':: d.obj(help='"jira defines the default configuration for Jira."'),
        jira: {
          '#withApiURL':: d.fn(help='"apiURL defines the default Jira API URL.\\n\\nIt requires Alertmanager >= v0.28.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { jira+: { apiURL: apiURL } } } } },
        },
        '#opsGenieApiKey':: d.obj(help='"opsGenieApiKey defines the default OpsGenie API Key."'),
        opsGenieApiKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#opsGenieApiUrl':: d.obj(help='"opsGenieApiUrl defines the default OpsGenie API URL."'),
        opsGenieApiUrl: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#rocketChat':: d.obj(help='"rocketChat defines the default configuration for Rocket Chat."'),
        rocketChat: {
          '#token':: d.obj(help='"token defines the default Rocket Chat token.\\n\\nIt requires Alertmanager >= v0.28.0."'),
          token: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { token+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { token+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { token+: { optional: optional } } } } } },
          },
          '#tokenID':: d.obj(help='"tokenID defines the default Rocket Chat Token ID.\\n\\nIt requires Alertmanager >= v0.28.0."'),
          tokenID: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { tokenID+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { tokenID+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { tokenID+: { optional: optional } } } } } },
          },
          '#withApiURL':: d.fn(help='"apiURL defines the default Rocket Chat API URL.\\n\\nIt requires Alertmanager >= v0.28.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { rocketChat+: { apiURL: apiURL } } } } },
        },
        '#slackApiUrl':: d.obj(help='"slackApiUrl defines the default Slack API URL."'),
        slackApiUrl: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#smtp':: d.obj(help='"smtp defines global SMTP parameters."'),
        smtp: {
          '#authPassword':: d.obj(help='"authPassword represents SMTP Auth using LOGIN and PLAIN."'),
          authPassword: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#authSecret':: d.obj(help='"authSecret represents SMTP Auth using CRAM-MD5."'),
          authSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#smartHost':: d.obj(help='"smartHost defines the default SMTP smarthost used for sending emails."'),
          smartHost: {
            '#withHost':: d.fn(help="\"host defines the host's address, it can be a DNS name or a literal IP address.\"", args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { smartHost+: { host: host } } } } } },
            '#withPort':: d.fn(help="\"port defines the host's port, it can be a literal port number or a port name.\"", args=[d.arg(name='port', type=d.T.string)]),
            withPort(port): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { smartHost+: { port: port } } } } } },
          },
          '#tlsConfig':: d.obj(help='"tlsConfig defines the default TLS configuration for SMTP receivers"'),
          tlsConfig: {
            '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
            ca: {
              '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
              configMap: {
                '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { configMap+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { configMap+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { configMap+: { optional: optional } } } } } } } },
              },
              '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
              secret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { secret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { secret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { ca+: { secret+: { optional: optional } } } } } } } },
              },
            },
            '#cert':: d.obj(help='"cert defines the Client certificate to present when doing client-authentication."'),
            cert: {
              ...
              configMap: {
                '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { configMap+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { configMap+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { configMap+: { optional: optional } } } } } } } },
              },
              '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
              secret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { secret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { secret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { cert+: { secret+: { optional: optional } } } } } } } },
              },
            },
            '#keySecret':: d.obj(help='"keySecret defines the Secret containing the client key file for the targets."'),
            keySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { keySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { keySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { keySecret+: { optional: optional } } } } } } },
            },
            '#withInsecureSkipVerify':: d.fn(help='"insecureSkipVerify defines how to disable target certificate validation."', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
            withInsecureSkipVerify(insecureSkipVerify): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { insecureSkipVerify: insecureSkipVerify } } } } } },
            '#withMaxVersion':: d.fn(help='"maxVersion defines the maximum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0."', args=[d.arg(name='maxVersion', type=d.T.string)]),
            withMaxVersion(maxVersion): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { maxVersion: maxVersion } } } } } },
            '#withMinVersion':: d.fn(help='"minVersion defines the minimum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.35.0 or Thanos >= v0.28.0."', args=[d.arg(name='minVersion', type=d.T.string)]),
            withMinVersion(minVersion): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { minVersion: minVersion } } } } } },
            '#withServerName':: d.fn(help='"serverName is used to verify the hostname for the targets."', args=[d.arg(name='serverName', type=d.T.string)]),
            withServerName(serverName): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { tlsConfig+: { serverName: serverName } } } } } },
          },
          '#withAuthIdentity':: d.fn(help='"authIdentity represents SMTP Auth using PLAIN"', args=[d.arg(name='authIdentity', type=d.T.string)]),
          withAuthIdentity(authIdentity): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { authIdentity: authIdentity } } } } },
          '#withAuthUsername':: d.fn(help="\"authUsername represents SMTP Auth using CRAM-MD5, LOGIN and PLAIN. If empty, Alertmanager doesn't authenticate to the SMTP server.\"", args=[d.arg(name='authUsername', type=d.T.string)]),
          withAuthUsername(authUsername): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { authUsername: authUsername } } } } },
          '#withFrom':: d.fn(help='"from defines the default SMTP From header field."', args=[d.arg(name='from', type=d.T.string)]),
          withFrom(from): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { from: from } } } } },
          '#withHello':: d.fn(help='"hello defines the default hostname to identify to the SMTP server."', args=[d.arg(name='hello', type=d.T.string)]),
          withHello(hello): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { hello: hello } } } } },
          '#withRequireTLS':: d.fn(help='"requireTLS defines the default SMTP TLS requirement.\\nNote that Go does not support unencrypted connections to remote SMTP endpoints."', args=[d.arg(name='requireTLS', type=d.T.boolean)]),
          withRequireTLS(requireTLS): { spec+: { alertmanagerConfiguration+: { global+: { smtp+: { requireTLS: requireTLS } } } } },
        },
        '#telegram':: d.obj(help='"telegram defines the default Telegram config"'),
        telegram: {
          '#withApiURL':: d.fn(help='"apiURL defines he default Telegram API URL.\\n\\nIt requires Alertmanager >= v0.24.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { telegram+: { apiURL: apiURL } } } } },
        },
        '#victorops':: d.obj(help='"victorops defines the default configuration for VictorOps."'),
        victorops: {
          '#apiKey':: d.obj(help='"apiKey defines the default VictorOps API Key."'),
          apiKey: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { victorops+: { apiKey+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { alertmanagerConfiguration+: { global+: { victorops+: { apiKey+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { victorops+: { apiKey+: { optional: optional } } } } } },
          },
          '#withApiURL':: d.fn(help='"apiURL defines the default VictorOps API URL."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { victorops+: { apiURL: apiURL } } } } },
        },
        '#webex':: d.obj(help='"webex defines the default configuration for Jira."'),
        webex: {
          '#withApiURL':: d.fn(help='"apiURL defines the is the default Webex API URL.\\n\\nIt requires Alertmanager >= v0.25.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { webex+: { apiURL: apiURL } } } } },
        },
        '#wechat':: d.obj(help='"wechat defines the default WeChat Config"'),
        wechat: {
          '#apiSecret':: d.obj(help='"apiSecret defines the default WeChat API Secret."'),
          apiSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { alertmanagerConfiguration+: { global+: { wechat+: { apiSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { alertmanagerConfiguration+: { global+: { wechat+: { apiSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { alertmanagerConfiguration+: { global+: { wechat+: { apiSecret+: { optional: optional } } } } } },
          },
          '#withApiCorpID':: d.fn(help='"apiCorpID defines the default WeChat API Corporate ID."', args=[d.arg(name='apiCorpID', type=d.T.string)]),
          withApiCorpID(apiCorpID): { spec+: { alertmanagerConfiguration+: { global+: { wechat+: { apiCorpID: apiCorpID } } } } },
          '#withApiURL':: d.fn(help='"apiURL defines he default WeChat API URL.\\nThe default value is \\"https://qyapi.weixin.qq.com/cgi-bin/\\', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { wechat+: { apiURL: apiURL } } } } },
        },
        '#withPagerdutyUrl':: d.fn(help='"pagerdutyUrl defines the default Pagerduty URL."', args=[d.arg(name='pagerdutyUrl', type=d.T.string)]),
        withPagerdutyUrl(pagerdutyUrl): { spec+: { alertmanagerConfiguration+: { global+: { pagerdutyUrl: pagerdutyUrl } } } },
        '#withResolveTimeout':: d.fn(help='"resolveTimeout defines the default value used by alertmanager if the alert does\\nnot include EndsAt, after this time passes it can declare the alert as resolved if it has not been updated.\\nThis has no impact on alerts from Prometheus, as they always include EndsAt."', args=[d.arg(name='resolveTimeout', type=d.T.string)]),
        withResolveTimeout(resolveTimeout): { spec+: { alertmanagerConfiguration+: { global+: { resolveTimeout: resolveTimeout } } } },
      },
      '#templates':: d.obj(help='"templates defines the custom notification templates."'),
      templates: {
        '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
        configMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"name defines the name of the AlertmanagerConfig custom resource which is used to generate the Alertmanager configuration.\\nIt must be defined in the same namespace as the Alertmanager object.\\nThe operator will not enforce a `namespace` label for routes and inhibition rules."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { alertmanagerConfiguration+: { name: name } } },
      '#withTemplates':: d.fn(help='"templates defines the custom notification templates."', args=[d.arg(name='templates', type=d.T.array)]),
    ...
    '#clusterTLS':: d.obj(help="\"clusterTLS defines the mutual TLS configuration for the Alertmanager cluster's gossip protocol.\\n\\nIt requires Alertmanager \u003e= 0.24.0.\""),
    clusterTLS: {
      '#client':: d.obj(help='"client defines the client-side configuration for mutual TLS."'),
      client: {
        '#ca':: d.obj(help='"ca defines the Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"configMap defines the ConfigMap containing data to use for the targets."'),
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { client+: { ca+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { client+: { ca+: { configMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { client+: { ca+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { client+: { ca+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { client+: { ca+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { client+: { ca+: { secret+: { optional: optional } } } } } },
          },
        },
        '#cert':: d.obj(help='"cert defines the Client certificate to present when doing client-authentication."'),
        cert: {
          ...
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { client+: { cert+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { client+: { cert+: { configMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { client+: { cert+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { client+: { cert+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { client+: { cert+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { client+: { cert+: { secret+: { optional: optional } } } } } },
          },
        },
        '#keySecret':: d.obj(help='"keySecret defines the Secret containing the client key file for the targets."'),
        keySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { clusterTLS+: { client+: { keySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { clusterTLS+: { client+: { keySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { clusterTLS+: { client+: { keySecret+: { optional: optional } } } } },
        },
        '#withInsecureSkipVerify':: d.fn(help='"insecureSkipVerify defines how to disable target certificate validation."', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { spec+: { clusterTLS+: { client+: { insecureSkipVerify: insecureSkipVerify } } } },
        '#withMaxVersion':: d.fn(help='"maxVersion defines the maximum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.41.0 or Thanos >= v0.31.0."', args=[d.arg(name='maxVersion', type=d.T.string)]),
        withMaxVersion(maxVersion): { spec+: { clusterTLS+: { client+: { maxVersion: maxVersion } } } },
        '#withMinVersion':: d.fn(help='"minVersion defines the minimum acceptable TLS version.\\n\\nIt requires Prometheus >= v2.35.0 or Thanos >= v0.28.0."', args=[d.arg(name='minVersion', type=d.T.string)]),
        withMinVersion(minVersion): { spec+: { clusterTLS+: { client+: { minVersion: minVersion } } } },
        '#withServerName':: d.fn(help='"serverName is used to verify the hostname for the targets."', args=[d.arg(name='serverName', type=d.T.string)]),
        withServerName(serverName): { spec+: { clusterTLS+: { client+: { serverName: serverName } } } },
      },
      '#server':: d.obj(help='"server defines the server-side configuration for mutual TLS."'),
      server: {
        ...
        cert: {
          ...
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { server+: { cert+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { server+: { cert+: { configMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { server+: { cert+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { server+: { cert+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { server+: { cert+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { server+: { cert+: { secret+: { optional: optional } } } } } },
          },
        },
        ...
        client_ca: {
          ...
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { server+: { client_ca+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { server+: { client_ca+: { configMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { server+: { client_ca+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"secret defines the Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { clusterTLS+: { server+: { client_ca+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { clusterTLS+: { server+: { client_ca+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { clusterTLS+: { server+: { client_ca+: { secret+: { optional: optional } } } } } },
          },
        },
        ...
        keySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { clusterTLS+: { server+: { keySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { clusterTLS+: { server+: { keySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { clusterTLS+: { server+: { keySecret+: { optional: optional } } } } },
        },
        ...
        withCertFile(certFile): { spec+: { clusterTLS+: { server+: { certFile: certFile } } } },
        ...
        withCipherSuites(cipherSuites): { spec+: { clusterTLS+: { server+: { cipherSuites: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        ...
        withCipherSuitesMixin(cipherSuites): { spec+: { clusterTLS+: { server+: { cipherSuites+: if std.isArray(v=cipherSuites) then cipherSuites else [cipherSuites] } } } },
        ...
        withClientAuthType(clientAuthType): { spec+: { clusterTLS+: { server+: { clientAuthType: clientAuthType } } } },
        ...
        withClientCAFile(clientCAFile): { spec+: { clusterTLS+: { server+: { clientCAFile: clientCAFile } } } },
        ...
        withCurvePreferences(curvePreferences): { spec+: { clusterTLS+: { server+: { curvePreferences: if std.isArray(v=curvePreferences) then curvePreferences else [curvePreferences] } } } },
        ...
        withCurvePreferencesMixin(curvePreferences): { spec+: { clusterTLS+: { server+: { curvePreferences+: if std.isArray(v=curvePreferences) then curvePreferences else [curvePreferences] } } } },
        ...
        withKeyFile(keyFile): { spec+: { clusterTLS+: { server+: { keyFile: keyFile } } } },
        ...
        withMaxVersion(maxVersion): { spec+: { clusterTLS+: { server+: { maxVersion: maxVersion } } } },
        ...
        withMinVersion(minVersion): { spec+: { clusterTLS+: { server+: { minVersion: minVersion } } } },
        ...
        withPreferServerCipherSuites(preferServerCipherSuites): { spec+: { clusterTLS+: { server+: { preferServerCipherSuites: preferServerCipherSuites } } } },
      },
    },
    ...
    '#hostAliases':: d.obj(help='"hostAliases Pods configuration"'),
    hostAliases: {
    ...
    '#limits':: d.obj(help='"limits defines the limits command line flags when starting Alertmanager."'),
    limits: {
      '#withMaxPerSilenceBytes':: d.fn(help="\"maxPerSilenceBytes defines the maximum size of an individual silence as stored on disk. This corresponds to the Alertmanager's\\n`--silences.max-per-silence-bytes` flag.\\nIt requires Alertmanager \u003e= v0.28.0.\"", args=[d.arg(name='maxPerSilenceBytes', type=d.T.string)]),
      withMaxPerSilenceBytes(maxPerSilenceBytes): { spec+: { limits+: { maxPerSilenceBytes: maxPerSilenceBytes } } },
      '#withMaxSilences':: d.fn(help="\"maxSilences defines the maximum number active and pending silences. This corresponds to the\\nAlertmanager's `--silences.max-silences` flag.\\nIt requires Alertmanager \u003e= v0.28.0.\"", args=[d.arg(name='maxSilences', type=d.T.integer)]),
      withMaxSilences(maxSilences): { spec+: { limits+: { maxSilences: maxSilences } } },
    },
    '#persistentVolumeClaimRetentionPolicy':: d.obj(help='"persistentVolumeClaimRetentionPolicy controls if and how PVCs are deleted during the lifecycle of a StatefulSet.\\nThe default behavior is all PVCs are retained.\\nThis is an alpha field from kubernetes 1.23 until 1.26 and a beta field from 1.26.\\nIt requires enabling the StatefulSetAutoDeletePVC feature gate."'),
    ...
    '#resources':: d.obj(help='"resources defines the resource requests and limits of the Pods."'),
    resources: {
      '#claims':: d.obj(help='"Claims lists the names of resources, defined in spec.resourceClaims,\\nthat are used by this container.\\n\\nThis field depends on the\\nDynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."'),
      claims: {
        '#withName':: d.fn(help='"Name must match the name of one entry in pod.spec.resourceClaims of\\nthe Pod where this field is used. It makes that resource available\\ninside a container."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#storage':: d.obj(help='"storage defines the definition of how storage will be used by the Alertmanager\\ninstances."'),
    storage: {
    ...
    '#tolerations':: d.obj(help="\"tolerations defines the pod's tolerations.\""),
    tolerations: {
    ...
    '#web':: d.obj(help='"web defines the web command line flags when starting Alertmanager."'),
    web: {
      ...
      '#withGetConcurrency':: d.fn(help="\"getConcurrency defines the maximum number of GET requests processed concurrently. This corresponds to the\\nAlertmanager's `--web.get-concurrency` flag.\"", args=[d.arg(name='getConcurrency', type=d.T.integer)]),
    ...
    '#withAdditionalArgs':: d.fn(help="\"additionalArgs allows setting additional arguments for the 'Alertmanager' container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nAlertmanager container which may cause issues if they are invalid or not supported\\nby the given Alertmanager version.\"", args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withAdditionalArgsMixin':: d.fn(help="\"additionalArgs allows setting additional arguments for the 'Alertmanager' container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nAlertmanager container which may cause issues if they are invalid or not supported\\nby the given Alertmanager version.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withEnableFeatures':: d.fn(help="\"enableFeatures defines the Alertmanager's feature flags. By default, no features are enabled.\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nIt requires Alertmanager \u003e= 0.27.0.\"", args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withEnableFeaturesMixin':: d.fn(help="\"enableFeatures defines the Alertmanager's feature flags. By default, no features are enabled.\\nEnabling features which are disabled by default is entirely outside the\\nscope of what the maintainers will support and by doing so, you accept\\nthat this behaviour may break at any time without notice.\\n\\nIt requires Alertmanager \u003e= 0.27.0.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='enableFeatures', type=d.T.array)]),
    ...
    '#withExternalUrl':: d.fn(help='"externalUrl defines the URL used to access the Alertmanager web service. This is\\nnecessary to generate correct URLs. This is necessary if Alertmanager is not\\nserved from root of a DNS name."', args=[d.arg(name='externalUrl', type=d.T.string)]),
    ...
    '#withListenLocal':: d.fn(help='"listenLocal defines the Alertmanager server listen on loopback, so that it\\ndoes not bind against the Pod IP. Note this is only for the Alertmanager\\nUI, not the gossip communication."', args=[d.arg(name='listenLocal', type=d.T.boolean)]),
    withListenLocal(listenLocal): { spec+: { listenLocal: listenLocal } },
    '#withLogFormat':: d.fn(help='"logFormat for Alertmanager to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    withLogFormat(logFormat): { spec+: { logFormat: logFormat } },
    '#withLogLevel':: d.fn(help='"logLevel for Alertmanager to be configured with."', args=[d.arg(name='logLevel', type=d.T.string)]),
    ...
    '#withPortName':: d.fn(help="\"portName defines the port's name for the pods and governing service.\\nDefaults to `web`.\"", args=[d.arg(name='portName', type=d.T.string)]),
