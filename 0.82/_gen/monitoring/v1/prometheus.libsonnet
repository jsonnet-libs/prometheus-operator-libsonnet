{
  ...
  spec: {
    ...
    '#withNameValidationScheme':: d.fn(help='"Specifies the validation scheme for metric and label names."', args=[d.arg(name='nameValidationScheme', type=d.T.string)]),
