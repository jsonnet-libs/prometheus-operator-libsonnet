  ...
  spec: {
    ...
    web: {
      ...
      tlsConfig: {
        ...
        '#withCertFile':: d.fn(help='"Path to the TLS certificate file in the Prometheus container for the server.\\nMutually exclusive with `cert`."', args=[d.arg(name='certFile', type=d.T.string)]),
        ...
        '#withClientCAFile':: d.fn(help='"Path to the CA certificate file for client certificate authentication to the server.\\nMutually exclusive with `client_ca`."', args=[d.arg(name='clientCAFile', type=d.T.string)]),
        ...
        '#withKeyFile':: d.fn(help='"Path to the TLS key file in the Prometheus container for the server.\\nMutually exclusive with `keySecret`."', args=[d.arg(name='keyFile', type=d.T.string)]),
