{
  ...
  spec: {
    ...
    consulSDConfigs: {
      ...
      '#withNoProxy':: d.fn(help='"Comma-separated string that can contain IPs, CIDR notation, domain names that should be excluded from proxying. IP and domain names can contain port numbers."', args=[d.arg(name='noProxy', type=d.T.string)]),
      ...
      '#withProxyConnectHeader':: d.fn(help='"Specifies headers to send to proxies during CONNECT requests."', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      withProxyConnectHeader(proxyConnectHeader): { proxyConnectHeader: proxyConnectHeader },
      '#withProxyConnectHeaderMixin':: d.fn(help='"Specifies headers to send to proxies during CONNECT requests."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='proxyConnectHeader', type=d.T.object)]),
      withProxyConnectHeaderMixin(proxyConnectHeader): { proxyConnectHeader+: proxyConnectHeader },
      '#withProxyFromEnvironment':: d.fn(help='"Use proxy URL indicated by environment variables (HTTP_PROXY, https_proxy, HTTPs_PROXY, https_proxy, and no_proxy) If unset, Prometheus uses its default value."', args=[d.arg(name='proxyFromEnvironment', type=d.T.boolean)]),
