  ...
  spec: {
    ...
    inhibitRules: {
      ...
      sourceMatch: {
        ...
        '#withRegex':: d.fn(help='"Whether to match on equality (false) or regular-expression (true). Deprecated as of AlertManager >= v0.22.0 where a user should use MatchType instead."', args=[d.arg(name='regex', type=d.T.boolean)]),
