    ...
    receivers: {
      ...
      discordConfigs: {
        ...
        httpConfig: {
          ...
          '#withProxyURL':: d.fn(help='"Optional proxy URL.\\n\\nIf defined, this field takes precedence over `proxyUrl`."', args=[d.arg(name='proxyURL', type=d.T.string)]),
          withProxyURL(proxyURL): { httpConfig+: { proxyURL: proxyURL } },
          '#withProxyUrl':: d.fn(help='"`proxyURL` defines the HTTP proxy server to use."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
          withProxyUrl(proxyUrl): { httpConfig+: { proxyUrl: proxyUrl } },
        },
        '#withAvatarURL':: d.fn(help='"The avatar url of the message sender."', args=[d.arg(name='avatarURL', type=d.T.string)]),
        withAvatarURL(avatarURL): { avatarURL: avatarURL },
        '#withContent':: d.fn(help="\"The template of the content's body.\"", args=[d.arg(name='content', type=d.T.string)]),
        ...
        '#withUsername':: d.fn(help='"The username of the message sender."', args=[d.arg(name='username', type=d.T.string)]),
      ...
      '#msteamsv2Configs':: d.obj(help='"List of MSTeamsV2 configurations.\\nIt requires Alertmanager >= 0.28.0."'),
      msteamsv2Configs: {
        '#httpConfig':: d.obj(help='"HTTP client configuration."'),
        httpConfig: {
          '#authorization':: d.obj(help='"Authorization header configuration for the client.\\nThis is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+."'),
        ...
        '#webhookURL':: d.obj(help='"MSTeams incoming webhook URL."'),
        webhookURL: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { webhookURL+: { key: key } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#rocketchatConfigs':: d.obj(help='"List of RocketChat configurations.\\nIt requires Alertmanager >= 0.28.0."'),
      rocketchatConfigs: {
        '#actions':: d.obj(help='"Actions to include in the message."'),
        actions: {
          '#withMsg':: d.fn(help='"The message to send when the button is clicked."', args=[d.arg(name='msg', type=d.T.string)]),
          withMsg(msg): { msg: msg },
          '#withText':: d.fn(help='"The button text."', args=[d.arg(name='text', type=d.T.string)]),
          withText(text): { text: text },
          '#withUrl':: d.fn(help='"The URL the button links to."', args=[d.arg(name='url', type=d.T.string)]),
          withUrl(url): { url: url },
        },
        '#fields':: d.obj(help='"Additional fields for the message."'),
        fields: {
          '#withShort':: d.fn(help='"Whether this field should be a short field."', args=[d.arg(name='short', type=d.T.boolean)]),
          withShort(short): { short: short },
          '#withTitle':: d.fn(help='"The title of this field."', args=[d.arg(name='title', type=d.T.string)]),
          withTitle(title): { title: title },
          '#withValue':: d.fn(help='"The value of this field, displayed underneath the title value."', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { value: value },
        },
        '#httpConfig':: d.obj(help='"HTTP client configuration."'),
        httpConfig: {
        ...
        '#token':: d.obj(help='"The sender token."'),
        token: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { token+: { key: key } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#tokenID':: d.obj(help='"The sender token ID."'),
        tokenID: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withActions':: d.fn(help='"Actions to include in the message."', args=[d.arg(name='actions', type=d.T.array)]),
        withActions(actions): { actions: if std.isArray(v=actions) then actions else [actions] },
        '#withActionsMixin':: d.fn(help='"Actions to include in the message."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='actions', type=d.T.array)]),
        withActionsMixin(actions): { actions+: if std.isArray(v=actions) then actions else [actions] },
        '#withApiURL':: d.fn(help='"The API URL for RocketChat.\\nDefaults to https://open.rocket.chat/ if not specified."', args=[d.arg(name='apiURL', type=d.T.string)]),
        withApiURL(apiURL): { apiURL: apiURL },
        '#withChannel':: d.fn(help='"The channel to send alerts to."', args=[d.arg(name='channel', type=d.T.string)]),
        withChannel(channel): { channel: channel },
        '#withColor':: d.fn(help='"The message color."', args=[d.arg(name='color', type=d.T.string)]),
        withColor(color): { color: color },
        '#withEmoji':: d.fn(help='"If provided, the avatar will be displayed as an emoji."', args=[d.arg(name='emoji', type=d.T.string)]),
        withEmoji(emoji): { emoji: emoji },
        '#withFields':: d.fn(help='"Additional fields for the message."', args=[d.arg(name='fields', type=d.T.array)]),
        withFields(fields): { fields: if std.isArray(v=fields) then fields else [fields] },
        '#withFieldsMixin':: d.fn(help='"Additional fields for the message."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fields', type=d.T.array)]),
        withFieldsMixin(fields): { fields+: if std.isArray(v=fields) then fields else [fields] },
        '#withIconURL':: d.fn(help='"Icon URL for the message."', args=[d.arg(name='iconURL', type=d.T.string)]),
        withIconURL(iconURL): { iconURL: iconURL },
        '#withImageURL':: d.fn(help='"Image URL for the message."', args=[d.arg(name='imageURL', type=d.T.string)]),
        withImageURL(imageURL): { imageURL: imageURL },
        '#withLinkNames':: d.fn(help='"Whether to enable link names."', args=[d.arg(name='linkNames', type=d.T.boolean)]),
        withLinkNames(linkNames): { linkNames: linkNames },
        '#withSendResolved':: d.fn(help='"Whether to notify about resolved alerts."', args=[d.arg(name='sendResolved', type=d.T.boolean)]),
        withSendResolved(sendResolved): { sendResolved: sendResolved },
        '#withShortFields':: d.fn(help='"Whether to use short fields."', args=[d.arg(name='shortFields', type=d.T.boolean)]),
        withShortFields(shortFields): { shortFields: shortFields },
        '#withText':: d.fn(help='"The message text to send, it is optional because of attachments."', args=[d.arg(name='text', type=d.T.string)]),
        withText(text): { text: text },
        '#withThumbURL':: d.fn(help='"Thumbnail URL for the message."', args=[d.arg(name='thumbURL', type=d.T.string)]),
        withThumbURL(thumbURL): { thumbURL: thumbURL },
        '#withTitle':: d.fn(help='"The message title."', args=[d.arg(name='title', type=d.T.string)]),
        withTitle(title): { title: title },
        '#withTitleLink':: d.fn(help='"The title link for the message."', args=[d.arg(name='titleLink', type=d.T.string)]),
