  ...
  spec: {
    ...
    alertmanagerConfiguration: {
      ...
      global: {
        ...
        '#jira':: d.obj(help='"The default configuration for Jira."'),
        jira: {
          '#withApiURL':: d.fn(help='"The default Jira API URL.\\n\\nIt requires Alertmanager >= v0.28.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
        ...
        '#rocketChat':: d.obj(help='"The default configuration for Rocket Chat."'),
        rocketChat: {
          '#token':: d.obj(help='"The default Rocket Chat token.\\n\\nIt requires Alertmanager >= v0.28.0."'),
          token: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#tokenID':: d.obj(help='"The default Rocket Chat Token ID.\\n\\nIt requires Alertmanager >= v0.28.0."'),
          tokenID: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#withApiURL':: d.fn(help='"The default Rocket Chat API URL.\\n\\nIt requires Alertmanager >= v0.28.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
        ...
        smtp: {
          ...
          '#tlsConfig':: d.obj(help='"The default TLS configuration for SMTP receivers"'),
          tlsConfig: {
            '#ca':: d.obj(help='"Certificate authority used when verifying server certificates."'),
            ca: {
              '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
        ...
        '#telegram':: d.obj(help='"The default Telegram config"'),
        telegram: {
          '#withApiURL':: d.fn(help='"The default Telegram API URL.\\n\\nIt requires Alertmanager >= v0.24.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { telegram+: { apiURL: apiURL } } } } },
        },
        '#victorops':: d.obj(help='"The default configuration for VictorOps."'),
        victorops: {
          '#apiKey':: d.obj(help='"The default VictorOps API Key."'),
          apiKey: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#withApiURL':: d.fn(help='"The default VictorOps API URL."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { victorops+: { apiURL: apiURL } } } } },
        },
        '#webex':: d.obj(help='"The default configuration for Jira."'),
        webex: {
          '#withApiURL':: d.fn(help='"The default Webex API URL.\\n\\nIt requires Alertmanager >= v0.25.0."', args=[d.arg(name='apiURL', type=d.T.string)]),
          withApiURL(apiURL): { spec+: { alertmanagerConfiguration+: { global+: { webex+: { apiURL: apiURL } } } } },
        },
        '#wechat':: d.obj(help='"The default WeChat Config"'),
        wechat: {
          '#apiSecret':: d.obj(help='"The default WeChat API Secret."'),
          apiSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#clusterTLS':: d.obj(help="\"Configures the mutual TLS configuration for the Alertmanager cluster's gossip protocol.\\n\\nIt requires Alertmanager \u003e= 0.24.0.\""),
    clusterTLS: {
      '#client':: d.obj(help='"Client-side configuration for mutual TLS."'),
      client: {
        '#ca':: d.obj(help='"Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
      ...
      '#server':: d.obj(help='"Server-side configuration for mutual TLS."'),
      server: {
