{
  ...
  spec: {
    ...
    '#excludedFromEnforcement':: d.obj(help='"List of references to PrometheusRule objects\\nto be excluded from enforcing a namespace label of origin.\\nApplies only if enforcedNamespaceLabel set to true."'),
    ...
    '#grpcServerTlsConfig':: d.obj(help="\"GRPCServerTLSConfig configures the gRPC server from which Thanos Querier reads\\nrecorded rule data.\\nNote: Currently only the CAFile, CertFile, and KeyFile fields are supported.\\nMaps to the '--grpc-server-tls-*' CLI args.\""),
    grpcServerTlsConfig: {
    ...
    '#prometheusRulesExcludedFromEnforce':: d.obj(help='"PrometheusRulesExcludedFromEnforce - list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."'),
    ...
    '#ruleNamespaceSelector':: d.obj(help='"Namespaces to be selected for Rules discovery. If unspecified, only\\nthe same namespace as the ThanosRuler object is in is used."'),
    ...
    '#volumes':: d.obj(help='"Volumes allows configuration of additional volumes on the output StatefulSet definition. Volumes specified will\\nbe appended to other volumes that are generated as a result of StorageSpec objects."'),
    volumes: {
    ...
    '#web':: d.obj(help='"Defines the configuration of the ThanosRuler web server."'),
    web: {
    ...
    '#withAdditionalArgs':: d.fn(help='"AdditionalArgs allows setting additional arguments for the ThanosRuler container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nThanosRuler container which may cause issues if they are invalid or not supported\\nby the given ThanosRuler version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument the reconciliation will\\nfail and an error will be logged."', args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withAdditionalArgsMixin':: d.fn(help='"AdditionalArgs allows setting additional arguments for the ThanosRuler container.\\nIt is intended for e.g. activating hidden flags which are not supported by\\nthe dedicated configuration options yet. The arguments are passed as-is to the\\nThanosRuler container which may cause issues if they are invalid or not supported\\nby the given ThanosRuler version.\\nIn case of an argument conflict (e.g. an argument which is already set by the\\noperator itself) or when providing an invalid argument the reconciliation will\\nfail and an error will be logged."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withEvaluationInterval':: d.fn(help='"Interval between consecutive evaluations."', args=[d.arg(name='evaluationInterval', type=d.T.string)]),
    ...
    '#withExternalPrefix':: d.fn(help='"The external URL the Thanos Ruler instances will be available under. This is\\nnecessary to generate correct URLs. This is necessary if Thanos Ruler is not\\nserved from root of a DNS name."', args=[d.arg(name='externalPrefix', type=d.T.string)]),
    ...
    '#withImage':: d.fn(help='"Thanos container image URL."', args=[d.arg(name='image', type=d.T.string)]),
    withImage(image): { spec+: { image: image } },
    '#withImagePullPolicy':: d.fn(help="\"Image pull policy for the 'thanos', 'init-config-reloader' and 'config-reloader' containers.\\nSee https://kubernetes.io/docs/concepts/containers/images/#image-pull-policy for more details.\"", args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
    ...
    '#withLabels':: d.fn(help="\"Configures the external label pairs of the ThanosRuler resource.\\n\\nA default replica label `thanos_ruler_replica` will be always added as a\\nlabel with the value of the pod's name.\"", args=[d.arg(name='labels', type=d.T.object)]),
    withLabels(labels): { spec+: { labels: labels } },
    '#withLabelsMixin':: d.fn(help="\"Configures the external label pairs of the ThanosRuler resource.\\n\\nA default replica label `thanos_ruler_replica` will be always added as a\\nlabel with the value of the pod's name.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='labels', type=d.T.object)]),
    withLabelsMixin(labels): { spec+: { labels+: labels } },
    '#withListenLocal':: d.fn(help='"ListenLocal makes the Thanos ruler listen on loopback, so that it\\ndoes not bind against the Pod IP."', args=[d.arg(name='listenLocal', type=d.T.boolean)]),
    withListenLocal(listenLocal): { spec+: { listenLocal: listenLocal } },
    '#withLogFormat':: d.fn(help='"Log format for ThanosRuler to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    withLogFormat(logFormat): { spec+: { logFormat: logFormat } },
    '#withLogLevel':: d.fn(help='"Log level for ThanosRuler to be configured with."', args=[d.arg(name='logLevel', type=d.T.string)]),
    ...
    '#withPrometheusRulesExcludedFromEnforce':: d.fn(help='"PrometheusRulesExcludedFromEnforce - list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."', args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withPrometheusRulesExcludedFromEnforceMixin':: d.fn(help='"PrometheusRulesExcludedFromEnforce - list of Prometheus rules to be excluded from enforcing\\nof adding namespace labels. Works only if enforcedNamespaceLabel set to true.\\nMake sure both ruleNamespace and ruleName are set for each pair\\nDeprecated: use excludedFromEnforcement instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withRemoteWrite':: d.fn(help="\"Defines the list of remote write configurations.\\n\\nWhen the list isn't empty, the ruler is configured with stateless mode.\\n\\nIt requires Thanos \u003e= 0.24.0.\"", args=[d.arg(name='remoteWrite', type=d.T.array)]),
    ...
    '#withReplicas':: d.fn(help='"Number of thanos ruler instances to deploy."', args=[d.arg(name='replicas', type=d.T.integer)]),
