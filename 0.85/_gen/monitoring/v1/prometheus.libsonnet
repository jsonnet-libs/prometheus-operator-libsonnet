{
  ...
  spec: {
    ...
    alerting: {
      '#alertmanagers':: d.obj(help='"Alertmanager endpoints where Prometheus should send alerts to."'),
      alertmanagers: {
        '#alertRelabelings':: d.obj(help='"Relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."'),
        alertRelabelings: {
        ...
        '#relabelings':: d.obj(help='"Relabel configuration applied to the discovered Alertmanagers."'),
        relabelings: {
          '#withAction':: d.fn(help='"Action to perform based on the regex matching.\\n\\n`Uppercase` and `Lowercase` actions require Prometheus >= v2.36.0.\\n`DropEqual` and `KeepEqual` actions require Prometheus >= v2.41.0.\\n\\nDefault: \\"Replace\\', args=[d.arg(name='action', type=d.T.string)]),
          withAction(action): { action: action },
          '#withModulus':: d.fn(help='"Modulus to take of the hash of the source label values.\\n\\nOnly applicable when the action is `HashMod`."', args=[d.arg(name='modulus', type=d.T.integer)]),
        ...
        '#withAlertRelabelings':: d.fn(help='"Relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."', args=[d.arg(name='alertRelabelings', type=d.T.array)]),
        ...
        '#withAlertRelabelingsMixin':: d.fn(help='"Relabeling configs applied before sending alerts to a specific Alertmanager.\\nIt requires Prometheus >= v2.51.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='alertRelabelings', type=d.T.array)]),
        ...
        '#withRelabelings':: d.fn(help='"Relabel configuration applied to the discovered Alertmanagers."', args=[d.arg(name='relabelings', type=d.T.array)]),
        withRelabelings(relabelings): { relabelings: if std.isArray(v=relabelings) then relabelings else [relabelings] },
        '#withRelabelingsMixin':: d.fn(help='"Relabel configuration applied to the discovered Alertmanagers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='relabelings', type=d.T.array)]),
      ...
      '#withAlertmanagers':: d.fn(help='"Alertmanager endpoints where Prometheus should send alerts to."', args=[d.arg(name='alertmanagers', type=d.T.array)]),
    ...
    '#dnsConfig':: d.obj(help='"Defines the DNS configuration for the pods."'),
    dnsConfig: {
    ...
    '#otlp':: d.obj(help='"Settings related to the OTLP receiver feature.\\nIt requires Prometheus >= v2.55.0."'),
    otlp: {
      '#withConvertHistogramsToNHCB':: d.fn(help='"Configures optional translation of OTLP explicit bucket histograms into native histograms with custom buckets.\\nIt requires Prometheus >= v3.4.0."', args=[d.arg(name='convertHistogramsToNHCB', type=d.T.boolean)]),
      withConvertHistogramsToNHCB(convertHistogramsToNHCB): { spec+: { otlp+: { convertHistogramsToNHCB: convertHistogramsToNHCB } } },
      '#withIgnoreResourceAttributes':: d.fn(help='"List of OpenTelemetry resource attributes to ignore when `promoteAllResourceAttributes` is true.\\n\\nIt requires `promoteAllResourceAttributes` to be true.\\nIt requires Prometheus >= v3.5.0."', args=[d.arg(name='ignoreResourceAttributes', type=d.T.array)]),
      ...
      '#withIgnoreResourceAttributesMixin':: d.fn(help='"List of OpenTelemetry resource attributes to ignore when `promoteAllResourceAttributes` is true.\\n\\nIt requires `promoteAllResourceAttributes` to be true.\\nIt requires Prometheus >= v3.5.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ignoreResourceAttributes', type=d.T.array)]),
      ...
      '#withPromoteResourceAttributes':: d.fn(help='"List of OpenTelemetry Attributes that should be promoted to metric labels, defaults to none.\\nCannot be defined when `promoteAllResourceAttributes` is true."', args=[d.arg(name='promoteResourceAttributes', type=d.T.array)]),
      ...
      '#withTranslationStrategy':: d.fn(help='"Configures how the OTLP receiver endpoint translates the incoming metrics.\\n\\nIt requires Prometheus >= v3.0.0."', args=[d.arg(name='translationStrategy', type=d.T.string)]),
    ...
    remoteWrite: {
      ...
      metadataConfig: {
        '#withMaxSamplesPerSend':: d.fn(help='"MaxSamplesPerSend is the maximum number of metadata samples per send.\\n\\nIt requires Prometheus >= v2.29.0."', args=[d.arg(name='maxSamplesPerSend', type=d.T.integer)]),
    ...
    '#ruleNamespaceSelector':: d.obj(help='"Namespaces to match for PrometheusRule discovery. An empty label selector\\nmatches all namespaces. A null label selector matches the current\\nnamespace only."'),
    ...
    '#ruleSelector':: d.obj(help='"PrometheusRule objects to be selected for rule evaluation. An empty\\nlabel selector matches all objects. A null label selector matches no\\nobjects."'),
    ruleSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    rules: {
      ...
      alert: {
        ...
        '#withForOutageTolerance':: d.fn(help="\"Max time to tolerate prometheus outage for restoring 'for' state of\\nalert.\"", args=[d.arg(name='forOutageTolerance', type=d.T.string)]),
        withForOutageTolerance(forOutageTolerance): { spec+: { rules+: { alert+: { forOutageTolerance: forOutageTolerance } } } },
        '#withResendDelay':: d.fn(help='"Minimum amount of time to wait before resending an alert to\\nAlertmanager."', args=[d.arg(name='resendDelay', type=d.T.string)]),
        withResendDelay(resendDelay): { spec+: { rules+: { alert+: { resendDelay: resendDelay } } } },
      },
    },
    '#runtime':: d.obj(help='"RuntimeConfig configures the values for the Prometheus process behavior"'),
    runtime: {
      '#withGoGC':: d.fn(help='"The Go garbage collection target percentage. Lowering this number may increase the CPU usage.\\nSee: https://tip.golang.org/doc/gc-guide#GOGC"', args=[d.arg(name='goGC', type=d.T.integer)]),
    ...
    thanos: {
      ...
      '#withReadyTimeout':: d.fn(help='"ReadyTimeout is the maximum time that the Thanos sidecar will wait for\\nPrometheus to start."', args=[d.arg(name='readyTimeout', type=d.T.string)]),
    ...
    web: {
      ...
      tlsConfig: {
        '#cert':: d.obj(help='"Secret or ConfigMap containing the TLS certificate for the web server.\\n\\nEither `keySecret` or `keyFile` must be defined.\\n\\nIt is mutually exclusive with `certFile`."'),
        cert: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#client_ca':: d.obj(help='"Secret or ConfigMap containing the CA certificate for client certificate\\nauthentication to the server.\\n\\nIt is mutually exclusive with `clientCAFile`."'),
        client_ca: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#keySecret':: d.obj(help='"Secret containing the TLS private key for the web server.\\n\\nEither `cert` or `certFile` must be defined.\\n\\nIt is mutually exclusive with `keyFile`."'),
        keySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#withConvertClassicHistogramsToNHCB':: d.fn(help='"Whether to convert all scraped classic histograms into a native\\nhistogram with custom buckets.\\n\\nIt requires Prometheus >= v3.4.0."', args=[d.arg(name='convertClassicHistogramsToNHCB', type=d.T.boolean)]),
    ...
    '#withEvaluationInterval':: d.fn(help='"Interval between rule evaluations.\\nDefault: \\"30s\\', args=[d.arg(name='evaluationInterval', type=d.T.string)]),
    ...
    '#withPrometheusRulesExcludedFromEnforce':: d.fn(help="\"Defines the list of PrometheusRule objects to which the namespace label\\nenforcement doesn't apply.\\nThis is only relevant when `spec.enforcedNamespaceLabel` is set to true.\\nDeprecated: use `spec.excludedFromEnforcement` instead.\"", args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withPrometheusRulesExcludedFromEnforceMixin':: d.fn(help="\"Defines the list of PrometheusRule objects to which the namespace label\\nenforcement doesn't apply.\\nThis is only relevant when `spec.enforcedNamespaceLabel` is set to true.\\nDeprecated: use `spec.excludedFromEnforcement` instead.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withRemoteWriteReceiverMessageVersions':: d.fn(help='"List of the protobuf message versions to accept when receiving the\\nremote writes.\\n\\nIt requires Prometheus >= v2.54.0."', args=[d.arg(name='remoteWriteReceiverMessageVersions', type=d.T.array)]),
    ...
    '#withRuleQueryOffset':: d.fn(help='"Defines the offset the rule evaluation timestamp of this particular group by the specified duration into the past.\\nIt requires Prometheus >= v2.53.0."', args=[d.arg(name='ruleQueryOffset', type=d.T.string)]),
