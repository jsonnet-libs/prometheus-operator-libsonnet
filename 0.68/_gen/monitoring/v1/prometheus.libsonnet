{
  ...
  spec: {
    ...
    '#withIgnoreNamespaceSelectors':: d.fn(help='"When true, `spec.namespaceSelector` from all PodMonitor, ServiceMonitor and Probe objects will be ignored. They will only discover targets within the namespace of the PodMonitor, ServiceMonitor and Probe objec."', args=[d.arg(name='ignoreNamespaceSelectors', type=d.T.boolean)]),
