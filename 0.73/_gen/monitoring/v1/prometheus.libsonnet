{
  ...
  spec: {
    ...
    '#alerting':: d.obj(help='"Defines the settings related to Alertmanager."'),
    alerting: {
      ...
      alertmanagers: {
        ...
        basicAuth: {
          '#password':: d.obj(help='"`password` specifies a key of a Secret containing the password for authentication."'),
          password: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#username':: d.obj(help='"`username` specifies a key of a Secret containing the username for authentication."'),
          username: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        sigv4: {
          '#accessKey':: d.obj(help='"AccessKey is the AWS API key. If not specified, the environment variable `AWS_ACCESS_KEY_ID` is used."'),
          accessKey: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          ...
          '#secretKey':: d.obj(help='"SecretKey is the AWS API secret. If not specified, the environment variable `AWS_SECRET_ACCESS_KEY` is used."'),
          secretKey: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#tlsConfig':: d.obj(help='"TLS Config to use for Alertmanager."'),
        tlsConfig: {
        ...
        withName(name): { name: name },
        '#withNamespace':: d.fn(help='"Namespace of the Endpoints object."', args=[d.arg(name='namespace', type=d.T.string)]),
    ...
    '#apiserverConfig':: d.obj(help="\"APIServerConfig allows specifying a host and auth methods to access the Kuberntees API server. If null, Prometheus is assumed to run inside of the cluster: it will discover the API servers automatically and use the Pod's CA certificate and bearer token file at /var/run/secrets/kubernetes.io/serviceaccount/.\""),
    apiserverConfig: {
      ...
      '#withBearerToken':: d.fn(help="\"*Warning: this field shouldn't be used because the token value appears in clear-text. Prefer using `authorization`.* \\n Deprecated: this will be removed in a future release.\"", args=[d.arg(name='bearerToken', type=d.T.string)]),
      ...
      '#withHost':: d.fn(help='"Kubernetes API address consisting of a hostname or IP address followed by an optional port number."', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { spec+: { apiserverConfig+: { host: host } } },
    },
    '#arbitraryFSAccessThroughSMs':: d.obj(help="\"When true, ServiceMonitor, PodMonitor and Probe object are forbidden to reference arbitrary files on the file system of the 'prometheus' container. When a ServiceMonitor's endpoint specifies a `bearerTokenFile` value (e.g.  '/var/run/secrets/kubernetes.io/serviceaccount/token'), a malicious target can get access to the Prometheus service account's token in the Prometheus' scrape request. Setting `spec.arbitraryFSAccessThroughSM` to 'true' would prevent the attack. Users should instead provide the credentials using the `spec.bearerTokenSecret` field.\""),
    ...
    '#excludedFromEnforcement':: d.obj(help='"List of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objects to be excluded from enforcing a namespace label of origin. \\n It is only applicable if `spec.enforcedNamespaceLabel` set to true."'),
    ...
    '#exemplars':: d.obj(help='"Exemplars related settings that are runtime reloadable. It requires to enable the `exemplar-storage` feature flag to be effective."'),
    exemplars: {
      '#withMaxSize':: d.fn(help='"Maximum number of exemplars stored in memory for all series. \\n exemplar-storage itself must be enabled using the `spec.enableFeature` option for exemplars to be scraped in the first place. \\n If not set, Prometheus uses its default value. A value of zero or less than zero disables the storage."', args=[d.arg(name='maxSize', type=d.T.integer)]),
      withMaxSize(maxSize): { spec+: { exemplars+: { maxSize: maxSize } } },
    },
    '#hostAliases':: d.obj(help="\"Optional list of hosts and IPs that will be injected into the Pod's hosts file if specified.\""),
    hostAliases: {
    ...
    '#imagePullSecrets':: d.obj(help='"An optional list of references to Secrets in the same namespace to use for pulling images from registries. See http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"'),
    imagePullSecrets: {
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    '#initContainers':: d.obj(help='"InitContainers allows injecting initContainers to the Pod definition. Those can be used to e.g.  fetch secrets for injection into the Prometheus configuration from external sources. Any errors during the execution of an initContainer will lead to a restart of the Pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/ InitContainers described here modify an operator generated init containers if they share the same name and modifications are done via a strategic merge patch. \\n The names of init container name managed by the operator are: * `init-config-reloader`. \\n Overriding init containers is entirely outside the scope of what the maintainers will support and by doing so, you accept that this behaviour may break at any time without notice."'),
    initContainers: {
      '#env':: d.obj(help='"List of environment variables to set in the container. Cannot be updated."'),
      env: {
        '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
    ...
    '#persistentVolumeClaimRetentionPolicy':: d.obj(help='"The field controls if and how PVCs are deleted during the lifecycle of a StatefulSet. The default behavior is all PVCs are retained. This is an alpha field from kubernetes 1.23 until 1.26 and a beta field from 1.26. It requires enabling the StatefulSetAutoDeletePVC feature gate."'),
    ...
    '#podMonitorNamespaceSelector':: d.obj(help='"Namespaces to match for PodMonitors discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only."'),
    ...
    '#probeNamespaceSelector':: d.obj(help='"Namespaces to match for Probe discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only."'),
    ...
    '#probeSelector':: d.obj(help="\"Probes to be selected for target discovery. An empty label selector matches all objects. A null label selector matches no objects. \\n If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is *deprecated* and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead.\""),
    probeSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#prometheusRulesExcludedFromEnforce':: d.obj(help="\"Defines the list of PrometheusRule objects to which the namespace label enforcement doesn't apply. This is only relevant when `spec.enforcedNamespaceLabel` is set to true. Deprecated: use `spec.excludedFromEnforcement` instead.\""),
    prometheusRulesExcludedFromEnforce: {
      '#withRuleName':: d.fn(help='"Name of the excluded PrometheusRule object."', args=[d.arg(name='ruleName', type=d.T.string)]),
      withRuleName(ruleName): { ruleName: ruleName },
      '#withRuleNamespace':: d.fn(help='"Namespace of the excluded PrometheusRule object."', args=[d.arg(name='ruleNamespace', type=d.T.string)]),
      withRuleNamespace(ruleNamespace): { ruleNamespace: ruleNamespace },
    },
    '#query':: d.obj(help='"QuerySpec defines the configuration of the Promethus query service."'),
    query: {
    ...
    '#remoteRead':: d.obj(help='"Defines the list of remote read configurations."'),
    remoteRead: {
      ...
      oauth2: {
        '#clientId':: d.obj(help="\"`clientId` specifies a key of a Secret or ConfigMap containing the OAuth2 client's ID.\""),
        clientId: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#clientSecret':: d.obj(help="\"`clientSecret` specifies a key of a Secret containing the OAuth2 client's secret.\""),
        clientSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withEndpointParams':: d.fn(help='"`endpointParams` configures the HTTP parameters to append to the token URL."', args=[d.arg(name='endpointParams', type=d.T.object)]),
        withEndpointParams(endpointParams): { oauth2+: { endpointParams: endpointParams } },
        '#withEndpointParamsMixin':: d.fn(help='"`endpointParams` configures the HTTP parameters to append to the token URL."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointParams', type=d.T.object)]),
      ...
      '#withBearerTokenFile':: d.fn(help='"File from which to read the bearer token for the URL. \\n Deprecated: this will be removed in a future release. Prefer using `authorization`."', args=[d.arg(name='bearerTokenFile', type=d.T.string)]),
      withBearerTokenFile(bearerTokenFile): { bearerTokenFile: bearerTokenFile },
      '#withFilterExternalLabels':: d.fn(help='"Whether to use the external labels as selectors for the remote read endpoint. \\n It requires Prometheus >= v2.34.0."', args=[d.arg(name='filterExternalLabels', type=d.T.boolean)]),
      ...
      '#withName':: d.fn(help='"The name of the remote read queue, it must be unique if specified. The name is used in metrics and logging in order to differentiate read configurations. \\n It requires Prometheus >= v2.15.0."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    ...
    remoteWrite: {
      ...
      azureAd: {
        '#managedIdentity':: d.obj(help='"ManagedIdentity defines the Azure User-assigned Managed identity. Cannot be set at the same time as `oauth`."'),
        managedIdentity: {
        ...
        '#oauth':: d.obj(help='"OAuth defines the oauth config that is being used to authenticate. Cannot be set at the same time as `managedIdentity`. \\n It requires Prometheus >= v2.48.0."'),
        oauth: {
      ...
      queueConfig: {
        ...
        '#withRetryOnRateLimit':: d.fn(help='"Retry upon receiving a 429 status code from the remote-write storage. \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."', args=[d.arg(name='retryOnRateLimit', type=d.T.boolean)]),
        withRetryOnRateLimit(retryOnRateLimit): { queueConfig+: { retryOnRateLimit: retryOnRateLimit } },
        '#withSampleAgeLimit':: d.fn(help='"SampleAgeLimit drops samples older than the limit. It requires Prometheus >= v2.50.0."', args=[d.arg(name='sampleAgeLimit', type=d.T.string)]),
      ...
      '#withEnableHTTP2':: d.fn(help='"Whether to enable HTTP2."', args=[d.arg(name='enableHTTP2', type=d.T.boolean)]),
      withEnableHTTP2(enableHTTP2): { enableHTTP2: enableHTTP2 },
      '#withHeaders':: d.fn(help="\"Custom HTTP headers to be sent along with each remote write request. Be aware that headers that are set by Prometheus itself can't be overwritten. \\n It requires Prometheus \u003e= v2.25.0.\"", args=[d.arg(name='headers', type=d.T.object)]),
      withHeaders(headers): { headers: headers },
      '#withHeadersMixin':: d.fn(help="\"Custom HTTP headers to be sent along with each remote write request. Be aware that headers that are set by Prometheus itself can't be overwritten. \\n It requires Prometheus \u003e= v2.25.0.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='headers', type=d.T.object)]),
      withHeadersMixin(headers): { headers+: headers },
      '#withName':: d.fn(help='"The name of the remote write queue, it must be unique if specified. The name is used in metrics and logging in order to differentiate queues. \\n It requires Prometheus >= v2.15.0."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withProxyUrl':: d.fn(help='"Optional ProxyURL."', args=[d.arg(name='proxyUrl', type=d.T.string)]),
      withProxyUrl(proxyUrl): { proxyUrl: proxyUrl },
      ...
      withRemoteTimeout(remoteTimeout): { remoteTimeout: remoteTimeout },
      '#withSendExemplars':: d.fn(help='"Enables sending of exemplars over remote write. Note that exemplar-storage itself must be enabled using the `spec.enableFeature` option for exemplars to be scraped in the first place. \\n It requires Prometheus >= v2.27.0."', args=[d.arg(name='sendExemplars', type=d.T.boolean)]),
      withSendExemplars(sendExemplars): { sendExemplars: sendExemplars },
      '#withSendNativeHistograms':: d.fn(help='"Enables sending of native histograms, also known as sparse histograms over remote write. \\n It requires Prometheus >= v2.40.0."', args=[d.arg(name='sendNativeHistograms', type=d.T.boolean)]),
    ...
    '#ruleNamespaceSelector':: d.obj(help='"Namespaces to match for PrometheusRule discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only."'),
    ...
    '#ruleSelector':: d.obj(help='"PrometheusRule objects to be selected for rule evaluation. An empty label selector matches all objects. A null label selector matches no objects."'),
    ruleSelector: {
      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
      matchExpressions: {
        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#rules':: d.obj(help="\"Defines the configuration of the Prometheus rules' engine.\""),
    rules: {
      '#alert':: d.obj(help="\"Defines the parameters of the Prometheus rules' engine. \\n Any update to these parameters trigger a restart of the pods.\""),
      alert: {
        '#withForGracePeriod':: d.fn(help="\"Minimum duration between alert and restored 'for' state. \\n This is maintained only for alerts with a configured 'for' time greater than the grace period.\"", args=[d.arg(name='forGracePeriod', type=d.T.string)]),
    ...
    '#scrapeClasses':: d.obj(help='"List of scrape classes to expose to scraping objects such as PodMonitors, ServiceMonitors, Probes and ScrapeConfigs. \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."'),
    scrapeClasses: {
      ...
      '#tlsConfig':: d.obj(help='"TLSConfig section for scrapes."'),
      tlsConfig: {
        '#ca':: d.obj(help='"Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
      ...
      '#withDefault':: d.fn(help="\"Default indicates that the scrape applies to all scrape objects that don't configure an explicit scrape class name. \\n Only one scrape class can be set as default.\"", args=[d.arg(name='default', type=d.T.boolean)]),
    ...
    '#scrapeConfigNamespaceSelector':: d.obj(help='"Namespaces to match for ScrapeConfig discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only. \\n Note that the ScrapeConfig custom resource definition is currently at Alpha level."'),
    ...
    '#scrapeConfigSelector':: d.obj(help="\"ScrapeConfigs to be selected for target discovery. An empty label selector matches all objects. A null label selector matches no objects. \\n If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is *deprecated* and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead. \\n Note that the ScrapeConfig custom resource definition is currently at Alpha level.\""),
    ...
    '#serviceMonitorNamespaceSelector':: d.obj(help='"Namespaces to match for ServicedMonitors discovery. An empty label selector matches all namespaces. A null label selector matches the current namespace only."'),
    ...
    '#serviceMonitorSelector':: d.obj(help="\"ServiceMonitors to be selected for target discovery. An empty label selector matches all objects. A null label selector matches no objects. \\n If `spec.serviceMonitorSelector`, `spec.podMonitorSelector`, `spec.probeSelector` and `spec.scrapeConfigSelector` are null, the Prometheus configuration is unmanaged. The Prometheus operator will ensure that the Prometheus configuration's Secret exists, but it is the responsibility of the user to provide the raw gzipped Prometheus configuration under the `prometheus.yaml.gz` key. This behavior is *deprecated* and will be removed in the next major version of the custom resource definition. It is recommended to use `spec.additionalScrapeConfigs` instead.\""),
    ...
    storage: {
      '#emptyDir':: d.obj(help='"EmptyDirVolumeSource to be used by the StatefulSet. If specified, it takes precedence over `ephemeral` and `volumeClaimTemplate`. More info: https://kubernetes.io/docs/concepts/storage/volumes/#emptydir"'),
      emptyDir: {
      ...
      '#ephemeral':: d.obj(help='"EphemeralVolumeSource to be used by the StatefulSet. This is a beta field in k8s 1.21 and GA in 1.15. For lower versions, starting with k8s 1.19, it requires enabling the GenericEphemeralVolume feature gate. More info: https://kubernetes.io/docs/concepts/storage/ephemeral-volumes/#generic-ephemeral-volumes"'),
      ephemeral: {
      ...
      '#volumeClaimTemplate':: d.obj(help='"Defines the PVC spec to be used by the Prometheus StatefulSets. The easiest way to use a volume that cannot be automatically provisioned is to use a label selector alongside manually created PersistentVolumes."'),
      volumeClaimTemplate: {
        ...
        '#spec':: d.obj(help='"Defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims"'),
        spec: {
          '#dataSource':: d.obj(help='"dataSource field can be used to specify either: * An existing VolumeSnapshot object (snapshot.storage.k8s.io/VolumeSnapshot) * An existing PVC (PersistentVolumeClaim) If the provisioner or an external controller can support the specified data source, it will create a new volume based on the contents of the specified data source. When the AnyVolumeDataSource feature gate is enabled, dataSource contents will be copied to dataSourceRef, and dataSourceRef contents will be copied to dataSource when dataSourceRef.namespace is not specified. If the namespace is specified, then dataSourceRef will not be copied to dataSource."'),
          dataSource: {
            '#withApiGroup':: d.fn(help='"APIGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required."', args=[d.arg(name='apiGroup', type=d.T.string)]),
    ...
    '#thanos':: d.obj(help='"Defines the configuration of the optional Thanos sidecar."'),
    thanos: {
      ...
      '#grpcServerTlsConfig':: d.obj(help='"Configures the TLS parameters for the gRPC server providing the StoreAPI. \\n Note: Currently only the `caFile`, `certFile`, and `keyFile` fields are supported."'),
      grpcServerTlsConfig: {
        '#ca':: d.obj(help='"Certificate authority used when verifying server certificates."'),
        ca: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
      ...
      '#objectStorageConfig':: d.obj(help="\"Defines the Thanos sidecar's configuration to upload TSDB blocks to object storage. \\n More info: https://thanos.io/tip/thanos/storage.md/ \\n objectStorageConfigFile takes precedence over this field.\""),
      objectStorageConfig: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#resources':: d.obj(help='"Defines the resources requests and limits of the Thanos sidecar."'),
      resources: {
        '#claims':: d.obj(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."'),
        claims: {
          '#withName':: d.fn(help='"Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used. It makes that resource available inside a container."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#tracingConfig':: d.obj(help='"Defines the tracing configuration for the Thanos sidecar. \\n `tracingConfigFile` takes precedence over this field. \\n More info: https://thanos.io/tip/thanos/tracing.md/ \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."'),
      tracingConfig: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#volumeMounts':: d.obj(help="\"VolumeMounts allows configuration of additional VolumeMounts for Thanos. VolumeMounts specified will be appended to other VolumeMounts in the 'thanos-sidecar' container.\""),
      volumeMounts: {
        '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must not contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
        withMountPath(mountPath): { mountPath: mountPath },
        '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host to container and the other way around. When not set, MountPropagationNone is used. This field is beta in 1.10."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
      ...
      '#withBaseImage':: d.fn(help="\"Deprecated: use 'image' instead.\"", args=[d.arg(name='baseImage', type=d.T.string)]),
      withBaseImage(baseImage): { spec+: { thanos+: { baseImage: baseImage } } },
      '#withBlockSize':: d.fn(help='"BlockDuration controls the size of TSDB blocks produced by Prometheus. The default value is 2h to match the upstream Prometheus defaults. \\n WARNING: Changing the block duration can impact the performance and efficiency of the entire Prometheus/Thanos stack due to how it interacts with memory and Thanos compactors. It is recommended to keep this value set to a multiple of 120 times your longest scrape or rule interval. For example, 30s * 120 = 1h."', args=[d.arg(name='blockSize', type=d.T.string)]),
      withBlockSize(blockSize): { spec+: { thanos+: { blockSize: blockSize } } },
      '#withGetConfigInterval':: d.fn(help='"How often to retrieve the Prometheus configuration."', args=[d.arg(name='getConfigInterval', type=d.T.string)]),
      withGetConfigInterval(getConfigInterval): { spec+: { thanos+: { getConfigInterval: getConfigInterval } } },
      '#withGetConfigTimeout':: d.fn(help='"Maximum time to wait when retrieving the Prometheus configuration."', args=[d.arg(name='getConfigTimeout', type=d.T.string)]),
      withGetConfigTimeout(getConfigTimeout): { spec+: { thanos+: { getConfigTimeout: getConfigTimeout } } },
      '#withGrpcListenLocal':: d.fn(help="\"When true, the Thanos sidecar listens on the loopback interface instead of the Pod IP's address for the gRPC endpoints. \\n It has no effect if `listenLocal` is true.\"", args=[d.arg(name='grpcListenLocal', type=d.T.boolean)]),
      withGrpcListenLocal(grpcListenLocal): { spec+: { thanos+: { grpcListenLocal: grpcListenLocal } } },
      '#withHttpListenLocal':: d.fn(help="\"When true, the Thanos sidecar listens on the loopback interface instead of the Pod IP's address for the HTTP endpoints. \\n It has no effect if `listenLocal` is true.\"", args=[d.arg(name='httpListenLocal', type=d.T.boolean)]),
      withHttpListenLocal(httpListenLocal): { spec+: { thanos+: { httpListenLocal: httpListenLocal } } },
      '#withImage':: d.fn(help='"Container image name for Thanos. If specified, it takes precedence over the `spec.thanos.baseImage`, `spec.thanos.tag` and `spec.thanos.sha` fields. \\n Specifying `spec.thanos.version` is still necessary to ensure the Prometheus Operator knows which version of Thanos is being configured. \\n If neither `spec.thanos.image` nor `spec.thanos.baseImage` are defined, the operator will use the latest upstream version of Thanos available at the time when the operator was released."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { thanos+: { image: image } } },
      '#withListenLocal':: d.fn(help='"Deprecated: use `grpcListenLocal` and `httpListenLocal` instead."', args=[d.arg(name='listenLocal', type=d.T.boolean)]),
      withListenLocal(listenLocal): { spec+: { thanos+: { listenLocal: listenLocal } } },
      '#withLogFormat':: d.fn(help='"Log format for the Thanos sidecar."', args=[d.arg(name='logFormat', type=d.T.string)]),
      withLogFormat(logFormat): { spec+: { thanos+: { logFormat: logFormat } } },
      '#withLogLevel':: d.fn(help='"Log level for the Thanos sidecar."', args=[d.arg(name='logLevel', type=d.T.string)]),
      withLogLevel(logLevel): { spec+: { thanos+: { logLevel: logLevel } } },
      '#withMinTime':: d.fn(help="\"Defines the start of time range limit served by the Thanos sidecar's StoreAPI. The field's value should be a constant time in RFC3339 format or a time duration relative to current time, such as -1d or 2h45m. Valid duration units are ms, s, m, h, d, w, y.\"", args=[d.arg(name='minTime', type=d.T.string)]),
      withMinTime(minTime): { spec+: { thanos+: { minTime: minTime } } },
      '#withObjectStorageConfigFile':: d.fn(help="\"Defines the Thanos sidecar's configuration file to upload TSDB blocks to object storage. \\n More info: https://thanos.io/tip/thanos/storage.md/ \\n This field takes precedence over objectStorageConfig.\"", args=[d.arg(name='objectStorageConfigFile', type=d.T.string)]),
      withObjectStorageConfigFile(objectStorageConfigFile): { spec+: { thanos+: { objectStorageConfigFile: objectStorageConfigFile } } },
      '#withReadyTimeout':: d.fn(help='"ReadyTimeout is the maximum time that the Thanos sidecar will wait for Prometheus to start."', args=[d.arg(name='readyTimeout', type=d.T.string)]),
      withReadyTimeout(readyTimeout): { spec+: { thanos+: { readyTimeout: readyTimeout } } },
      '#withSha':: d.fn(help="\"Deprecated: use 'image' instead.  The image digest can be specified as part of the image name.\"", args=[d.arg(name='sha', type=d.T.string)]),
      withSha(sha): { spec+: { thanos+: { sha: sha } } },
      '#withTag':: d.fn(help="\"Deprecated: use 'image' instead. The image's tag can be specified as as part of the image name.\"", args=[d.arg(name='tag', type=d.T.string)]),
      withTag(tag): { spec+: { thanos+: { tag: tag } } },
      '#withTracingConfigFile':: d.fn(help='"Defines the tracing configuration file for the Thanos sidecar. \\n This field takes precedence over `tracingConfig`. \\n More info: https://thanos.io/tip/thanos/tracing.md/ \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."', args=[d.arg(name='tracingConfigFile', type=d.T.string)]),
      withTracingConfigFile(tracingConfigFile): { spec+: { thanos+: { tracingConfigFile: tracingConfigFile } } },
      '#withVersion':: d.fn(help='"Version of Thanos being deployed. The operator uses this information to generate the Prometheus StatefulSet + configuration files. \\n If not specified, the operator assumes the latest upstream release of Thanos available at the time when the version of the operator was released."', args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { spec+: { thanos+: { version: version } } },
      '#withVolumeMounts':: d.fn(help="\"VolumeMounts allows configuration of additional VolumeMounts for Thanos. VolumeMounts specified will be appended to other VolumeMounts in the 'thanos-sidecar' container.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { spec+: { thanos+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help="\"VolumeMounts allows configuration of additional VolumeMounts for Thanos. VolumeMounts specified will be appended to other VolumeMounts in the 'thanos-sidecar' container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
    ...
    tsdb: {
      '#withOutOfOrderTimeWindow':: d.fn(help='"Configures how old an out-of-order/out-of-bounds sample can be with respect to the TSDB max time. \\n An out-of-order/out-of-bounds sample is ingested into the TSDB as long as the timestamp of the sample is >= (TSDB.MaxTime - outOfOrderTimeWindow). \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way. \\n It requires Prometheus >= v2.39.0."', args=[d.arg(name='outOfOrderTimeWindow', type=d.T.string)]),
    ...
    '#volumes':: d.obj(help='"Volumes allows the configuration of additional volumes on the output StatefulSet definition. Volumes specified will be appended to other volumes that are generated as a result of StorageSpec objects."'),
    volumes: {
    ...
    web: {
      ...
      '#withMaxConnections':: d.fn(help="\"Defines the maximum number of simultaneous connections A zero value means that Prometheus doesn't accept any incoming connection.\"", args=[d.arg(name='maxConnections', type=d.T.integer)]),
    ...
    '#withAdditionalArgs':: d.fn(help="\"AdditionalArgs allows setting additional arguments for the 'prometheus' container. \\n It is intended for e.g. activating hidden flags which are not supported by the dedicated configuration options yet. The arguments are passed as-is to the Prometheus container which may cause issues if they are invalid or not supported by the given Prometheus version. \\n In case of an argument conflict (e.g. an argument which is already set by the operator itself) or when providing an invalid argument, the reconciliation will fail and an error will be logged.\"", args=[d.arg(name='additionalArgs', type=d.T.array)]),
    ...
    '#withAllowOverlappingBlocks':: d.fn(help='"AllowOverlappingBlocks enables vertical compaction and vertical query merge in Prometheus. \\n Deprecated: this flag has no effect for Prometheus >= 2.39.0 where overlapping blocks are enabled by default."', args=[d.arg(name='allowOverlappingBlocks', type=d.T.boolean)]),
    withAllowOverlappingBlocks(allowOverlappingBlocks): { spec+: { allowOverlappingBlocks: allowOverlappingBlocks } },
    '#withBaseImage':: d.fn(help="\"Deprecated: use 'spec.image' instead.\"", args=[d.arg(name='baseImage', type=d.T.string)]),
    withBaseImage(baseImage): { spec+: { baseImage: baseImage } },
    '#withBodySizeLimit':: d.fn(help='"BodySizeLimit defines per-scrape on response body size. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='bodySizeLimit', type=d.T.string)]),
    ...
    '#withContainers':: d.fn(help='"Containers allows injecting additional containers or modifying operator generated containers. This can be used to allow adding an authentication proxy to the Pods or to change the behavior of an operator generated container. Containers described here modify an operator generated container if they share the same name and modifications are done via a strategic merge patch. \\n The names of containers managed by the operator are: * `prometheus` * `config-reloader` * `thanos-sidecar` \\n Overriding containers is entirely outside the scope of what the maintainers will support and by doing so, you accept that this behaviour may break at any time without notice."', args=[d.arg(name='containers', type=d.T.array)]),
    ...
    '#withExcludedFromEnforcementMixin':: d.fn(help='"List of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objects to be excluded from enforcing a namespace label of origin. \\n It is only applicable if `spec.enforcedNamespaceLabel` set to true."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='excludedFromEnforcement', type=d.T.array)]),
    ...
    '#withExternalLabels':: d.fn(help='"The labels to add to any time series or alerts when communicating with external systems (federation, remote storage, Alertmanager). Labels defined by `spec.replicaExternalLabelName` and `spec.prometheusExternalLabelName` take precedence over this list."', args=[d.arg(name='externalLabels', type=d.T.object)]),
    withExternalLabels(externalLabels): { spec+: { externalLabels: externalLabels } },
    '#withExternalLabelsMixin':: d.fn(help='"The labels to add to any time series or alerts when communicating with external systems (federation, remote storage, Alertmanager). Labels defined by `spec.replicaExternalLabelName` and `spec.prometheusExternalLabelName` take precedence over this list."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='externalLabels', type=d.T.object)]),
    withExternalLabelsMixin(externalLabels): { spec+: { externalLabels+: externalLabels } },
    '#withExternalUrl':: d.fn(help='"The external URL under which the Prometheus service is externally available. This is necessary to generate correct URLs (for instance if Prometheus is accessible behind an Ingress resource)."', args=[d.arg(name='externalUrl', type=d.T.string)]),
    withExternalUrl(externalUrl): { spec+: { externalUrl: externalUrl } },
    '#withHostAliases':: d.fn(help="\"Optional list of hosts and IPs that will be injected into the Pod's hosts file if specified.\"", args=[d.arg(name='hostAliases', type=d.T.array)]),
    withHostAliases(hostAliases): { spec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    '#withHostAliasesMixin':: d.fn(help="\"Optional list of hosts and IPs that will be injected into the Pod's hosts file if specified.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='hostAliases', type=d.T.array)]),
    withHostAliasesMixin(hostAliases): { spec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } },
    '#withHostNetwork':: d.fn(help="\"Use the host's network namespace if true. \\n Make sure to understand the security implications if you want to enable it (https://kubernetes.io/docs/concepts/configuration/overview/). \\n When hostNetwork is enabled, this will set the DNS policy to `ClusterFirstWithHostNet` automatically.\"", args=[d.arg(name='hostNetwork', type=d.T.boolean)]),
    withHostNetwork(hostNetwork): { spec+: { hostNetwork: hostNetwork } },
    '#withIgnoreNamespaceSelectors':: d.fn(help='"When true, `spec.namespaceSelector` from all PodMonitor, ServiceMonitor and Probe objects will be ignored. They will only discover targets within the namespace of the PodMonitor, ServiceMonitor and Probe object."', args=[d.arg(name='ignoreNamespaceSelectors', type=d.T.boolean)]),
    withIgnoreNamespaceSelectors(ignoreNamespaceSelectors): { spec+: { ignoreNamespaceSelectors: ignoreNamespaceSelectors } },
    '#withImage':: d.fn(help='"Container image name for Prometheus. If specified, it takes precedence over the `spec.baseImage`, `spec.tag` and `spec.sha` fields. \\n Specifying `spec.version` is still necessary to ensure the Prometheus Operator knows which version of Prometheus is being configured. \\n If neither `spec.image` nor `spec.baseImage` are defined, the operator will use the latest upstream version of Prometheus available at the time when the operator was released."', args=[d.arg(name='image', type=d.T.string)]),
    ...
    '#withImagePullSecrets':: d.fn(help='"An optional list of references to Secrets in the same namespace to use for pulling images from registries. See http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
    ...
    '#withImagePullSecretsMixin':: d.fn(help='"An optional list of references to Secrets in the same namespace to use for pulling images from registries. See http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
    ...
    '#withInitContainers':: d.fn(help='"InitContainers allows injecting initContainers to the Pod definition. Those can be used to e.g.  fetch secrets for injection into the Prometheus configuration from external sources. Any errors during the execution of an initContainer will lead to a restart of the Pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/ InitContainers described here modify an operator generated init containers if they share the same name and modifications are done via a strategic merge patch. \\n The names of init container name managed by the operator are: * `init-config-reloader`. \\n Overriding init containers is entirely outside the scope of what the maintainers will support and by doing so, you accept that this behaviour may break at any time without notice."', args=[d.arg(name='initContainers', type=d.T.array)]),
    ...
    '#withKeepDroppedTargets':: d.fn(help='"Per-scrape limit on the number of targets dropped by relabeling that will be kept in memory. 0 means no limit. \\n It requires Prometheus >= v2.47.0."', args=[d.arg(name='keepDroppedTargets', type=d.T.integer)]),
    withKeepDroppedTargets(keepDroppedTargets): { spec+: { keepDroppedTargets: keepDroppedTargets } },
    '#withLabelLimit':: d.fn(help='"Per-scrape limit on number of labels that will be accepted for a sample. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='labelLimit', type=d.T.integer)]),
    withLabelLimit(labelLimit): { spec+: { labelLimit: labelLimit } },
    '#withLabelNameLengthLimit':: d.fn(help='"Per-scrape limit on length of labels name that will be accepted for a sample. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='labelNameLengthLimit', type=d.T.integer)]),
    withLabelNameLengthLimit(labelNameLengthLimit): { spec+: { labelNameLengthLimit: labelNameLengthLimit } },
    '#withLabelValueLengthLimit':: d.fn(help='"Per-scrape limit on length of labels value that will be accepted for a sample. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='labelValueLengthLimit', type=d.T.integer)]),
    withLabelValueLengthLimit(labelValueLengthLimit): { spec+: { labelValueLengthLimit: labelValueLengthLimit } },
    '#withListenLocal':: d.fn(help="\"When true, the Prometheus server listens on the loopback address instead of the Pod IP's address.\"", args=[d.arg(name='listenLocal', type=d.T.boolean)]),
    ...
    '#withMinReadySeconds':: d.fn(help='"Minimum number of seconds for which a newly created Pod should be ready without any of its container crashing for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) \\n This is an alpha field from kubernetes 1.22 until 1.24 which requires enabling the StatefulSetMinReadySeconds feature gate."', args=[d.arg(name='minReadySeconds', type=d.T.integer)]),
    ...
    '#withPodTargetLabels':: d.fn(help='"PodTargetLabels are appended to the `spec.podTargetLabels` field of all PodMonitor and ServiceMonitor objects."', args=[d.arg(name='podTargetLabels', type=d.T.array)]),
    ...
    '#withPodTargetLabelsMixin':: d.fn(help='"PodTargetLabels are appended to the `spec.podTargetLabels` field of all PodMonitor and ServiceMonitor objects."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podTargetLabels', type=d.T.array)]),
    ...
    '#withPortName':: d.fn(help='"Port name used for the pods and governing service. Default: \\"web\\', args=[d.arg(name='portName', type=d.T.string)]),
    ...
    '#withPrometheusRulesExcludedFromEnforceMixin':: d.fn(help="\"Defines the list of PrometheusRule objects to which the namespace label enforcement doesn't apply. This is only relevant when `spec.enforcedNamespaceLabel` is set to true. Deprecated: use `spec.excludedFromEnforcement` instead.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='prometheusRulesExcludedFromEnforce', type=d.T.array)]),
    ...
    '#withReplicaExternalLabelName':: d.fn(help='"Name of Prometheus external label used to denote the replica name. The external label will _not_ be added when the field is set to the empty string (`\\"\\"`). \\n Default: \\"prometheus_replica\\', args=[d.arg(name='replicaExternalLabelName', type=d.T.string)]),
    withReplicaExternalLabelName(replicaExternalLabelName): { spec+: { replicaExternalLabelName: replicaExternalLabelName } },
    '#withReplicas':: d.fn(help='"Number of replicas of each shard to deploy for a Prometheus deployment. `spec.replicas` multiplied by `spec.shards` is the total number of Pods created. \\n Default: 1"', args=[d.arg(name='replicas', type=d.T.integer)]),
    withReplicas(replicas): { spec+: { replicas: replicas } },
    '#withRetention':: d.fn(help='"How long to retain the Prometheus data. \\n Default: \\"24h\\" if `spec.retention` and `spec.retentionSize` are empty."', args=[d.arg(name='retention', type=d.T.string)]),
    withRetention(retention): { spec+: { retention: retention } },
    '#withRetentionSize':: d.fn(help='"Maximum number of bytes used by the Prometheus data."', args=[d.arg(name='retentionSize', type=d.T.string)]),
    withRetentionSize(retentionSize): { spec+: { retentionSize: retentionSize } },
    '#withRoutePrefix':: d.fn(help='"The route prefix Prometheus registers HTTP handlers for. \\n This is useful when using `spec.externalURL`, and a proxy is rewriting HTTP routes of a request, and the actual ExternalURL is still true, but the server serves requests under a different route prefix. For example for use with `kubectl proxy`."', args=[d.arg(name='routePrefix', type=d.T.string)]),
    withRoutePrefix(routePrefix): { spec+: { routePrefix: routePrefix } },
    '#withSampleLimit':: d.fn(help='"SampleLimit defines per-scrape limit on number of scraped samples that will be accepted. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='sampleLimit', type=d.T.integer)]),
    withSampleLimit(sampleLimit): { spec+: { sampleLimit: sampleLimit } },
    '#withScrapeClasses':: d.fn(help='"List of scrape classes to expose to scraping objects such as PodMonitors, ServiceMonitors, Probes and ScrapeConfigs. \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."', args=[d.arg(name='scrapeClasses', type=d.T.array)]),
    withScrapeClasses(scrapeClasses): { spec+: { scrapeClasses: if std.isArray(v=scrapeClasses) then scrapeClasses else [scrapeClasses] } },
    '#withScrapeClassesMixin':: d.fn(help='"List of scrape classes to expose to scraping objects such as PodMonitors, ServiceMonitors, Probes and ScrapeConfigs. \\n This is an *experimental feature*, it may change in any upcoming release in a breaking way."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scrapeClasses', type=d.T.array)]),
    ...
    '#withScrapeProtocols':: d.fn(help='"The protocols to negotiate during a scrape. It tells clients the protocols supported by Prometheus in order of preference (from most to least preferred). \\n If unset, Prometheus uses its default value. \\n It requires Prometheus >= v2.49.0."', args=[d.arg(name='scrapeProtocols', type=d.T.array)]),
    ...
    '#withScrapeProtocolsMixin':: d.fn(help='"The protocols to negotiate during a scrape. It tells clients the protocols supported by Prometheus in order of preference (from most to least preferred). \\n If unset, Prometheus uses its default value. \\n It requires Prometheus >= v2.49.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scrapeProtocols', type=d.T.array)]),
    ...
    '#withSha':: d.fn(help="\"Deprecated: use 'spec.image' instead. The image's digest can be specified as part of the image name.\"", args=[d.arg(name='sha', type=d.T.string)]),
    withSha(sha): { spec+: { sha: sha } },
    '#withShards':: d.fn(help='"Number of shards to distribute targets onto. `spec.replicas` multiplied by `spec.shards` is the total number of Pods created. \\n Note that scaling down shards will not reshard data onto remaining instances, it must be manually moved. Increasing shards will not reshard data either but it will continue to be available from the same instances. To query globally, use Thanos sidecar and Thanos querier or remote write data to a central location. \\n Sharding is performed on the content of the `__address__` target meta-label for PodMonitors and ServiceMonitors and `__param_target__` for Probes. \\n Default: 1"', args=[d.arg(name='shards', type=d.T.integer)]),
    withShards(shards): { spec+: { shards: shards } },
    '#withTag':: d.fn(help="\"Deprecated: use 'spec.image' instead. The image's tag can be specified as part of the image name.\"", args=[d.arg(name='tag', type=d.T.string)]),
    withTag(tag): { spec+: { tag: tag } },
    '#withTargetLimit':: d.fn(help='"TargetLimit defines a limit on the number of scraped targets that will be accepted. Only valid in Prometheus versions 2.45.0 and newer."', args=[d.arg(name='targetLimit', type=d.T.integer)]),
    ...
    '#withVersion':: d.fn(help='"Version of Prometheus being deployed. The operator uses this information to generate the Prometheus StatefulSet + configuration files. \\n If not specified, the operator assumes the latest upstream version of Prometheus available at the time when the version of the operator was released."', args=[d.arg(name='version', type=d.T.string)]),
    withVersion(version): { spec+: { version: version } },
    '#withVolumeMounts':: d.fn(help="\"VolumeMounts allows the configuration of additional VolumeMounts. \\n VolumeMounts will be appended to other VolumeMounts in the 'prometheus' container, that are generated as a result of StorageSpec objects.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
    ...
    '#withVolumes':: d.fn(help='"Volumes allows the configuration of additional volumes on the output StatefulSet definition. Volumes specified will be appended to other volumes that are generated as a result of StorageSpec objects."', args=[d.arg(name='volumes', type=d.T.array)]),
    withVolumes(volumes): { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    '#withVolumesMixin':: d.fn(help='"Volumes allows the configuration of additional volumes on the output StatefulSet definition. Volumes specified will be appended to other volumes that are generated as a result of StorageSpec objects."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
