{
  ...
  '#':: d.pkg(name='alertmanagerConfig', url='', help='"AlertmanagerConfig configures the Prometheus Alertmanager, specifying how alerts should be grouped, inhibited and notified to external systems."'),
  ...
  spec: {
    '#inhibitRules':: d.obj(help="\"List of inhibition rules. The rules will only apply to alerts matching the resource's namespace.\""),
    inhibitRules: {
      '#sourceMatch':: d.obj(help="\"Matchers for which one or more alerts have to exist for the inhibition to take effect. The operator enforces that the alert matches the resource's namespace.\""),
      sourceMatch: {
        '#withMatchType':: d.fn(help='"Match operation available with AlertManager >= v0.22.0 and takes precedence over Regex (deprecated) if non-empty."', args=[d.arg(name='matchType', type=d.T.string)]),
        withMatchType(matchType): { matchType: matchType },
        '#withName':: d.fn(help='"Label to match."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withRegex':: d.fn(help='"Whether to match on equality (false) or regular-expression (true). Deprecated: for AlertManager >= v0.22.0, `matchType` should be used instead."', args=[d.arg(name='regex', type=d.T.boolean)]),
        withRegex(regex): { regex: regex },
        '#withValue':: d.fn(help='"Label value to match."', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#targetMatch':: d.obj(help="\"Matchers that have to be fulfilled in the alerts to be muted. The operator enforces that the alert matches the resource's namespace.\""),
      targetMatch: {
        '#withMatchType':: d.fn(help='"Match operation available with AlertManager >= v0.22.0 and takes precedence over Regex (deprecated) if non-empty."', args=[d.arg(name='matchType', type=d.T.string)]),
        withMatchType(matchType): { matchType: matchType },
        '#withName':: d.fn(help='"Label to match."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withEqual':: d.fn(help='"Labels that must have an equal value in the source and target alert for the inhibition to take effect."', args=[d.arg(name='equal', type=d.T.array)]),
      withEqual(equal): { equal: if std.isArray(v=equal) then equal else [equal] },
      '#withEqualMixin':: d.fn(help='"Labels that must have an equal value in the source and target alert for the inhibition to take effect."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='equal', type=d.T.array)]),
      withEqualMixin(equal): { equal+: if std.isArray(v=equal) then equal else [equal] },
      '#withSourceMatch':: d.fn(help="\"Matchers for which one or more alerts have to exist for the inhibition to take effect. The operator enforces that the alert matches the resource's namespace.\"", args=[d.arg(name='sourceMatch', type=d.T.array)]),
      withSourceMatch(sourceMatch): { sourceMatch: if std.isArray(v=sourceMatch) then sourceMatch else [sourceMatch] },
      '#withSourceMatchMixin':: d.fn(help="\"Matchers for which one or more alerts have to exist for the inhibition to take effect. The operator enforces that the alert matches the resource's namespace.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='sourceMatch', type=d.T.array)]),
      withSourceMatchMixin(sourceMatch): { sourceMatch+: if std.isArray(v=sourceMatch) then sourceMatch else [sourceMatch] },
      '#withTargetMatch':: d.fn(help="\"Matchers that have to be fulfilled in the alerts to be muted. The operator enforces that the alert matches the resource's namespace.\"", args=[d.arg(name='targetMatch', type=d.T.array)]),
      withTargetMatch(targetMatch): { targetMatch: if std.isArray(v=targetMatch) then targetMatch else [targetMatch] },
      '#withTargetMatchMixin':: d.fn(help="\"Matchers that have to be fulfilled in the alerts to be muted. The operator enforces that the alert matches the resource's namespace.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='targetMatch', type=d.T.array)]),
    ...
    receivers: {
      ...
      discordConfigs: {
        '#apiURL':: d.obj(help="\"The secret's key that contains the Discord webhook URL. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        apiURL: {
        ...
        httpConfig: {
          ...
          '#bearerTokenSecret':: d.obj(help="\"The secret's key that contains the bearer token to be used by the client for authentication. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
          bearerTokenSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      emailConfigs: {
        '#authPassword':: d.obj(help="\"The secret's key that contains the password to use for authentication. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        authPassword: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#authSecret':: d.obj(help="\"The secret's key that contains the CRAM-MD5 secret. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        authSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#headers':: d.obj(help='"Further headers email header key/value pairs. Overrides any headers previously set by the notification implementation."'),
        headers: {
        ...
        '#withHeaders':: d.fn(help='"Further headers email header key/value pairs. Overrides any headers previously set by the notification implementation."', args=[d.arg(name='headers', type=d.T.array)]),
        withHeaders(headers): { headers: if std.isArray(v=headers) then headers else [headers] },
        '#withHeadersMixin':: d.fn(help='"Further headers email header key/value pairs. Overrides any headers previously set by the notification implementation."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
        ...
        '#withRequireTLS':: d.fn(help='"The SMTP TLS requirement. Note that Go does not support unencrypted connections to remote SMTP endpoints."', args=[d.arg(name='requireTLS', type=d.T.boolean)]),
      ...
      '#msteamsConfigs':: d.obj(help='"List of MSTeams configurations. It requires Alertmanager >= 0.26.0."'),
      msteamsConfigs: {
        '#httpConfig':: d.obj(help='"HTTP client configuration."'),
        httpConfig: {
          '#authorization':: d.obj(help='"Authorization header configuration for the client. This is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+."'),
        ...
        withSendResolved(sendResolved): { sendResolved: sendResolved },
        '#withSummary':: d.fn(help='"Message summary template. It requires Alertmanager >= 0.27.0."', args=[d.arg(name='summary', type=d.T.string)]),
      ...
      opsgenieConfigs: {
        '#apiKey':: d.obj(help="\"The secret's key that contains the OpsGenie API key. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        apiKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withUpdateAlerts':: d.fn(help='"Whether to update message and description of the alert in OpsGenie if it already exists By default, the alert is never updated in OpsGenie, the new message only appears in activity log."', args=[d.arg(name='updateAlerts', type=d.T.boolean)]),
      ...
      pagerdutyConfigs: {
        ...
        '#routingKey':: d.obj(help="\"The secret's key that contains the PagerDuty integration key (when using Events API v2). Either this field or `serviceKey` needs to be defined. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        routingKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#serviceKey':: d.obj(help="\"The secret's key that contains the PagerDuty service key (when using integration type \\\"Prometheus\\\"). Either this field or `routingKey` needs to be defined. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        serviceKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      pushoverConfigs: {
        ...
        '#token':: d.obj(help="\"The secret's key that contains the registered application's API token, see https://pushover.net/apps. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator. Either `token` or `tokenFile` is required.\""),
        token: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#userKey':: d.obj(help="\"The secret's key that contains the recipient user's user key. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator. Either `userKey` or `userKeyFile` is required.\""),
        userKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withExpire':: d.fn(help='"How long your notification will continue to be retried for, unless the user acknowledges the notification."', args=[d.arg(name='expire', type=d.T.string)]),
        ...
        withPriority(priority): { priority: priority },
        '#withRetry':: d.fn(help='"How often the Pushover servers will send the same notification to the user. Must be at least 30 seconds."', args=[d.arg(name='retry', type=d.T.string)]),
        ...
        withTitle(title): { title: title },
        '#withTokenFile':: d.fn(help="\"The token file that contains the registered application's API token, see https://pushover.net/apps. Either `token` or `tokenFile` is required. It requires Alertmanager \u003e= v0.26.0.\"", args=[d.arg(name='tokenFile', type=d.T.string)]),
        ...
        '#withUserKeyFile':: d.fn(help="\"The user key file that contains the recipient user's user key. Either `userKey` or `userKeyFile` is required. It requires Alertmanager \u003e= v0.26.0.\"", args=[d.arg(name='userKeyFile', type=d.T.string)]),
      ...
      slackConfigs: {
        ...
        actions: {
          '#confirm':: d.obj(help='"SlackConfirmationField protect users from destructive actions or particularly distinguished decisions by asking them to confirm their button click one more time. See https://api.slack.com/docs/interactive-message-field-guide#confirmation_fields for more information."'),
          confirm: {
        ...
        '#apiURL':: d.obj(help="\"The secret's key that contains the Slack webhook URL. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        apiURL: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { apiURL+: { key: key } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      snsConfigs: {
        ...
        '#withApiURL':: d.fn(help='"The SNS API URL i.e. https://sns.us-east-2.amazonaws.com. If not specified, the SNS API URL from the SNS SDK will be used."', args=[d.arg(name='apiURL', type=d.T.string)]),
        withApiURL(apiURL): { apiURL: apiURL },
        ...
        withMessage(message): { message: message },
        '#withPhoneNumber':: d.fn(help="\"Phone number if message is delivered via SMS in E.164 format. If you don't specify this value, you must specify a value for the TopicARN or TargetARN.\"", args=[d.arg(name='phoneNumber', type=d.T.string)]),
        ...
        '#withTargetARN':: d.fn(help="\"The  mobile platform endpoint ARN if message is delivered via mobile notifications. If you don't specify this value, you must specify a value for the topic_arn or PhoneNumber.\"", args=[d.arg(name='targetARN', type=d.T.string)]),
        withTargetARN(targetARN): { targetARN: targetARN },
        '#withTopicARN':: d.fn(help="\"SNS topic ARN, i.e. arn:aws:sns:us-east-2:698519295917:My-Topic If you don't specify this value, you must specify a value for the PhoneNumber or TargetARN.\"", args=[d.arg(name='topicARN', type=d.T.string)]),
        withTopicARN(topicARN): { topicARN: topicARN },
      },
      '#telegramConfigs':: d.obj(help='"List of Telegram configurations."'),
      telegramConfigs: {
        '#botToken':: d.obj(help='"Telegram bot token. It is mutually exclusive with `botTokenFile`. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator. \\n Either `botToken` or `botTokenFile` is required."'),
        botToken: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withApiURL':: d.fn(help='"The Telegram API URL i.e. https://api.telegram.org. If not specified, default API URL will be used."', args=[d.arg(name='apiURL', type=d.T.string)]),
        withApiURL(apiURL): { apiURL: apiURL },
        '#withBotTokenFile':: d.fn(help='"File to read the Telegram bot token from. It is mutually exclusive with `botToken`. Either `botToken` or `botTokenFile` is required. \\n It requires Alertmanager >= v0.26.0."', args=[d.arg(name='botTokenFile', type=d.T.string)]),
      ...
      victoropsConfigs: {
        '#apiKey':: d.obj(help="\"The secret's key that contains the API key to use when talking to the VictorOps API. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        apiKey: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { apiKey+: { key: key } },
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      webexConfigs: {
        '#httpConfig':: d.obj(help="\"The HTTP client's configuration. You must supply the bot token via the `httpConfig.authorization` field.\""),
        httpConfig: {
          '#authorization':: d.obj(help='"Authorization header configuration for the client. This is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+."'),
          authorization: {
            '#credentials':: d.obj(help='"Selects a key of a Secret in the namespace that contains the credentials for authentication."'),
        ...
        '#withApiURL':: d.fn(help='"The Webex Teams API URL i.e. https://webexapis.com/v1/messages Provide if different from the default API URL."', args=[d.arg(name='apiURL', type=d.T.string)]),
        withApiURL(apiURL): { apiURL: apiURL },
        '#withMessage':: d.fn(help='"Message template"', args=[d.arg(name='message', type=d.T.string)]),
        withMessage(message): { message: message },
      ...
      webhookConfigs: {
        ...
        '#urlSecret':: d.obj(help="\"The secret's key that contains the webhook URL to send HTTP requests to. `urlSecret` takes precedence over `url`. One of `urlSecret` and `url` should be defined. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        urlSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withSendResolved':: d.fn(help='"Whether or not to notify about resolved alerts."', args=[d.arg(name='sendResolved', type=d.T.boolean)]),
        withSendResolved(sendResolved): { sendResolved: sendResolved },
        '#withUrl':: d.fn(help='"The URL to send HTTP POST requests to. `urlSecret` takes precedence over `url`. One of `urlSecret` and `url` should be defined."', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { url: url },
      },
      '#wechatConfigs':: d.obj(help='"List of WeChat configurations."'),
      wechatConfigs: {
        '#apiSecret':: d.obj(help="\"The secret's key that contains the WeChat API key. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.\""),
        apiSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withMsteamsConfigs':: d.fn(help='"List of MSTeams configurations. It requires Alertmanager >= 0.26.0."', args=[d.arg(name='msteamsConfigs', type=d.T.array)]),
      withMsteamsConfigs(msteamsConfigs): { msteamsConfigs: if std.isArray(v=msteamsConfigs) then msteamsConfigs else [msteamsConfigs] },
      '#withMsteamsConfigsMixin':: d.fn(help='"List of MSTeams configurations. It requires Alertmanager >= 0.26.0."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='msteamsConfigs', type=d.T.array)]),
    ...
    route: {
      '#matchers':: d.obj(help="\"List of matchers that the alert's labels should match. For the first level route, the operator removes any existing equality and regexp matcher on the `namespace` label and adds a `namespace: \u003cobject namespace\u003e` matcher.\""),
      matchers: {
        '#withMatchType':: d.fn(help='"Match operation available with AlertManager >= v0.22.0 and takes precedence over Regex (deprecated) if non-empty."', args=[d.arg(name='matchType', type=d.T.string)]),
        withMatchType(matchType): { matchType: matchType },
        '#withName':: d.fn(help='"Label to match."', args=[d.arg(name='name', type=d.T.string)]),
