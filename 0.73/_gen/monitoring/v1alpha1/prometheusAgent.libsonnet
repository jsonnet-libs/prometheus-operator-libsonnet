{
  ...
  '#':: d.pkg(name='prometheusAgent', url='', help='"PrometheusAgent defines a Prometheus agent deployment."'),
  ...
  '#spec':: d.obj(help='"Specification of the desired behavior of the Prometheus agent. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
