{
  ...
  spec: {
    ...
    azureSDConfigs: {
      ...
      '#withAuthenticationMethod':: d.fn(help='"# The authentication method, either OAuth or ManagedIdentity. See https://docs.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/overview"', args=[d.arg(name='authenticationMethod', type=d.T.string)]),
      ...
      '#withPort':: d.fn(help='"The port to scrape metrics from. If using the public IP address, this must instead be specified in the relabeling rule."', args=[d.arg(name='port', type=d.T.integer)]),
    ...
    consulSDConfigs: {
      ...
      '#withAllowStale':: d.fn(help='"Allow stale Consul results (see https://www.consul.io/api/features/consistency.html). Will reduce load on Consul. If unset, Prometheus uses its default value."', args=[d.arg(name='allowStale', type=d.T.boolean)]),
      ...
      '#withEnableHTTP2':: d.fn(help='"Whether to enable HTTP2. If unset, Prometheus uses its default value."', args=[d.arg(name='enableHTTP2', type=d.T.boolean)]),
      withEnableHTTP2(enableHTTP2): { enableHTTP2: enableHTTP2 },
      '#withFollowRedirects':: d.fn(help='"Configure whether HTTP requests follow HTTP 3xx redirects. If unset, Prometheus uses its default value."', args=[d.arg(name='followRedirects', type=d.T.boolean)]),
      ...
      '#withNoProxy':: d.fn(help='"`noProxy` is a comma-separated string that can contain IPs, CIDR notation, domain names that should be excluded from proxying. IP and domain names can contain port numbers. \\n It requires Prometheus >= v2.43.0."', args=[d.arg(name='noProxy', type=d.T.string)]),
      ...
      '#withRefreshInterval':: d.fn(help='"The time after which the provided names are refreshed. On large setup it might be a good idea to increase this value because the catalog will change all the time. If unset, Prometheus uses its default value."', args=[d.arg(name='refreshInterval', type=d.T.string)]),
      withRefreshInterval(refreshInterval): { refreshInterval: refreshInterval },
      ...
      '#withTagSeparator':: d.fn(help='"The string by which Consul tags are joined into the tag label. If unset, Prometheus uses its default value."', args=[d.arg(name='tagSeparator', type=d.T.string)]),
    ...
    digitalOceanSDConfigs: {
      '#authorization':: d.obj(help='"Authorization header configuration to authenticate against the DigitalOcean API. Cannot be set at the same time as `oauth2`."'),
      authorization: {
        '#credentials':: d.obj(help='"Selects a key of a Secret in the namespace that contains the credentials for authentication."'),
        credentials: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#oauth2':: d.obj(help='"Optional OAuth 2.0 configuration. Cannot be set at the same time as `authorization`."'),
      oauth2: {
        '#clientId':: d.obj(help="\"`clientId` specifies a key of a Secret or ConfigMap containing the OAuth2 client's ID.\""),
        clientId: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
    ...
    dnsSDConfigs: {
      ...
      '#withPort':: d.fn(help='"The port number used if the query type is not SRV Ignored for SRV records"', args=[d.arg(name='port', type=d.T.integer)]),
      withPort(port): { port: port },
      '#withRefreshInterval':: d.fn(help='"RefreshInterval configures the time after which the provided names are refreshed. If not set, Prometheus uses its default value."', args=[d.arg(name='refreshInterval', type=d.T.string)]),
      withRefreshInterval(refreshInterval): { refreshInterval: refreshInterval },
      '#withType':: d.fn(help='"The type of DNS query to perform. One of SRV, A, AAAA, MX or NS. If not set, Prometheus uses its default value. \\n When set to NS, It requires Prometheus >= 2.49.0."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { type: type },
    },
    '#dockerSDConfigs':: d.obj(help='"DockerSDConfigs defines a list of Docker service discovery configurations."'),
    dockerSDConfigs: {
      '#authorization':: d.obj(help='"Authorization header configuration to authenticate against the Docker API. Cannot be set at the same time as `oauth2`."'),
      authorization: {
        '#credentials':: d.obj(help='"Selects a key of a Secret in the namespace that contains the credentials for authentication."'),
        credentials: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    ec2SDConfigs: {
      ...
      '#filters':: d.obj(help='"Filters can be used optionally to filter the instance list by other criteria. Available filter criteria can be found here: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstances.html Filter API documentation: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Filter.html"'),
      filters: {
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValues':: d.fn(help='', args=[d.arg(name='values', type=d.T.array)]),
      ...
      '#withFilters':: d.fn(help='"Filters can be used optionally to filter the instance list by other criteria. Available filter criteria can be found here: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstances.html Filter API documentation: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Filter.html"', args=[d.arg(name='filters', type=d.T.array)]),
      withFilters(filters): { filters: if std.isArray(v=filters) then filters else [filters] },
      '#withFiltersMixin':: d.fn(help='"Filters can be used optionally to filter the instance list by other criteria. Available filter criteria can be found here: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstances.html Filter API documentation: https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Filter.html"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='filters', type=d.T.array)]),
      withFiltersMixin(filters): { filters+: if std.isArray(v=filters) then filters else [filters] },
      '#withPort':: d.fn(help='"The port to scrape metrics from. If using the public IP address, this must instead be specified in the relabeling rule."', args=[d.arg(name='port', type=d.T.integer)]),
      withPort(port): { port: port },
      '#withRefreshInterval':: d.fn(help='"RefreshInterval configures the refresh interval at which Prometheus will re-read the instance list."', args=[d.arg(name='refreshInterval', type=d.T.string)]),
    ...
    eurekaSDConfigs: {
      ...
      '#oauth2':: d.obj(help='"Optional OAuth 2.0 configuration. Cannot be set at the same time as `authorization` or `basic_auth`."'),
      oauth2: {
        '#clientId':: d.obj(help="\"`clientId` specifies a key of a Secret or ConfigMap containing the OAuth2 client's ID.\""),
        clientId: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
    ...
    gceSDConfigs: {
      '#withFilter':: d.fn(help='"Filter can be used optionally to filter the instance list by other criteria Syntax of this filter is described in the filter query parameter section: https://cloud.google.com/compute/docs/reference/latest/instances/list"', args=[d.arg(name='filter', type=d.T.string)]),
    ...
    hetznerSDConfigs: {
      '#authorization':: d.obj(help='"Authorization header configuration, required when role is hcloud. Role robot does not support bearer token authentication."'),
      authorization: {
        '#credentials':: d.obj(help='"Selects a key of a Secret in the namespace that contains the credentials for authentication."'),
        credentials: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#basicAuth':: d.obj(help='"BasicAuth information to use on every scrape request, required when role is robot. Role hcloud does not support basic auth."'),
      basicAuth: {
        '#password':: d.obj(help='"`password` specifies a key of a Secret containing the password for authentication."'),
        password: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#oauth2':: d.obj(help='"Optional OAuth 2.0 configuration. Cannot be used at the same time as `basic_auth` or `authorization`."'),
      oauth2: {
        '#clientId':: d.obj(help="\"`clientId` specifies a key of a Secret or ConfigMap containing the OAuth2 client's ID.\""),
        clientId: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
    ...
    kubernetesSDConfigs: {
      '#attachMetadata':: d.obj(help='"Optional metadata to attach to discovered targets. It requires Prometheus >= v2.35.0 for `pod` role and Prometheus >= v2.37.0 for `endpoints` and `endpointslice` roles."'),
      attachMetadata: {
        '#withNode':: d.fn(help='"Attaches node metadata to discovered targets. When set to true, Prometheus must have the `get` permission on the `Nodes` objects. Only valid for Pod, Endpoint and Endpointslice roles."', args=[d.arg(name='node', type=d.T.boolean)]),
        withNode(node): { attachMetadata+: { node: node } },
      },
      '#authorization':: d.obj(help='"Authorization header to use on every scrape request. Cannot be set at the same time as `basicAuth`, or `oauth2`."'),
      authorization: {
        '#credentials':: d.obj(help='"Selects a key of a Secret in the namespace that contains the credentials for authentication."'),
        credentials: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#basicAuth':: d.obj(help='"BasicAuth information to use on every scrape request. Cannot be set at the same time as `authorization`, or `oauth2`."'),
      basicAuth: {
        '#password':: d.obj(help='"`password` specifies a key of a Secret containing the password for authentication."'),
        password: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      namespaces: {
        '#withNames':: d.fn(help="\"List of namespaces where to watch for resources. If empty and `ownNamespace` isn't true, Prometheus watches for resources in all namespaces.\"", args=[d.arg(name='names', type=d.T.array)]),
        withNames(names): { namespaces+: { names: if std.isArray(v=names) then names else [names] } },
        '#withNamesMixin':: d.fn(help="\"List of namespaces where to watch for resources. If empty and `ownNamespace` isn't true, Prometheus watches for resources in all namespaces.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='names', type=d.T.array)]),
        withNamesMixin(names): { namespaces+: { names+: if std.isArray(v=names) then names else [names] } },
        '#withOwnNamespace':: d.fn(help='"Includes the namespace in which the Prometheus pod exists to the list of watched namesapces."', args=[d.arg(name='ownNamespace', type=d.T.boolean)]),
        withOwnNamespace(ownNamespace): { namespaces+: { ownNamespace: ownNamespace } },
      },
      '#oauth2':: d.obj(help='"Optional OAuth 2.0 configuration. Cannot be set at the same time as `authorization`, or `basicAuth`."'),
      oauth2: {
        '#clientId':: d.obj(help="\"`clientId` specifies a key of a Secret or ConfigMap containing the OAuth2 client's ID.\""),
        clientId: {
          '#configMap':: d.obj(help='"ConfigMap containing data to use for the targets."'),
      ...
      selectors: {
        ...
        '#withRole':: d.fn(help='"Role is role of the service in Kubernetes."', args=[d.arg(name='role', type=d.T.string)]),
        withRole(role): { role: role },
      },
      '#tlsConfig':: d.obj(help='"TLS configuration to use on every scrape request."'),
      tlsConfig: {
      ...
      '#withApiServer':: d.fn(help="\"The API server address consisting of a hostname or IP address followed by an optional port number. If left empty, Prometheus is assumed to run inside of the cluster. It will discover API servers automatically and use the pod's CA certificate and bearer token file at /var/run/secrets/kubernetes.io/serviceaccount/.\"", args=[d.arg(name='apiServer', type=d.T.string)]),
    ...
    openstackSDConfigs: {
      '#applicationCredentialSecret':: d.obj(help='"The applicationCredentialSecret field is required if using an application credential to authenticate."'),
      ...
      '#password':: d.obj(help="\"Password for the Identity V2 and V3 APIs. Consult with your provider's control panel to discover your account's preferred method of authentication.\""),
      password: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withAllTenants':: d.fn(help="\"Whether the service discovery should list all instances for all projects. It is only relevant for the 'instance' role and usually requires admin permissions.\"", args=[d.arg(name='allTenants', type=d.T.boolean)]),
      ...
      '#withApplicationCredentialName':: d.fn(help='"The ApplicationCredentialID or ApplicationCredentialName fields are required if using an application credential to authenticate. Some providers allow you to create an application credential to authenticate rather than a password."', args=[d.arg(name='applicationCredentialName', type=d.T.string)]),
      ...
      '#withDomainName':: d.fn(help='"At most one of domainId and domainName must be provided if using username with Identity V3. Otherwise, either are optional."', args=[d.arg(name='domainName', type=d.T.string)]),
      withDomainName(domainName): { domainName: domainName },
      '#withIdentityEndpoint':: d.fn(help='"IdentityEndpoint specifies the HTTP endpoint that is required to work with the Identity API of the appropriate version."', args=[d.arg(name='identityEndpoint', type=d.T.string)]),
      ...
      '#withProjectName':: d.fn(help="\"The ProjectId and ProjectName fields are optional for the Identity V2 API. Some providers allow you to specify a ProjectName instead of the ProjectId. Some require both. Your provider's authentication policies will determine how these fields influence authentication.\"", args=[d.arg(name='projectName', type=d.T.string)]),
      ...
      '#withUsername':: d.fn(help="\"Username is required if using Identity V2 API. Consult with your provider's control panel to discover your account's username. In Identity V3, either userid or a combination of username and domainId or domainName are needed\"", args=[d.arg(name='username', type=d.T.string)]),
    ...
    '#withTrackTimestampsStaleness':: d.fn(help='"TrackTimestampsStaleness whether Prometheus tracks staleness of the metrics that have an explicit timestamp present in scraped data. Has no effect if `honorTimestamps` is false. It requires Prometheus >= v2.48.0."', args=[d.arg(name='trackTimestampsStaleness', type=d.T.boolean)]),
