{
  ...
  spec: {
    '#attachMetadata':: d.obj(help='"Attaches node metadata to discovered targets. Requires Prometheus v2.35.0 and above."'),
    attachMetadata: {
    ...
    '#namespaceSelector':: d.obj(help='"Selector to select which namespaces the Endpoints objects are discovered from."'),
    namespaceSelector: {
    ...
    '#podMetricsEndpoints':: d.obj(help='"A list of endpoints allowed as part of this PodMonitor."'),
    podMetricsEndpoints: {
      ...
      '#bearerTokenSecret':: d.obj(help='"Secret to mount to read bearer token for scraping targets. The secret needs to be in the same namespace as the pod monitor and accessible by the Prometheus Operator."'),
      bearerTokenSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#withPort':: d.fn(help='"Name of the pod port this endpoint refers to. Mutually exclusive with targetPort."', args=[d.arg(name='port', type=d.T.string)]),
      ...
      '#withScrapeTimeout':: d.fn(help='"Timeout after which the scrape is ended If not specified, the Prometheus global scrape interval is used."', args=[d.arg(name='scrapeTimeout', type=d.T.string)]),
      withScrapeTimeout(scrapeTimeout): { scrapeTimeout: scrapeTimeout },
      '#withTargetPort':: d.fn(help="\"Deprecated: Use 'port' instead.\"", args=[d.arg(name='targetPort', type=d.T.any)]),
      withTargetPort(targetPort): { targetPort: targetPort },
    },
    '#selector':: d.obj(help='"Selector to select Pod objects."'),
    selector: {
    ...
    '#withPodMetricsEndpoints':: d.fn(help='"A list of endpoints allowed as part of this PodMonitor."', args=[d.arg(name='podMetricsEndpoints', type=d.T.array)]),
